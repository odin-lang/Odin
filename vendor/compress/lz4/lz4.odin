...
foreign lib {
	...
	F_isError :: proc(code: F_errorCode_t) -> c.uint ---
	 ...
	 */
	F_compressFrame :: proc(dstBuffer: rawptr, dstCapacity: c.size_t, srcBuffer: rawptr, srcSize: c.size_t, #by_ptr preferencesPtr: F_preferences_t) -> c.size_t ---
	 ...
	 */
	F_compressFrameBound :: proc(srcSize: c.size_t, #by_ptr preferencesPtr: F_preferences_t) -> c.size_t ---
	 ...
	 */
	F_compressBegin :: proc(cctx: F_cctx, dstBuffer: rawptr, dstCapacity: c.size_t, #by_ptr prefsPtr: F_preferences_t) -> c.size_t ---
	 ...
	 */
	F_compressBound :: proc(srcSize: c.size_t, #by_ptr prefsPtr: F_preferences_t) -> c.size_t ---
	 ...
	 */
	F_compressUpdate :: proc(cctx: F_cctx, dstBuffer: rawptr, dstCapacity: c.size_t, srcBuffer: rawptr, srcSize: c.size_t, #by_ptr cOptPtr: F_compressOptions_t) -> c.size_t ---
	 ...
	 */
	F_flush :: proc(cctx: F_cctx, dstBuffer: rawptr, dstCapacity: c.size_t, #by_ptr cOptPtr: F_compressOptions_t) -> c.size_t ---
	 ...
	 */
	F_compressEnd :: proc(cctx: F_cctx, dstBuffer: rawptr, dstCapacity: c.size_t, #by_ptr cOptPtr: F_compressOptions_t) -> c.size_t ---
	 ...
	 */
	F_decompress :: proc(dctx: F_dctx, dstBuffer: rawptr, dstSizePtr: ^c.size_t, srcBuffer: rawptr, srcSizePtr: ^c.size_t, #by_ptr dOptPtr: F_decompressOptions) -> c.size_t ---
	 ...
	 */
	F_compressBegin_usingDict :: proc(cctx: F_cctx, dstBuffer: rawptr, dstCapacity: c.size_t, dictBuffer: rawptr, dictSize: c.size_t, #by_ptr prefsPtr: F_preferences_t) -> c.size_t ---

	/*! LZ4F_decompress_usingDict() : stable since v1.10
	 *  Same as LZ4F_decompress(), using a predefined dictionary.
	 *  Dictionary is used "in place", without any preprocessing.
	**  It must remain accessible throughout the entire frame decoding. */
	F_decompress_usingDict :: proc(dctxPtr: F_dctx, dstBuffer: rawptr, dstSizePtr: ^c.size_t, srcBuffer: rawptr, srcSizePtr: ^c.size_t, dict: rawptr, dictSize: c.size_t, #by_ptr decompressOptionsPtr: F_decompressOptions) -> c.size_t ---
	...
	F_compressFrame_usingCDict :: proc(cctx: F_cctx, dst: rawptr, dstCapacity: c.size_t, src: rawptr, srcSize: c.size_t, cdict: F_CDict, #by_ptr preferencesPtr: F_preferences_t) -> c.size_t ---
	 ...
	 * @return : number of bytes written into dstBuffer for the header,
	 *           or an error code, which can be tested using LZ4F_isError(). */
	F_compressBegin_usingCDict :: proc(cctx: F_cctx, dstBuffer: rawptr, dstCapacity: c.size_t, cdict: F_CDict, #by_ptr prefsPtr: F_preferences_t) -> c.size_t ---
}
