...
IMalloc_VTable :: struct {
	...
	Alloc:          proc "c" (this: ^IMalloc, cb: SIZE_T) -> rawptr,
	Realloc:        proc "c" (this: ^IMalloc, pv: rawptr, cb: SIZE_T) -> rawptr,
	Free:           proc "c" (this: ^IMalloc, pv: rawptr),
	GetSize:        proc "c" (this: ^IMalloc, pv: rawptr) -> SIZE_T,
	DidAlloc:       proc "c" (this: ^IMalloc, pv: rawptr) -> i32,
	HeapMinimize:   proc "c" (this: ^IMalloc),
}
...
ISequentialStream_VTable :: struct {
	using iunknown_vtable: IUnknown_VTable,
	Read:  proc "c" (this: ^ISequentialStream, pv: rawptr, cb: ULONG, pcbRead: ^ULONG) -> HRESULT,
	Write: proc "c" (this: ^ISequentialStream, pv: rawptr, cb: ULONG, pcbWritten: ^ULONG) -> HRESULT,
}
...
IStream_VTable :: struct {
	using isequentialstream_vtable: ISequentialStream_VTable,
	Seek:         proc "c" (this: ^IStream, dlibMove: i64, dwOrigin: u32, plibNewPosition: ^u64) -> HRESULT,
	SetSize:      proc "c" (this: ^IStream, libNewSize: u64) -> HRESULT,
	CopyTo:       proc "c" (this: ^IStream, pstm: ^IStream, cb: u64, pcbRead: ^u64, pcbWritten: ^u64) -> HRESULT,
	Commit:       proc "c" (this: ^IStream, grfCommitFlags: u32) -> HRESULT,
	Revert:       proc "c" (this: ^IStream) -> HRESULT,
	LockRegion:   proc "c" (this: ^IStream, libOffset: u64, cb: u64, dwLockType: u32) -> HRESULT,
	UnlockRegion: proc "c" (this: ^IStream, libOffset: u64, cb: u64, dwLockType: u32) -> HRESULT,
...
IBlob_VTable :: struct {
	using iunknown_vtable: IUnknown_VTable,
	GetBufferPointer: proc "c" (this: ^IBlob) -> rawptr,
	GetBufferSize:    proc "c" (this: ^IBlob) -> SIZE_T,
}
...
IBlobEncoding_VTable :: struct {
	...
	GetEncoding: proc "c" (this: ^IBlobEncoding, pKnown: ^BOOL, pCodePage: ^u32) -> HRESULT,
}
...
IBlobUtf16_VTable :: struct {
	using idxcblobencoding_vtable: IBlobEncoding_VTable,
	GetStringPointer: proc "c" (this: ^IBlobUtf16) -> wstring,
	GetStringLength:  proc "c" (this: ^IBlobUtf16) -> SIZE_T,
}
...
IBlobUtf8_VTable :: struct {
	using idxcblobencoding_vtable: IBlobEncoding_VTable,
	GetStringPointer: proc "c" (this: ^IBlobUtf8) -> cstring,
	GetStringLength:  proc "c" (this: ^IBlobUtf8) -> SIZE_T,
}
...
IIncludeHandler_VTable :: struct {
	using iunknown_vtable: IUnknown_VTable,
	LoadSource: proc "c" (this: ^IIncludeHandler, pFilename: wstring, ppIncludeSource: ^^IBlob) -> HRESULT,
}
...
ICompilerArgs_VTable :: struct {
	using iunknown_vtable: IUnknown_VTable,
	GetArguments:       proc "c" (this: ^ICompilerArgs) -> [^]wstring,
	GetCount:           proc "c" (this: ^ICompilerArgs) -> u32,
	AddArguments:       proc "c" (this: ^ICompilerArgs, pArguments: [^]wstring, argCount: u32) -> HRESULT,
	AddArgumentsUTF8:   proc "c" (this: ^ICompilerArgs, pArguments: [^]cstring, argCount: u32) -> HRESULT,
	AddDefines:         proc "c" (this: ^ICompilerArgs, pDefines: [^]Define, defineCount: u32) -> HRESULT,
}
...
ILibrary_VTable :: struct {
	using iunknown_vtable: IUnknown_VTable,
	SetMalloc:                        proc "c" (this: ^ILibrary, pMalloc: ^IMalloc) -> HRESULT,
	CreateBlobFromBlob:               proc "c" (this: ^ILibrary, pBlob: ^IBlob, offset: u32, length: u32, ppResult: ^^IBlob) -> HRESULT,
	CreateBlobFromFile:               proc "c" (this: ^ILibrary, pFileName: wstring, codePage: ^u32, pBlobEncoding: ^^IBlobEncoding) -> HRESULT,
	CreateBlobWithEncodingFromPinned: proc "c" (this: ^ILibrary, pText: rawptr, size: u32, codePage: u32, pBlobEncoding: ^^IBlobEncoding) -> HRESULT,
	CreateBlobWithEncodingOnHeapCopy: proc "c" (this: ^ILibrary, pText: rawptr, size: u32, codePage: u32, pBlobEncoding: ^^IBlobEncoding) -> HRESULT,
	CreateBlobWithEncodingOnMalloc:   proc "c" (this: ^ILibrary, pText: rawptr, pIMalloc: ^IMalloc, size: u32, codePage: u32, pBlobEncoding: ^^IBlobEncoding) -> HRESULT,
	CreateIncludeHandler:             proc "c" (this: ^ILibrary, ppResult: ^^IIncludeHandler) -> HRESULT,
	CreateStreamFromBlobReadOnly:     proc "c" (this: ^ILibrary, pBlob: ^IBlob, ppStream: ^^IStream) -> HRESULT,
	GetBlobAsUtf8:                    proc "c" (this: ^ILibrary, pBlob: ^IBlob, pBlobEncoding: ^^IBlobEncoding) -> HRESULT,
	GetBlobAsUtf16:                   proc "c" (this: ^ILibrary, pBlob: ^IBlob, pBlobEncoding: ^^IBlobEncoding) -> HRESULT,
}
...
IOperationResult_VTable :: struct {
	using iunknown_vtable: IUnknown_VTable,
	GetStatus:      proc "c" (this: ^IOperationResult, pStatus: ^HRESULT) -> HRESULT,
	GetResult:      proc "c" (this: ^IOperationResult, ppResult: ^^IBlob) -> HRESULT,
	GetErrorBuffer: proc "c" (this: ^IOperationResult, ppErrors: ^^IBlobEncoding) -> HRESULT,
}
...
ICompiler_VTable :: struct {
	...
	Preprocess: proc "c" (
		...
		pIncludeHandler: ^IIncludeHandler,
		ppResult: ^^IOperationResult) -> HRESULT,
	Disassemble: proc "c" (this: ^ICompiler, pSource: ^Buffer, ppDisassembly: ^IBlobEncoding) -> HRESULT,
}
...
ILinker_VTable :: struct {
	using iunknown_vtable: IUnknown_VTable,
	RegisterLibrary: proc "c" (this: ^ILinker, pLibName: ^IBlob) -> HRESULT,
	Link: proc "c" (
		this: ^ILinker,
		pEntryName: wstring,
		pTargetProfile: wstring,
...
IUtils_VTable :: struct {
	using iunknown_vtable: IUnknown_VTable,
	CreateBlobFromBlob:           proc "c" (this: ^IUtils, pBlob: ^IBlob, offset: u32, length: u32, ppResult: ^^IBlob) -> HRESULT,
	CreateBlobFromPinned:         proc "c" (this: ^IUtils, pData: rawptr, size: u32, codePage: u32, pBlobEncoding: ^^IBlobEncoding) -> HRESULT,
	MoveToBlob:                   proc "c" (this: ^IUtils, pData: rawptr, pIMalloc: ^IMalloc, size: u32, codePage: u32, pBlobEncoding: ^^IBlobEncoding) -> HRESULT,
	CreateBlob:                   proc "c" (this: ^IUtils, pData: rawptr, size: u32, codePage: u32, pBlobEncoding: ^^IBlobEncoding) -> HRESULT,
	LoadFile:                     proc "c" (this: ^IUtils, pFileName: wstring, pCodePage: ^u32, pBlobEncoding: ^^IBlobEncoding) -> HRESULT,
	CreateReadOnlyStreamFromBlob: proc "c" (this: ^IUtils, pBlob: ^IBlob, ppStream: ^^IStream) -> HRESULT,
	CreateDefaultIncludeHandler:  proc "c" (this: ^IUtils, ppResult: ^^IIncludeHandler) -> HRESULT,
	GetBlobAsUtf8:                proc "c" (this: ^IUtils, pBlob: ^IBlob, pBlobEncoding: ^^IBlobUtf8) -> HRESULT,
	GetBlobAsUtf16:               proc "c" (this: ^IUtils, pBlob: ^IBlob, pBlobEncoding: ^^IBlobUtf16) -> HRESULT,
	GetDxilContainerPart:         proc "c" (this: ^IUtils, pShader: ^Buffer, Part: u32, ppPartData: rawptr, pPartSizeInBytes: ^u32) -> HRESULT,
	CreateReflection:             proc "c" (this: ^IUtils, pData: ^Buffer, iid: ^IID, ppvReflection: rawptr) -> HRESULT,
	BuildArguments:               proc "c" (this: ^IUtils, pSourceName: wstring, pEntryPoint: wstring, pTargetProfile: wstring, pArguments: [^]wstring, argCount: u32, pDefines: [^]Define, defineCount: u32, ppArgs: ^[^]ICompilerArgs) -> HRESULT,
	GetPDBContents:               proc "c" (this: ^IUtils, pPDBBlob: ^IBlob, ppHash: ^^IBlob, ppContainer: ^^IBlob) -> HRESULT,
}
...
IResult_VTable :: struct {
	using idxcoperationresult_vtable: IOperationResult_VTable,
	HasOutput:        proc "c" (this: ^IResult, dxcOutKind: DXC_OUT_KIND) -> BOOL,
	GetOutput:        proc "c" (this: ^IResult, dxcOutKind: DXC_OUT_KIND, iid: ^IID, ppvObject: rawptr, ppOutputName: ^^IBlobUtf16) -> HRESULT,
	GetNumOutputs:    proc "c" (this: ^IResult) -> u32,
	GetOutputByIndex: proc "c" (this: ^IResult, Index: u32) -> DXC_OUT_KIND,
	PrimaryOutput:    proc "c" (this: ^IResult) -> DXC_OUT_KIND,
}
...
IExtraOutputs_VTable :: struct {
	using iunknown_vtable: IUnknown_VTable,
	GetOutputCount: proc "c" (this: ^IExtraOutputs) -> u32,
	GetOutput:      proc "c" (this: ^IExtraOutputs, uIndex: u32, iid: ^IID, ppvObject: rawptr, ppOutputType: ^^IBlobUtf16, ppOutputName: ^^IBlobUtf16) -> HRESULT,
}
...
ICompiler3_VTable :: struct {
	using iunknown_vtable: IUnknown_VTable,
	Compile:     proc "c" (this: ^ICompiler3, pSource: ^Buffer, pArguments: [^]wstring, argCount: u32, pIncludeHandler: ^IIncludeHandler, riid: ^IID, ppResult: rawptr) -> HRESULT,
	Disassemble: proc "c" (this: ^ICompiler3, pObject: ^Buffer, riid: ^IID, ppResult: rawptr) -> HRESULT,
}
...
IValidator_VTable :: struct {
	using iunknown_vtable: IUnknown_VTable,
	Validate: proc "c" (this: ^IValidator, pShader: ^IBlob, Flags: u32, ppResult: ^^IOperationResult) -> HRESULT,
}
...
IValidator2_VTable :: struct {
	using idxcvalidator_vtable: IValidator_VTable,
	ValidateWithDebug: proc "c" (this: ^IValidator2, pShader: ^IBlob, Flags: u32, pOptDebugBitcode: ^Buffer, ppResult: ^^IOperationResult) -> HRESULT,
}
...
IContainerBuilder_VTable :: struct {
	using iunknown_vtable: IUnknown_VTable,
	Load:               proc "c" (this: ^IContainerBuilder, pDxilContainerHeader: ^IBlob) -> HRESULT,
	AddPart:            proc "c" (this: ^IContainerBuilder, fourCC: u32, pSource: ^IBlob) -> HRESULT,
	RemovePart:         proc "c" (this: ^IContainerBuilder, fourCC: u32) -> HRESULT,
	SerializeContainer: proc "c" (this: ^IContainerBuilder, ppResult: ^^IOperationResult) -> HRESULT,
}
...
IAssembler_VTable :: struct {
	using iunknown_vtable: IUnknown_VTable,
	AssembleToContainer: proc "c" (this: ^IAssembler, pShader: ^IBlob, ppResult: ^^IOperationResult) -> HRESULT,
}
...
IContainerReflection_VTable :: struct {
	using iunknown_vtable: IUnknown_VTable,
	Load:              proc "c" (this: ^IContainerReflection, pContainer: ^IBlob) -> HRESULT,
	GetPartCount:      proc "c" (this: ^IContainerReflection, pResult: ^u32) -> HRESULT,
	GetPartKind:       proc "c" (this: ^IContainerReflection, idx: u32, pResult: ^u32) -> HRESULT,
	GetPartContent:    proc "c" (this: ^IContainerReflection, idx: u32, ppResult: ^^IBlob) -> HRESULT,
	FindFirstPartKind: proc "c" (this: ^IContainerReflection, kind: u32, pResult: ^u32) -> HRESULT,
	GetPartReflection: proc "c" (this: ^IContainerReflection, idx: u32, iid: ^IID, ppvObject: rawptr) -> HRESULT,
}
...
IOptimizerPass_VTable :: struct {
	using iunknown_vtable: IUnknown_VTable,
	GetOptionName:           proc "c" (this: ^IOptimizerPass, ppResult: ^wstring) -> HRESULT,
	GetDescription:          proc "c" (this: ^IOptimizerPass, ppResult: ^wstring) -> HRESULT,
	GetOptionArgCount:       proc "c" (this: ^IOptimizerPass, pCount: ^u32) -> HRESULT,
	GetOptionArgName:        proc "c" (this: ^IOptimizerPass, argIndex: u32, ppResult: ^wstring) -> HRESULT,
	GetOptionArgDescription: proc "c" (this: ^IOptimizerPass, argIndex: u32, ppResult: ^wstring) -> HRESULT,
}
...
IOptimizer_VTable :: struct {
	using iunknown_vtable: IUnknown_VTable,
	GetAvailablePassCount: proc "c" (this: ^IOptimizer, pCount: ^u32) -> HRESULT,
	GetAvailablePass:      proc "c" (this: ^IOptimizer, index: u32, ppResult: ^^IOptimizerPass) -> HRESULT,
	RunOptimizer:          proc "c" (this: ^IOptimizer, pBlob: ^IBlob, ppOptions: [^]wstring, optionCount: u32, pOutputModule: ^^IBlob, ppOutputText: ^^IBlobEncoding) -> HRESULT,
}
...
IVersionInfo_VTable :: struct {
	using iunknown_vtable: IUnknown_VTable,
	GetVersion: proc "c" (this: ^IVersionInfo, pMajor: ^u32, pMinor: ^u32) -> HRESULT,
	GetFlags:   proc "c" (this: ^IVersionInfo, pFlags: ^VersionInfoFlags) -> HRESULT,
}
...
IVersionInfo2_VTable :: struct {
	using idxcversioninfo_vtable: IVersionInfo_VTable,
	GetCommitInfo: proc "c" (this: ^IVersionInfo2, pCommitCount: ^u32, pCommitHash: ^[^]byte) -> HRESULT,
}
...
IVersionInfo3_VTable :: struct {
	using iunknown_vtable: IUnknown_VTable,
	GetCustomVersionString: proc "c" (this: ^IVersionInfo3, pVersionString: ^cstring) -> HRESULT,
}
...
IPdbUtils_VTable :: struct {
	using iunknown_vtable: IUnknown_VTable,
	Load:                  proc "c" (this: ^IPdbUtils, pPdbOrDxil: ^IBlob) -> HRESULT,
	GetSourceCount:        proc "c" (this: ^IPdbUtils, pCount: ^u32) -> HRESULT,
	GetSource:             proc "c" (this: ^IPdbUtils, uIndex: u32, ppResult: ^^IBlobEncoding) -> HRESULT,
	GetSourceName:         proc "c" (this: ^IPdbUtils, uIndex: u32, pResult: ^BSTR) -> HRESULT,
	GetFlagCount:          proc "c" (this: ^IPdbUtils, pCount: ^u32) -> HRESULT,
	GetFlag:               proc "c" (this: ^IPdbUtils, uIndex: u32, pResult: ^BSTR) -> HRESULT,
	GetArgCount:           proc "c" (this: ^IPdbUtils, pCount: ^u32) -> HRESULT,
	GetArg:                proc "c" (this: ^IPdbUtils, uIndex: u32, pResult: ^BSTR) -> HRESULT,
	GetArgPairCount:       proc "c" (this: ^IPdbUtils, pCount: ^u32) -> HRESULT,
	GetArgPair:            proc "c" (this: ^IPdbUtils, uIndex: u32, pName: ^BSTR, pValue: ^BSTR) -> HRESULT,
	GetDefineCount:        proc "c" (this: ^IPdbUtils, pCount: ^u32) -> HRESULT,
	GetDefine:             proc "c" (this: ^IPdbUtils, uIndex: u32, pResult: ^BSTR) -> HRESULT,
	GetTargetProfile:      proc "c" (this: ^IPdbUtils, pResult: ^BSTR) -> HRESULT,
	GetEntryPoint:         proc "c" (this: ^IPdbUtils, pResult: ^BSTR) -> HRESULT,
	GetMainFileName:       proc "c" (this: ^IPdbUtils, pResult: ^BSTR) -> HRESULT,
	GetHash:               proc "c" (this: ^IPdbUtils, ppResult: ^^IBlob) -> HRESULT,
	GetName:               proc "c" (this: ^IPdbUtils, pResult: ^BSTR) -> HRESULT,
	IsFullPDB:             proc "c" (this: ^IPdbUtils) -> BOOL,
	GetFullPDB:            proc "c" (this: ^IPdbUtils, ppFullPDB: ^^IBlob) -> HRESULT,
	GetVersionInfo:        proc "c" (this: ^IPdbUtils, ppVersionInfo: ^^IVersionInfo) -> HRESULT,
	SetCompiler:           proc "c" (this: ^IPdbUtils, pCompiler: ^ICompiler3) -> HRESULT,
	CompileForFullPDB:     proc "c" (this: ^IPdbUtils, ppResult: ^^IResult) -> HRESULT,
	OverrideArgs:          proc "c" (this: ^IPdbUtils, pArgPairs: ^ArgPair, uNumArgPairs: u32) -> HRESULT,
	OverrideRootSignature: proc "c" (this: ^IPdbUtils, pRootSignature: wstring) -> HRESULT,
}
