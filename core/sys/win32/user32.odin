...
foreign user32 {
	...
	@(link_name="PostThreadMessageA") post_thread_message_a :: proc(idThread: u32, msg: u32, wparam: Wparam, lparam: Lparam) -> Bool ---
	@(link_name="PostThreadMessageW") post_thread_message_w :: proc(idThread: u32, msg: u32, wparam: Wparam, lparam: Lparam) -> Bool ---
