...
init_sw :: proc "contextless" (ctx: ^Context, st: ^State_SW, iv: []byte) {
	switch ctx._key_len {
	case KEY_SIZE_128L:
		key_0, key_1 := load_interleaved(ctx._key[:16])
		iv_0, iv_1 := load_interleaved(iv)

		st.s0_0, st.s0_1 = xor_interleaved(key_0, key_1, iv_0, iv_1)
		st.s1_0, st.s1_1 = load_interleaved(_C1[:])
		st.s2_0, st.s2_1 = load_interleaved(_C0[:])
		st.s3_0, st.s3_1 = st.s1_0, st.s1_1
		st.s4_0, st.s4_1 = st.s0_0, st.s0_1
		st.s5_0, st.s5_1 = xor_interleaved(key_0, key_1, st.s2_0, st.s2_1)
		st.s6_0, st.s6_1 = xor_interleaved(key_0, key_1, st.s1_0, st.s1_1)
	...
	case KEY_SIZE_256:
		k0_0, k0_1 := load_interleaved(ctx._key[:16])
		k1_0, k1_1 := load_interleaved(ctx._key[16:])
		n0_0, n0_1 := load_interleaved(iv[:16])
		n1_0, n1_1 := load_interleaved(iv[16:])

		st.s0_0, st.s0_1 = xor_interleaved(k0_0, k0_1, n0_0, n0_1)
		st.s1_0, st.s1_1 = xor_interleaved(k1_0, k1_1, n1_0, n1_1)
		st.s2_0, st.s2_1 = load_interleaved(_C1[:])
		st.s3_0, st.s3_1 = load_interleaved(_C0[:])
		st.s4_0, st.s4_1 = xor_interleaved(k0_0, k0_1, st.s3_0, st.s3_1)
		st.s5_0, st.s5_1 = xor_interleaved(k1_0, k1_1, st.s2_0, st.s2_1)
		st.rate = _RATE_256
...
update_sw_128l :: proc "contextless" (st: ^State_SW, m0_0, m0_1, m1_0, m1_1: u64) {
	st.q_k[0], st.q_k[4] = xor_interleaved(st.s0_0, st.s0_1, m0_0, m0_1)
	...
	st.q_k[0], st.q_k[4] = xor_interleaved(st.s4_0, st.s4_1, m1_0, m1_1)
...
update_sw_256 :: proc "contextless" (st: ^State_SW, m_0, m_1: u64) {
	st.q_k[0], st.q_k[4] = xor_interleaved(st.s0_0, st.s0_1, m_0, m_1)
	st.q_k[1], st.q_k[5] = st.s1_0, st.s1_1
	st.q_k[2], st.q_k[6] = st.s2_0, st.s2_1
	st.q_k[3], st.q_k[7] = st.s3_0, st.s3_1
	aes.orthogonalize(&st.q_k)
...
z_sw_128l :: proc "contextless" (st: ^State_SW) -> (u64, u64, u64, u64) {
	z0_0, z0_1 := and_interleaved(st.s2_0, st.s2_1, st.s3_0, st.s3_1)
	z0_0, z0_1 = xor_interleaved(st.s1_0, st.s1_1, z0_0, z0_1)
	z0_0, z0_1 = xor_interleaved(st.s6_0, st.s6_1, z0_0, z0_1)

	z1_0, z1_1 := and_interleaved(st.s6_0, st.s6_1, st.s7_0, st.s7_1)
	z1_0, z1_1 = xor_interleaved(st.s5_0, st.s5_1, z1_0, z1_1)
	z1_0, z1_1 = xor_interleaved(st.s2_0, st.s2_1, z1_0, z1_1)
...
z_sw_256 :: proc "contextless" (st: ^State_SW) -> (u64, u64) {
	z_0, z_1 := and_interleaved(st.s2_0, st.s2_1, st.s3_0, st.s3_1)
	z_0, z_1 = xor_interleaved(st.s5_0, st.s5_1, z_0, z_1)
	z_0, z_1 = xor_interleaved(st.s4_0, st.s4_1, z_0, z_1)
	return xor_interleaved(st.s1_0, st.s1_1, z_0, z_1)
}
...
enc_sw_128l :: #force_inline proc "contextless" (st: ^State_SW, ci, xi: []byte) #no_bounds_check {
	...
	t0_0, t0_1 := load_interleaved(xi[:16])
	t1_0, t1_1 := load_interleaved(xi[16:])
	update_sw_128l(st, t0_0, t0_1, t1_0, t1_1)

	out0_0, out0_1 := xor_interleaved(t0_0, t0_1, z0_0, z0_1)
	out1_0, out1_1 := xor_interleaved(t1_0, t1_1, z1_0, z1_1)
	store_interleaved(ci[:16], out0_0, out0_1)
	store_interleaved(ci[16:], out1_0, out1_1)
}
...
enc_sw_256 :: #force_inline proc "contextless" (st: ^State_SW, ci, xi: []byte) #no_bounds_check {
	...
	xi_0, xi_1 := load_interleaved(xi)
	update_sw_256(st, xi_0, xi_1)

	ci_0, ci_1 := xor_interleaved(xi_0, xi_1, z_0, z_1)
	store_interleaved(ci, ci_0, ci_1)
}
...
dec_sw_128l :: #force_inline proc "contextless" (st: ^State_SW, xi, ci: []byte) #no_bounds_check {
	...
	t0_0, t0_1 := load_interleaved(ci[:16])
	t1_0, t1_1 := load_interleaved(ci[16:])
	out0_0, out0_1 := xor_interleaved(t0_0, t0_1, z0_0, z0_1)
	out1_0, out1_1 := xor_interleaved(t1_0, t1_1, z1_0, z1_1)

	update_sw_128l(st, out0_0, out0_1, out1_0, out1_1)
	store_interleaved(xi[:16], out0_0, out0_1)
	store_interleaved(xi[16:], out1_0, out1_1)
}
...
dec_sw_256 :: #force_inline proc "contextless" (st: ^State_SW, xi, ci: []byte) #no_bounds_check {
	...
	ci_0, ci_1 := load_interleaved(ci)
	xi_0, xi_1 := xor_interleaved(ci_0, ci_1, z_0, z_1)

	update_sw_256(st, xi_0, xi_1)
	store_interleaved(xi, xi_0, xi_1)
}
...
dec_partial_sw_128l :: proc "contextless" (st: ^State_SW, xn, cn: []byte) #no_bounds_check {
	...
	t0_0, t0_1 := load_interleaved(tmp[:16])
	t1_0, t1_1 := load_interleaved(tmp[16:])
	out0_0, out0_1 := xor_interleaved(t0_0, t0_1, z0_0, z0_1)
	out1_0, out1_1 := xor_interleaved(t1_0, t1_1, z1_0, z1_1)

	store_interleaved(tmp[:16], out0_0, out0_1)
	store_interleaved(tmp[16:], out1_0, out1_1)
	copy(xn, tmp[:])

	for off := len(xn); off < _RATE_128L; off += 1 {
		tmp[off] = 0
	}
	out0_0, out0_1 = load_interleaved(tmp[:16])
	out1_0, out1_1 = load_interleaved(tmp[16:])
	update_sw_128l(st, out0_0, out0_1, out1_0, out1_1)
}
...
dec_partial_sw_256 :: proc "contextless" (st: ^State_SW, xn, cn: []byte) #no_bounds_check {
	...
	cn_0, cn_1 := load_interleaved(tmp[:])
	xn_0, xn_1 := xor_interleaved(cn_0, cn_1, z_0, z_1)

	store_interleaved(tmp[:], xn_0, xn_1)
	copy(xn, tmp[:])

	for off := len(xn); off < _RATE_256; off += 1 {
		tmp[off] = 0
	}
	xn_0, xn_1 = load_interleaved(tmp[:])
...
finalize_sw :: proc "contextless" (st: ^State_SW, tag: []byte, ad_len, msg_len: int) {
	...
	t_0, t_1 := load_interleaved(tmp[:])

	t0_0, t0_1, t1_0, t1_1: u64 = ---, ---, ---, ---
	switch st.rate {
	case _RATE_128L:
		t_0, t_1 = xor_interleaved(st.s2_0, st.s2_1, t_0, t_1)
		for _ in 0 ..< 7 {
			update_sw_128l(st, t_0, t_1, t_0, t_1)
		}

		t0_0, t0_1 = xor_interleaved(st.s0_0, st.s0_1, st.s1_0, st.s1_1)
		t0_0, t0_1 = xor_interleaved(t0_0, t0_1, st.s2_0, st.s2_1)
		t0_0, t0_1 = xor_interleaved(t0_0, t0_1, st.s3_0, st.s3_1)

		t1_0, t1_1 = xor_interleaved(st.s4_0, st.s4_1, st.s5_0, st.s5_1)
		t1_0, t1_1 = xor_interleaved(t1_0, t1_1, st.s6_0, st.s6_1)
		if len(tag) == TAG_SIZE_256 {
			t1_0, t1_1 = xor_interleaved(t1_0, t1_1, st.s7_0, st.s7_1)
		}
	case _RATE_256:
		t_0, t_1 = xor_interleaved(st.s3_0, st.s3_1, t_0, t_1)
		for _ in 0 ..< 7 {
		...
		t1_0, t1_1 = xor_interleaved(st.s3_0, st.s3_1, st.s4_0, st.s4_1)
		t1_0, t1_1 = xor_interleaved(t1_0, t1_1, st.s5_0, st.s5_1)
	}
	switch len(tag) {
	case TAG_SIZE_128:
		t0_0, t0_1 = xor_interleaved(t0_0, t0_1, t1_0, t1_1)
		store_interleaved(tag, t0_0, t0_1)
	case TAG_SIZE_256:
		store_interleaved(tag[:16], t0_0, t0_1)
		store_interleaved(tag[16:], t1_0, t1_1)
	}
}
...
load_interleaved :: proc "contextless" (src: []byte) -> (u64, u64) {
	...
	return aes.interleave_in(w0, w1, w2, w3)
}

@(private = "file")
store_interleaved :: proc "contextless" (dst: []byte, a0, a1: u64) {
	w0, w1, w2, w3 := aes.interleave_out(a0, a1)
