...
fe_clear_tight :: proc "contextless" (arg1: ^Tight_Field_Element) {
	mem.zero_explicit(arg1, size_of(Tight_Field_Element))
}

fe_clear_loose :: proc "contextless" (arg1: ^Loose_Field_Element) {
	mem.zero_explicit(arg1, size_of(Loose_Field_Element))
}
...
fe_carry_sqrt_ratio_m1 :: proc "contextless" (
	...
	fe_carry_mul(neg_u_i, fe_relax_cast(neg_u), fe_relax_cast(&SQRT_M1))
	...
	r_prime := check
	fe_carry_mul(r_prime, fe_relax_cast(r), fe_relax_cast(&SQRT_M1))
...
fe_carry_inv :: proc "contextless" (out1: ^Tight_Field_Element, arg1: ^Loose_Field_Element) {
	...
	_ = fe_carry_sqrt_ratio_m1(&tmp1, fe_relax_cast(&ONE), fe_relax_cast(&tmp1))
...
fe_cond_select :: #force_no_inline proc "contextless" (
	out1, arg1, arg2: ^Tight_Field_Element,
	arg3: int,
) {
	mask := (u64(arg3) * 0xffffffffffffffff)
	x1 := ((mask & arg1[0]) | ((~mask) & arg2[0]))
	x2 := ((mask & arg1[1]) | ((~mask) & arg2[1]))
	x3 := ((mask & arg1[2]) | ((~mask) & arg2[2]))
	x4 := ((mask & arg1[3]) | ((~mask) & arg2[3]))
	x5 := ((mask & arg1[4]) | ((~mask) & arg2[4]))
	out1[0] = x1
	out1[1] = x2
	out1[2] = x3
	out1[3] = x4
