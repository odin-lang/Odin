...
// =============================================================================
//
// Reverse maps from wire opcode to Opcode. Dispatch is two-level:
//
...
@(rodata)
DECODE_MAIN := [DECODE_MAIN_COUNT]Opcode{
	0x00 = .UNREACHABLE,
	0x01 = .NOP,
	0x02 = .BLOCK,
	0x03 = .LOOP,
...
@(rodata)
DECODE_MISC := [DECODE_MISC_COUNT]Opcode{
...
@(rodata)
DECODE_SIMD := [DECODE_SIMD_COUNT]Opcode{
	0x00 = .V128_LOAD,
	0x01 = .V128_LOAD8X8_S,
	0x02 = .V128_LOAD8X8_U,
...
@(rodata)
DECODE_ATOMIC := [DECODE_ATOMIC_COUNT]Opcode{
