...
@(rodata)
ENCODE_FORMS := [2071]lib.Encoding{
	// .ADD_IMM
...
ENCODE_RUNS := [lib.Mnemonic]lib.Encode_Run{
	...
	.SVE_ADD_PRED         = { 1485,   4},
	.SVE_SUB_PRED         = { 1489,   4},
	.SVE_SUBR_PRED        = { 1493,   4},
	.SVE_MUL_PRED         = { 1497,   4},
	.SVE_SMULH_PRED       = { 1501,   4},
	.SVE_UMULH_PRED       = { 1505,   4},
	.SVE_SDIV_PRED        = { 1509,   2},
	.SVE_UDIV_PRED        = { 1511,   2},
	.SVE_SMAX_PRED        = { 1513,   4},
	.SVE_UMAX_PRED        = { 1517,   4},
	.SVE_SMIN_PRED        = { 1521,   4},
	.SVE_UMIN_PRED        = { 1525,   4},
	.SVE_SABD_PRED        = { 1529,   4},
	.SVE_UABD_PRED        = { 1533,   4},
	.SVE_AND_PRED         = { 1537,   1},
	.SVE_ORR_PRED         = { 1538,   1},
	.SVE_EOR_PRED         = { 1539,   1},
	.SVE_BIC_PRED         = { 1540,   1},
	...
	.SVE_LSL_PRED         = { 1545,   4},
	.SVE_LSR_PRED         = { 1549,   4},
	.SVE_ASRR_PRED        = { 1553,   0},
	.SVE_LSLR_PRED        = { 1553,   0},
	.SVE_LSRR_PRED        = { 1553,   0},
	.SVE_ABS_PRED         = { 1553,   4},
	.SVE_NEG_PRED         = { 1557,   4},
	.SVE_CLS_PRED         = { 1561,   4},
	.SVE_CLZ_PRED         = { 1565,   4},
	...
	.SVE_FRSQRTS          = { 1585,   3},
	.SVE_FTSMUL           = { 1588,   3},
	.SVE_FADD_PRED        = { 1591,   3},
	.SVE_FSUB_PRED        = { 1594,   3},
	.SVE_FSUBR_PRED       = { 1597,   0},
	.SVE_FMUL_PRED        = { 1597,   3},
	.SVE_FDIV_PRED        = { 1600,   3},
	.SVE_FDIVR_PRED       = { 1603,   0},
	.SVE_FMAX_PRED        = { 1603,   3},
	.SVE_FMIN_PRED        = { 1606,   3},
	.SVE_FMAXNM_PRED      = { 1609,   3},
	.SVE_FMINNM_PRED      = { 1612,   3},
	.SVE_FABS_Z           = { 1615,   3},
	.SVE_FNEG_Z           = { 1618,   3},
	.SVE_FSQRT_Z          = { 1621,   3},
	.SVE_FRECPX_Z         = { 1624,   0},
	...
	.SME_USMOPA           = { 1792,   1},
	.SME_SUMOPA           = { 1793,   1},
	.SME_MOVA_TO_Z        = { 1794,   0},
	.SME_MOVA_TO_ZA       = { 1794,   0},
	.SME_LD1B_ZA          = { 1794,   0},
	.SME_LD1H_ZA          = { 1794,   0},
	.SME_LD1W_ZA          = { 1794,   0},
	.SME_LD1D_ZA          = { 1794,   0},
	...
	.SME_LDR_ZA           = { 1794,   1},
	.SME_STR_ZA           = { 1795,   1},
	.SVE_FMLA_IDX_H       = { 1796,   1},
	.SVE_FMLA_IDX_S       = { 1797,   1},
	.SVE_FMLA_IDX_D       = { 1798,   1},
	.SVE_FMLS_IDX_H       = { 1799,   1},
	.SVE_FMLS_IDX_S       = { 1800,   1},
	.SVE_FMLS_IDX_D       = { 1801,   1},
	.SVE_LD1B_GATHER_S    = { 1802,   1},
	.SVE_LD1B_GATHER_D    = { 1803,   1},
	.SVE_LD1H_GATHER_S    = { 1804,   1},
	.SVE_LD1H_GATHER_D    = { 1805,   1},
	.SVE_LD1W_GATHER_S    = { 1806,   1},
	.SVE_LD1W_GATHER_D    = { 1807,   1},
	.SVE_LD1D_GATHER_D    = { 1808,   1},
	.SVE_LD1SB_GATHER_S   = { 1809,   1},
	.SVE_LD1SB_GATHER_D   = { 1810,   1},
	.SVE_LD1SH_GATHER_S   = { 1811,   1},
	.SVE_LD1SH_GATHER_D   = { 1812,   1},
	.SVE_LD1SW_GATHER_D   = { 1813,   1},
	.SVE_ST1B_SCATTER_S   = { 1814,   1},
	.SVE_ST1B_SCATTER_D   = { 1815,   1},
	.SVE_ST1H_SCATTER_S   = { 1816,   1},
	.SVE_ST1H_SCATTER_D   = { 1817,   1},
	.SVE_ST1W_SCATTER_S   = { 1818,   1},
	.SVE_ST1W_SCATTER_D   = { 1819,   1},
	.SVE_ST1D_SCATTER_D   = { 1820,   1},
	.SME_LD1B_TILE        = { 1821,   1},
	.SME_LD1H_TILE        = { 1822,   1},
	.SME_LD1W_TILE        = { 1823,   1},
	.SME_LD1D_TILE        = { 1824,   1},
	.SME_LD1Q_TILE        = { 1825,   1},
	.SME_ST1B_TILE        = { 1826,   1},
	.SME_ST1H_TILE        = { 1827,   1},
	.SME_ST1W_TILE        = { 1828,   1},
	.SME_ST1D_TILE        = { 1829,   1},
	.SME_ST1Q_TILE        = { 1830,   1},
	.SME_MOVA_Z_FROM_TILE = { 1831,   1},
	.SME_MOVA_TILE_FROM_Z = { 1832,   1},
	.FCMLA_4H             = { 1833,   1},
	.FCMLA_8H             = { 1834,   1},
	.FCMLA_4S             = { 1835,   1},
	.FCMLA_2D             = { 1836,   1},
	...
	.ASR_IMM              = { 1931,   2},
	.ROR_IMM              = { 1933,   2},
	.SVE_BFADD_UNPRED     = { 1935,   1},
	.SVE_BFSUB_UNPRED     = { 1936,   1},
	.SVE_BFMUL_UNPRED     = { 1937,   1},
	.SVE_BFCLAMP          = { 1938,   1},
	.SVE_BFMAXNM          = { 1939,   1},
	.SVE_BFMINNM          = { 1940,   1},
	.SME2_LUTI2_B         = { 1941,   1},
	...
	.AT_S12E0W            = { 2025,   1},
	.TLBI_VMALLE1         = { 2026,   1},
	.TLBI_VMALLE1IS       = { 2027,   1},
	.TLBI_VAE1            = { 2028,   1},
	.TLBI_VAE1IS          = { 2029,   1},
	.TLBI_ASIDE1          = { 2030,   1},
	.TLBI_ASIDE1IS        = { 2031,   1},
	.TLBI_VAAE1           = { 2032,   1},
	.TLBI_VAAE1IS         = { 2033,   1},
	.TLBI_VALE1           = { 2034,   1},
	.TLBI_VALE1IS         = { 2035,   1},
	.TLBI_VAALE1          = { 2036,   1},
	.TLBI_VAALE1IS        = { 2037,   1},
	.TLBI_ALLE1           = { 2038,   1},
	.TLBI_ALLE1IS         = { 2039,   1},
	.TLBI_ALLE2           = { 2040,   1},
	.TLBI_ALLE2IS         = { 2041,   1},
