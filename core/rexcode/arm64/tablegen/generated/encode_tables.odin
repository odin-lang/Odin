...
@(rodata)
ENCODE_FORMS := [1806]lib.Encoding{
	// .ADD_IMM
...
ENCODE_RUNS := [lib.Mnemonic]lib.Encode_Run{
	...
	.SVE_ADD_PRED         = { 1220,   4},
	.SVE_SUB_PRED         = { 1224,   4},
	.SVE_SUBR_PRED        = { 1228,   4},
	.SVE_MUL_PRED         = { 1232,   4},
	.SVE_SMULH_PRED       = { 1236,   4},
	.SVE_UMULH_PRED       = { 1240,   4},
	.SVE_SDIV_PRED        = { 1244,   2},
	.SVE_UDIV_PRED        = { 1246,   2},
	.SVE_SMAX_PRED        = { 1248,   4},
	.SVE_UMAX_PRED        = { 1252,   4},
	.SVE_SMIN_PRED        = { 1256,   4},
	.SVE_UMIN_PRED        = { 1260,   4},
	.SVE_SABD_PRED        = { 1264,   4},
	.SVE_UABD_PRED        = { 1268,   4},
	.SVE_AND_PRED         = { 1272,   1},
	.SVE_ORR_PRED         = { 1273,   1},
	.SVE_EOR_PRED         = { 1274,   1},
	.SVE_BIC_PRED         = { 1275,   1},
	...
	.SVE_LSL_PRED         = { 1280,   4},
	.SVE_LSR_PRED         = { 1284,   4},
	.SVE_ASRR_PRED        = { 1288,   0},
	.SVE_LSLR_PRED        = { 1288,   0},
	.SVE_LSRR_PRED        = { 1288,   0},
	.SVE_ABS_PRED         = { 1288,   4},
	.SVE_NEG_PRED         = { 1292,   4},
	.SVE_CLS_PRED         = { 1296,   4},
	.SVE_CLZ_PRED         = { 1300,   4},
	...
	.SVE_FRSQRTS          = { 1320,   3},
	.SVE_FTSMUL           = { 1323,   3},
	.SVE_FADD_PRED        = { 1326,   3},
	.SVE_FSUB_PRED        = { 1329,   3},
	.SVE_FSUBR_PRED       = { 1332,   0},
	.SVE_FMUL_PRED        = { 1332,   3},
	.SVE_FDIV_PRED        = { 1335,   3},
	.SVE_FDIVR_PRED       = { 1338,   0},
	.SVE_FMAX_PRED        = { 1338,   3},
	.SVE_FMIN_PRED        = { 1341,   3},
	.SVE_FMAXNM_PRED      = { 1344,   3},
	.SVE_FMINNM_PRED      = { 1347,   3},
	.SVE_FABS_Z           = { 1350,   3},
	.SVE_FNEG_Z           = { 1353,   3},
	.SVE_FSQRT_Z          = { 1356,   3},
	.SVE_FRECPX_Z         = { 1359,   0},
	...
	.SME_USMOPA           = { 1527,   1},
	.SME_SUMOPA           = { 1528,   1},
	.SME_MOVA_TO_Z        = { 1529,   0},
	.SME_MOVA_TO_ZA       = { 1529,   0},
	.SME_LD1B_ZA          = { 1529,   0},
	.SME_LD1H_ZA          = { 1529,   0},
	.SME_LD1W_ZA          = { 1529,   0},
	.SME_LD1D_ZA          = { 1529,   0},
	...
	.SME_LDR_ZA           = { 1529,   1},
	.SME_STR_ZA           = { 1530,   1},
	.SVE_FMLA_IDX_H       = { 1531,   1},
	.SVE_FMLA_IDX_S       = { 1532,   1},
	.SVE_FMLA_IDX_D       = { 1533,   1},
	.SVE_FMLS_IDX_H       = { 1534,   1},
	.SVE_FMLS_IDX_S       = { 1535,   1},
	.SVE_FMLS_IDX_D       = { 1536,   1},
	.SVE_LD1B_GATHER_S    = { 1537,   1},
	.SVE_LD1B_GATHER_D    = { 1538,   1},
	.SVE_LD1H_GATHER_S    = { 1539,   1},
	.SVE_LD1H_GATHER_D    = { 1540,   1},
	.SVE_LD1W_GATHER_S    = { 1541,   1},
	.SVE_LD1W_GATHER_D    = { 1542,   1},
	.SVE_LD1D_GATHER_D    = { 1543,   1},
	.SVE_LD1SB_GATHER_S   = { 1544,   1},
	.SVE_LD1SB_GATHER_D   = { 1545,   1},
	.SVE_LD1SH_GATHER_S   = { 1546,   1},
	.SVE_LD1SH_GATHER_D   = { 1547,   1},
	.SVE_LD1SW_GATHER_D   = { 1548,   1},
	.SVE_ST1B_SCATTER_S   = { 1549,   1},
	.SVE_ST1B_SCATTER_D   = { 1550,   1},
	.SVE_ST1H_SCATTER_S   = { 1551,   1},
	.SVE_ST1H_SCATTER_D   = { 1552,   1},
	.SVE_ST1W_SCATTER_S   = { 1553,   1},
	.SVE_ST1W_SCATTER_D   = { 1554,   1},
	.SVE_ST1D_SCATTER_D   = { 1555,   1},
	.SME_LD1B_TILE        = { 1556,   1},
	.SME_LD1H_TILE        = { 1557,   1},
	.SME_LD1W_TILE        = { 1558,   1},
	.SME_LD1D_TILE        = { 1559,   1},
	.SME_LD1Q_TILE        = { 1560,   1},
	.SME_ST1B_TILE        = { 1561,   1},
	.SME_ST1H_TILE        = { 1562,   1},
	.SME_ST1W_TILE        = { 1563,   1},
	.SME_ST1D_TILE        = { 1564,   1},
	.SME_ST1Q_TILE        = { 1565,   1},
	.SME_MOVA_Z_FROM_TILE = { 1566,   1},
	.SME_MOVA_TILE_FROM_Z = { 1567,   1},
	.FCMLA_4H             = { 1568,   1},
	.FCMLA_8H             = { 1569,   1},
	.FCMLA_4S             = { 1570,   1},
	.FCMLA_2D             = { 1571,   1},
	...
	.ASR_IMM              = { 1666,   2},
	.ROR_IMM              = { 1668,   2},
	.SVE_BFADD_UNPRED     = { 1670,   1},
	.SVE_BFSUB_UNPRED     = { 1671,   1},
	.SVE_BFMUL_UNPRED     = { 1672,   1},
	.SVE_BFCLAMP          = { 1673,   1},
	.SVE_BFMAXNM          = { 1674,   1},
	.SVE_BFMINNM          = { 1675,   1},
	.SME2_LUTI2_B         = { 1676,   1},
	...
	.AT_S12E0W            = { 1760,   1},
	.TLBI_VMALLE1         = { 1761,   1},
	.TLBI_VMALLE1IS       = { 1762,   1},
	.TLBI_VAE1            = { 1763,   1},
	.TLBI_VAE1IS          = { 1764,   1},
	.TLBI_ASIDE1          = { 1765,   1},
	.TLBI_ASIDE1IS        = { 1766,   1},
	.TLBI_VAAE1           = { 1767,   1},
	.TLBI_VAAE1IS         = { 1768,   1},
	.TLBI_VALE1           = { 1769,   1},
	.TLBI_VALE1IS         = { 1770,   1},
	.TLBI_VAALE1          = { 1771,   1},
	.TLBI_VAALE1IS        = { 1772,   1},
	.TLBI_ALLE1           = { 1773,   1},
	.TLBI_ALLE1IS         = { 1774,   1},
	.TLBI_ALLE2           = { 1775,   1},
	.TLBI_ALLE2IS         = { 1776,   1},
