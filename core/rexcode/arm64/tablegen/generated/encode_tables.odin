...
@(rodata)
ENCODE_FORMS := [2275]lib.Encoding{
	// .ADD_IMM
...
ENCODE_RUNS := [lib.Mnemonic]lib.Encode_Run{
	...
	.SVE_LSL_PRED         = { 1749,   4},
	.SVE_LSR_PRED         = { 1753,   4},
	.SVE_ASRR_PRED        = { 1757,   0},
	.SVE_LSLR_PRED        = { 1757,   0},
	.SVE_LSRR_PRED        = { 1757,   0},
	.SVE_ABS_PRED         = { 1757,   4},
	.SVE_NEG_PRED         = { 1761,   4},
	.SVE_CLS_PRED         = { 1765,   4},
	.SVE_CLZ_PRED         = { 1769,   4},
	...
	.SVE_FRSQRTS          = { 1789,   3},
	.SVE_FTSMUL           = { 1792,   3},
	.SVE_FADD_PRED        = { 1795,   3},
	.SVE_FSUB_PRED        = { 1798,   3},
	.SVE_FSUBR_PRED       = { 1801,   0},
	.SVE_FMUL_PRED        = { 1801,   3},
	.SVE_FDIV_PRED        = { 1804,   3},
	.SVE_FDIVR_PRED       = { 1807,   0},
	.SVE_FMAX_PRED        = { 1807,   3},
	.SVE_FMIN_PRED        = { 1810,   3},
	.SVE_FMAXNM_PRED      = { 1813,   3},
	.SVE_FMINNM_PRED      = { 1816,   3},
	.SVE_FABS_Z           = { 1819,   3},
	.SVE_FNEG_Z           = { 1822,   3},
	.SVE_FSQRT_Z          = { 1825,   3},
	.SVE_FRECPX_Z         = { 1828,   0},
	...
	.SME_USMOPA           = { 1996,   1},
	.SME_SUMOPA           = { 1997,   1},
	.SME_MOVA_TO_Z        = { 1998,   0},
	.SME_MOVA_TO_ZA       = { 1998,   0},
	.SME_LD1B_ZA          = { 1998,   0},
	.SME_LD1H_ZA          = { 1998,   0},
	.SME_LD1W_ZA          = { 1998,   0},
	.SME_LD1D_ZA          = { 1998,   0},
	...
	.SME_LDR_ZA           = { 1998,   1},
	.SME_STR_ZA           = { 1999,   1},
	.SVE_FMLA_IDX_H       = { 2000,   1},
	.SVE_FMLA_IDX_S       = { 2001,   1},
	.SVE_FMLA_IDX_D       = { 2002,   1},
	.SVE_FMLS_IDX_H       = { 2003,   1},
	.SVE_FMLS_IDX_S       = { 2004,   1},
	.SVE_FMLS_IDX_D       = { 2005,   1},
	.SVE_LD1B_GATHER_S    = { 2006,   1},
	.SVE_LD1B_GATHER_D    = { 2007,   1},
	.SVE_LD1H_GATHER_S    = { 2008,   1},
	.SVE_LD1H_GATHER_D    = { 2009,   1},
	.SVE_LD1W_GATHER_S    = { 2010,   1},
	.SVE_LD1W_GATHER_D    = { 2011,   1},
	.SVE_LD1D_GATHER_D    = { 2012,   1},
	.SVE_LD1SB_GATHER_S   = { 2013,   1},
	.SVE_LD1SB_GATHER_D   = { 2014,   1},
	.SVE_LD1SH_GATHER_S   = { 2015,   1},
	.SVE_LD1SH_GATHER_D   = { 2016,   1},
	.SVE_LD1SW_GATHER_D   = { 2017,   1},
	.SVE_ST1B_SCATTER_S   = { 2018,   1},
	.SVE_ST1B_SCATTER_D   = { 2019,   1},
	.SVE_ST1H_SCATTER_S   = { 2020,   1},
	.SVE_ST1H_SCATTER_D   = { 2021,   1},
	.SVE_ST1W_SCATTER_S   = { 2022,   1},
	.SVE_ST1W_SCATTER_D   = { 2023,   1},
	.SVE_ST1D_SCATTER_D   = { 2024,   1},
	.SME_LD1B_TILE        = { 2025,   1},
	.SME_LD1H_TILE        = { 2026,   1},
	.SME_LD1W_TILE        = { 2027,   1},
	.SME_LD1D_TILE        = { 2028,   1},
	.SME_LD1Q_TILE        = { 2029,   1},
	.SME_ST1B_TILE        = { 2030,   1},
	.SME_ST1H_TILE        = { 2031,   1},
	.SME_ST1W_TILE        = { 2032,   1},
	.SME_ST1D_TILE        = { 2033,   1},
	.SME_ST1Q_TILE        = { 2034,   1},
	.SME_MOVA_Z_FROM_TILE = { 2035,   1},
	.SME_MOVA_TILE_FROM_Z = { 2036,   1},
	.FCMLA_4H             = { 2037,   1},
	.FCMLA_8H             = { 2038,   1},
	.FCMLA_4S             = { 2039,   1},
	.FCMLA_2D             = { 2040,   1},
	...
	.ASR_IMM              = { 2135,   2},
	.ROR_IMM              = { 2137,   2},
	.SVE_BFADD_UNPRED     = { 2139,   1},
	.SVE_BFSUB_UNPRED     = { 2140,   1},
	.SVE_BFMUL_UNPRED     = { 2141,   1},
	.SVE_BFCLAMP          = { 2142,   1},
	.SVE_BFMAXNM          = { 2143,   1},
	.SVE_BFMINNM          = { 2144,   1},
	.SME2_LUTI2_B         = { 2145,   1},
	...
	.AT_S12E0W            = { 2229,   1},
	.TLBI_VMALLE1         = { 2230,   1},
	.TLBI_VMALLE1IS       = { 2231,   1},
	.TLBI_VAE1            = { 2232,   1},
	.TLBI_VAE1IS          = { 2233,   1},
	.TLBI_ASIDE1          = { 2234,   1},
	.TLBI_ASIDE1IS        = { 2235,   1},
	.TLBI_VAAE1           = { 2236,   1},
	.TLBI_VAAE1IS         = { 2237,   1},
	.TLBI_VALE1           = { 2238,   1},
	.TLBI_VALE1IS         = { 2239,   1},
	.TLBI_VAALE1          = { 2240,   1},
	.TLBI_VAALE1IS        = { 2241,   1},
	.TLBI_ALLE1           = { 2242,   1},
	.TLBI_ALLE1IS         = { 2243,   1},
	.TLBI_ALLE2           = { 2244,   1},
	.TLBI_ALLE2IS         = { 2245,   1},
