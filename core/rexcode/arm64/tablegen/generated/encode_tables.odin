...
@(rodata)
ENCODE_FORMS := [1353]lib.Encoding{
	// .ADD_IMM
...
ENCODE_RUNS := [lib.Mnemonic]lib.Encode_Run{
	...
	.SVE_SUBR_PRED        = {  775,   4},
	.SVE_MUL_PRED         = {  779,   4},
	.SVE_SMULH_PRED       = {  783,   4},
	.SVE_UMULH_PRED       = {  787,   4},
	.SVE_SDIV_PRED        = {  791,   2},
	.SVE_UDIV_PRED        = {  793,   2},
	.SVE_SMAX_PRED        = {  795,   4},
	.SVE_UMAX_PRED        = {  799,   4},
	...
	.SVE_FADD_PRED        = {  873,   3},
	.SVE_FSUB_PRED        = {  876,   3},
	.SVE_FSUBR_PRED       = {  879,   0},
	.SVE_FMUL_PRED        = {  879,   3},
	.SVE_FDIV_PRED        = {  882,   3},
	.SVE_FDIVR_PRED       = {  885,   0},
	.SVE_FMAX_PRED        = {  885,   3},
	.SVE_FMIN_PRED        = {  888,   3},
	.SVE_FMAXNM_PRED      = {  891,   3},
	.SVE_FMINNM_PRED      = {  894,   3},
	.SVE_FABS_Z           = {  897,   3},
	.SVE_FNEG_Z           = {  900,   3},
	.SVE_FSQRT_Z          = {  903,   3},
	.SVE_FRECPX_Z         = {  906,   0},
	...
	.SME_USMOPA           = { 1074,   1},
	.SME_SUMOPA           = { 1075,   1},
	.SME_MOVA_TO_Z        = { 1076,   0},
	.SME_MOVA_TO_ZA       = { 1076,   0},
	.SME_LD1B_ZA          = { 1076,   0},
	.SME_LD1H_ZA          = { 1076,   0},
	.SME_LD1W_ZA          = { 1076,   0},
	.SME_LD1D_ZA          = { 1076,   0},
	...
	.SME_LDR_ZA           = { 1076,   1},
	.SME_STR_ZA           = { 1077,   1},
	.SVE_FMLA_IDX_H       = { 1078,   1},
	.SVE_FMLA_IDX_S       = { 1079,   1},
	.SVE_FMLA_IDX_D       = { 1080,   1},
	.SVE_FMLS_IDX_H       = { 1081,   1},
	.SVE_FMLS_IDX_S       = { 1082,   1},
	.SVE_FMLS_IDX_D       = { 1083,   1},
	.SVE_LD1B_GATHER_S    = { 1084,   1},
	.SVE_LD1B_GATHER_D    = { 1085,   1},
	.SVE_LD1H_GATHER_S    = { 1086,   1},
	.SVE_LD1H_GATHER_D    = { 1087,   1},
	.SVE_LD1W_GATHER_S    = { 1088,   1},
	.SVE_LD1W_GATHER_D    = { 1089,   1},
	.SVE_LD1D_GATHER_D    = { 1090,   1},
	.SVE_LD1SB_GATHER_S   = { 1091,   1},
	.SVE_LD1SB_GATHER_D   = { 1092,   1},
	.SVE_LD1SH_GATHER_S   = { 1093,   1},
	.SVE_LD1SH_GATHER_D   = { 1094,   1},
	.SVE_LD1SW_GATHER_D   = { 1095,   1},
	.SVE_ST1B_SCATTER_S   = { 1096,   1},
	.SVE_ST1B_SCATTER_D   = { 1097,   1},
	.SVE_ST1H_SCATTER_S   = { 1098,   1},
	.SVE_ST1H_SCATTER_D   = { 1099,   1},
	.SVE_ST1W_SCATTER_S   = { 1100,   1},
	.SVE_ST1W_SCATTER_D   = { 1101,   1},
	.SVE_ST1D_SCATTER_D   = { 1102,   1},
	.SME_LD1B_TILE        = { 1103,   1},
	.SME_LD1H_TILE        = { 1104,   1},
	.SME_LD1W_TILE        = { 1105,   1},
	.SME_LD1D_TILE        = { 1106,   1},
	.SME_LD1Q_TILE        = { 1107,   1},
	.SME_ST1B_TILE        = { 1108,   1},
	.SME_ST1H_TILE        = { 1109,   1},
	.SME_ST1W_TILE        = { 1110,   1},
	.SME_ST1D_TILE        = { 1111,   1},
	.SME_ST1Q_TILE        = { 1112,   1},
	.SME_MOVA_Z_FROM_TILE = { 1113,   1},
	.SME_MOVA_TILE_FROM_Z = { 1114,   1},
	.FCMLA_4H             = { 1115,   1},
	.FCMLA_8H             = { 1116,   1},
	.FCMLA_4S             = { 1117,   1},
	.FCMLA_2D             = { 1118,   1},
	...
	.ASR_IMM              = { 1213,   2},
	.ROR_IMM              = { 1215,   2},
	.SVE_BFADD_UNPRED     = { 1217,   1},
	.SVE_BFSUB_UNPRED     = { 1218,   1},
	.SVE_BFMUL_UNPRED     = { 1219,   1},
	.SVE_BFCLAMP          = { 1220,   1},
	.SVE_BFMAXNM          = { 1221,   1},
	.SVE_BFMINNM          = { 1222,   1},
	.SME2_LUTI2_B         = { 1223,   1},
	...
	.AT_S12E0W            = { 1307,   1},
	.TLBI_VMALLE1         = { 1308,   1},
	.TLBI_VMALLE1IS       = { 1309,   1},
	.TLBI_VAE1            = { 1310,   1},
	.TLBI_VAE1IS          = { 1311,   1},
	.TLBI_ASIDE1          = { 1312,   1},
	.TLBI_ASIDE1IS        = { 1313,   1},
	.TLBI_VAAE1           = { 1314,   1},
	.TLBI_VAAE1IS         = { 1315,   1},
	.TLBI_VALE1           = { 1316,   1},
	.TLBI_VALE1IS         = { 1317,   1},
	.TLBI_VAALE1          = { 1318,   1},
	.TLBI_VAALE1IS        = { 1319,   1},
	.TLBI_ALLE1           = { 1320,   1},
	.TLBI_ALLE1IS         = { 1321,   1},
	.TLBI_ALLE2           = { 1322,   1},
	.TLBI_ALLE2IS         = { 1323,   1},
