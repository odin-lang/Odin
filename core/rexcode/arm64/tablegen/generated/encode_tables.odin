...
ENCODE_RUNS := [lib.Mnemonic]lib.Encode_Run{
	...
	.SVE_SUBR_PRED        = {  618,   4},
	.SVE_MUL_PRED         = {  622,   4},
	.SVE_SMULH_PRED       = {  626,   4},
	.SVE_UMULH_PRED       = {  630,   4},
	.SVE_SDIV_PRED        = {  634,   2},
	.SVE_UDIV_PRED        = {  636,   2},
	.SVE_SMAX_PRED        = {  638,   4},
	.SVE_UMAX_PRED        = {  642,   4},
	...
	.SVE_FADD_PRED        = {  716,   3},
	.SVE_FSUB_PRED        = {  719,   3},
	.SVE_FSUBR_PRED       = {  722,   0},
	.SVE_FMUL_PRED        = {  722,   3},
	.SVE_FDIV_PRED        = {  725,   3},
	.SVE_FDIVR_PRED       = {  728,   0},
	.SVE_FMAX_PRED        = {  728,   3},
	.SVE_FMIN_PRED        = {  731,   3},
	.SVE_FMAXNM_PRED      = {  734,   3},
	.SVE_FMINNM_PRED      = {  737,   3},
	.SVE_FABS_Z           = {  740,   3},
	.SVE_FNEG_Z           = {  743,   3},
	.SVE_FSQRT_Z          = {  746,   3},
	.SVE_FRECPX_Z         = {  749,   0},
	...
	.SME_LDR_ZA           = {  919,   1},
	.SME_STR_ZA           = {  920,   1},
	.SVE_FMLA_IDX_H       = {  921,   1},
	.SVE_FMLA_IDX_S       = {  922,   1},
	.SVE_FMLA_IDX_D       = {  923,   1},
	.SVE_FMLS_IDX_H       = {  924,   1},
	.SVE_FMLS_IDX_S       = {  925,   1},
	.SVE_FMLS_IDX_D       = {  926,   1},
	.SVE_LD1B_GATHER_S    = {  927,   1},
	.SVE_LD1B_GATHER_D    = {  928,   1},
	.SVE_LD1H_GATHER_S    = {  929,   1},
	.SVE_LD1H_GATHER_D    = {  930,   1},
	.SVE_LD1W_GATHER_S    = {  931,   1},
	.SVE_LD1W_GATHER_D    = {  932,   1},
	.SVE_LD1D_GATHER_D    = {  933,   1},
	.SVE_LD1SB_GATHER_S   = {  934,   1},
	.SVE_LD1SB_GATHER_D   = {  935,   1},
	.SVE_LD1SH_GATHER_S   = {  936,   1},
	.SVE_LD1SH_GATHER_D   = {  937,   1},
	.SVE_LD1SW_GATHER_D   = {  938,   1},
	.SVE_ST1B_SCATTER_S   = {  939,   1},
	.SVE_ST1B_SCATTER_D   = {  940,   1},
	.SVE_ST1H_SCATTER_S   = {  941,   1},
	.SVE_ST1H_SCATTER_D   = {  942,   1},
	.SVE_ST1W_SCATTER_S   = {  943,   1},
	.SVE_ST1W_SCATTER_D   = {  944,   1},
	.SVE_ST1D_SCATTER_D   = {  945,   1},
	.SME_LD1B_TILE        = {  946,   1},
	.SME_LD1H_TILE        = {  947,   1},
	.SME_LD1W_TILE        = {  948,   1},
	.SME_LD1D_TILE        = {  949,   1},
	...
	.SME_ST1D_TILE        = {  954,   1},
	.SME_ST1Q_TILE        = {  955,   1},
	.SME_MOVA_Z_FROM_TILE = {  956,   1},
	.SME_MOVA_TILE_FROM_Z = {  957,   1},
	.FCMLA_4H             = {  958,   1},
	.FCMLA_8H             = {  959,   1},
	.FCMLA_4S             = {  960,   1},
	.FCMLA_2D             = {  961,   1},
	...
	.ASR_IMM              = { 1056,   2},
	.ROR_IMM              = { 1058,   2},
	.SVE_BFADD_UNPRED     = { 1060,   1},
	.SVE_BFSUB_UNPRED     = { 1061,   1},
	.SVE_BFMUL_UNPRED     = { 1062,   1},
	.SVE_BFCLAMP          = { 1063,   1},
	.SVE_BFMAXNM          = { 1064,   1},
	.SVE_BFMINNM          = { 1065,   1},
	.SME2_LUTI2_B         = { 1066,   1},
	...
	.AT_S12E0W            = { 1150,   1},
	.TLBI_VMALLE1         = { 1151,   1},
	.TLBI_VMALLE1IS       = { 1152,   1},
	.TLBI_VAE1            = { 1153,   1},
	.TLBI_VAE1IS          = { 1154,   1},
	.TLBI_ASIDE1          = { 1155,   1},
	.TLBI_ASIDE1IS        = { 1156,   1},
	.TLBI_VAAE1           = { 1157,   1},
	.TLBI_VAAE1IS         = { 1158,   1},
	.TLBI_VALE1           = { 1159,   1},
	.TLBI_VALE1IS         = { 1160,   1},
	.TLBI_VAALE1          = { 1161,   1},
	.TLBI_VAALE1IS        = { 1162,   1},
	.TLBI_ALLE1           = { 1163,   1},
	.TLBI_ALLE1IS         = { 1164,   1},
	.TLBI_ALLE2           = { 1165,   1},
	.TLBI_ALLE2IS         = { 1166,   1},
