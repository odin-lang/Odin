...
@(rodata)
ENCODE_FORMS := [1993]lib.Encoding{
	// .ADD_IMM
...
ENCODE_RUNS := [lib.Mnemonic]lib.Encode_Run{
	...
	.SVE_ADD_PRED         = { 1407,   4},
	.SVE_SUB_PRED         = { 1411,   4},
	.SVE_SUBR_PRED        = { 1415,   4},
	.SVE_MUL_PRED         = { 1419,   4},
	.SVE_SMULH_PRED       = { 1423,   4},
	.SVE_UMULH_PRED       = { 1427,   4},
	.SVE_SDIV_PRED        = { 1431,   2},
	.SVE_UDIV_PRED        = { 1433,   2},
	.SVE_SMAX_PRED        = { 1435,   4},
	.SVE_UMAX_PRED        = { 1439,   4},
	.SVE_SMIN_PRED        = { 1443,   4},
	.SVE_UMIN_PRED        = { 1447,   4},
	.SVE_SABD_PRED        = { 1451,   4},
	.SVE_UABD_PRED        = { 1455,   4},
	.SVE_AND_PRED         = { 1459,   1},
	.SVE_ORR_PRED         = { 1460,   1},
	.SVE_EOR_PRED         = { 1461,   1},
	.SVE_BIC_PRED         = { 1462,   1},
	...
	.SVE_LSL_PRED         = { 1467,   4},
	.SVE_LSR_PRED         = { 1471,   4},
	.SVE_ASRR_PRED        = { 1475,   0},
	.SVE_LSLR_PRED        = { 1475,   0},
	.SVE_LSRR_PRED        = { 1475,   0},
	.SVE_ABS_PRED         = { 1475,   4},
	.SVE_NEG_PRED         = { 1479,   4},
	.SVE_CLS_PRED         = { 1483,   4},
	.SVE_CLZ_PRED         = { 1487,   4},
	...
	.SVE_FRSQRTS          = { 1507,   3},
	.SVE_FTSMUL           = { 1510,   3},
	.SVE_FADD_PRED        = { 1513,   3},
	.SVE_FSUB_PRED        = { 1516,   3},
	.SVE_FSUBR_PRED       = { 1519,   0},
	.SVE_FMUL_PRED        = { 1519,   3},
	.SVE_FDIV_PRED        = { 1522,   3},
	.SVE_FDIVR_PRED       = { 1525,   0},
	.SVE_FMAX_PRED        = { 1525,   3},
	.SVE_FMIN_PRED        = { 1528,   3},
	.SVE_FMAXNM_PRED      = { 1531,   3},
	.SVE_FMINNM_PRED      = { 1534,   3},
	.SVE_FABS_Z           = { 1537,   3},
	.SVE_FNEG_Z           = { 1540,   3},
	.SVE_FSQRT_Z          = { 1543,   3},
	.SVE_FRECPX_Z         = { 1546,   0},
	...
	.SME_USMOPA           = { 1714,   1},
	.SME_SUMOPA           = { 1715,   1},
	.SME_MOVA_TO_Z        = { 1716,   0},
	.SME_MOVA_TO_ZA       = { 1716,   0},
	.SME_LD1B_ZA          = { 1716,   0},
	.SME_LD1H_ZA          = { 1716,   0},
	.SME_LD1W_ZA          = { 1716,   0},
	.SME_LD1D_ZA          = { 1716,   0},
	...
	.SME_LDR_ZA           = { 1716,   1},
	.SME_STR_ZA           = { 1717,   1},
	.SVE_FMLA_IDX_H       = { 1718,   1},
	.SVE_FMLA_IDX_S       = { 1719,   1},
	.SVE_FMLA_IDX_D       = { 1720,   1},
	.SVE_FMLS_IDX_H       = { 1721,   1},
	.SVE_FMLS_IDX_S       = { 1722,   1},
	.SVE_FMLS_IDX_D       = { 1723,   1},
	.SVE_LD1B_GATHER_S    = { 1724,   1},
	.SVE_LD1B_GATHER_D    = { 1725,   1},
	.SVE_LD1H_GATHER_S    = { 1726,   1},
	.SVE_LD1H_GATHER_D    = { 1727,   1},
	.SVE_LD1W_GATHER_S    = { 1728,   1},
	.SVE_LD1W_GATHER_D    = { 1729,   1},
	.SVE_LD1D_GATHER_D    = { 1730,   1},
	.SVE_LD1SB_GATHER_S   = { 1731,   1},
	.SVE_LD1SB_GATHER_D   = { 1732,   1},
	.SVE_LD1SH_GATHER_S   = { 1733,   1},
	.SVE_LD1SH_GATHER_D   = { 1734,   1},
	.SVE_LD1SW_GATHER_D   = { 1735,   1},
	.SVE_ST1B_SCATTER_S   = { 1736,   1},
	.SVE_ST1B_SCATTER_D   = { 1737,   1},
	.SVE_ST1H_SCATTER_S   = { 1738,   1},
	.SVE_ST1H_SCATTER_D   = { 1739,   1},
	.SVE_ST1W_SCATTER_S   = { 1740,   1},
	.SVE_ST1W_SCATTER_D   = { 1741,   1},
	.SVE_ST1D_SCATTER_D   = { 1742,   1},
	.SME_LD1B_TILE        = { 1743,   1},
	.SME_LD1H_TILE        = { 1744,   1},
	.SME_LD1W_TILE        = { 1745,   1},
	.SME_LD1D_TILE        = { 1746,   1},
	.SME_LD1Q_TILE        = { 1747,   1},
	.SME_ST1B_TILE        = { 1748,   1},
	.SME_ST1H_TILE        = { 1749,   1},
	.SME_ST1W_TILE        = { 1750,   1},
	.SME_ST1D_TILE        = { 1751,   1},
	.SME_ST1Q_TILE        = { 1752,   1},
	.SME_MOVA_Z_FROM_TILE = { 1753,   1},
	.SME_MOVA_TILE_FROM_Z = { 1754,   1},
	.FCMLA_4H             = { 1755,   1},
	.FCMLA_8H             = { 1756,   1},
	.FCMLA_4S             = { 1757,   1},
	.FCMLA_2D             = { 1758,   1},
	...
	.ASR_IMM              = { 1853,   2},
	.ROR_IMM              = { 1855,   2},
	.SVE_BFADD_UNPRED     = { 1857,   1},
	.SVE_BFSUB_UNPRED     = { 1858,   1},
	.SVE_BFMUL_UNPRED     = { 1859,   1},
	.SVE_BFCLAMP          = { 1860,   1},
	.SVE_BFMAXNM          = { 1861,   1},
	.SVE_BFMINNM          = { 1862,   1},
	.SME2_LUTI2_B         = { 1863,   1},
	...
	.AT_S12E0W            = { 1947,   1},
	.TLBI_VMALLE1         = { 1948,   1},
	.TLBI_VMALLE1IS       = { 1949,   1},
	.TLBI_VAE1            = { 1950,   1},
	.TLBI_VAE1IS          = { 1951,   1},
	.TLBI_ASIDE1          = { 1952,   1},
	.TLBI_ASIDE1IS        = { 1953,   1},
	.TLBI_VAAE1           = { 1954,   1},
	.TLBI_VAAE1IS         = { 1955,   1},
	.TLBI_VALE1           = { 1956,   1},
	.TLBI_VALE1IS         = { 1957,   1},
	.TLBI_VAALE1          = { 1958,   1},
	.TLBI_VAALE1IS        = { 1959,   1},
	.TLBI_ALLE1           = { 1960,   1},
	.TLBI_ALLE1IS         = { 1961,   1},
	.TLBI_ALLE2           = { 1962,   1},
	.TLBI_ALLE2IS         = { 1963,   1},
