...
@(rodata)
ENCODE_FORMS := [2256]lib.Encoding{
	// .ADD_IMM
...
ENCODE_RUNS := [lib.Mnemonic]lib.Encode_Run{
	...
	.SVE_ADD_PRED         = { 1670,   4},
	.SVE_SUB_PRED         = { 1674,   4},
	.SVE_SUBR_PRED        = { 1678,   4},
	.SVE_MUL_PRED         = { 1682,   4},
	.SVE_SMULH_PRED       = { 1686,   4},
	.SVE_UMULH_PRED       = { 1690,   4},
	.SVE_SDIV_PRED        = { 1694,   2},
	.SVE_UDIV_PRED        = { 1696,   2},
	.SVE_SMAX_PRED        = { 1698,   4},
	.SVE_UMAX_PRED        = { 1702,   4},
	.SVE_SMIN_PRED        = { 1706,   4},
	.SVE_UMIN_PRED        = { 1710,   4},
	.SVE_SABD_PRED        = { 1714,   4},
	.SVE_UABD_PRED        = { 1718,   4},
	.SVE_AND_PRED         = { 1722,   1},
	.SVE_ORR_PRED         = { 1723,   1},
	.SVE_EOR_PRED         = { 1724,   1},
	.SVE_BIC_PRED         = { 1725,   1},
	...
	.SVE_LSL_PRED         = { 1730,   4},
	.SVE_LSR_PRED         = { 1734,   4},
	.SVE_ASRR_PRED        = { 1738,   0},
	.SVE_LSLR_PRED        = { 1738,   0},
	.SVE_LSRR_PRED        = { 1738,   0},
	.SVE_ABS_PRED         = { 1738,   4},
	.SVE_NEG_PRED         = { 1742,   4},
	.SVE_CLS_PRED         = { 1746,   4},
	.SVE_CLZ_PRED         = { 1750,   4},
	...
	.SVE_FRSQRTS          = { 1770,   3},
	.SVE_FTSMUL           = { 1773,   3},
	.SVE_FADD_PRED        = { 1776,   3},
	.SVE_FSUB_PRED        = { 1779,   3},
	.SVE_FSUBR_PRED       = { 1782,   0},
	.SVE_FMUL_PRED        = { 1782,   3},
	.SVE_FDIV_PRED        = { 1785,   3},
	.SVE_FDIVR_PRED       = { 1788,   0},
	.SVE_FMAX_PRED        = { 1788,   3},
	.SVE_FMIN_PRED        = { 1791,   3},
	.SVE_FMAXNM_PRED      = { 1794,   3},
	.SVE_FMINNM_PRED      = { 1797,   3},
	.SVE_FABS_Z           = { 1800,   3},
	.SVE_FNEG_Z           = { 1803,   3},
	.SVE_FSQRT_Z          = { 1806,   3},
	.SVE_FRECPX_Z         = { 1809,   0},
	...
	.SME_USMOPA           = { 1977,   1},
	.SME_SUMOPA           = { 1978,   1},
	.SME_MOVA_TO_Z        = { 1979,   0},
	.SME_MOVA_TO_ZA       = { 1979,   0},
	.SME_LD1B_ZA          = { 1979,   0},
	.SME_LD1H_ZA          = { 1979,   0},
	.SME_LD1W_ZA          = { 1979,   0},
	.SME_LD1D_ZA          = { 1979,   0},
	...
	.SME_LDR_ZA           = { 1979,   1},
	.SME_STR_ZA           = { 1980,   1},
	.SVE_FMLA_IDX_H       = { 1981,   1},
	.SVE_FMLA_IDX_S       = { 1982,   1},
	.SVE_FMLA_IDX_D       = { 1983,   1},
	.SVE_FMLS_IDX_H       = { 1984,   1},
	.SVE_FMLS_IDX_S       = { 1985,   1},
	.SVE_FMLS_IDX_D       = { 1986,   1},
	.SVE_LD1B_GATHER_S    = { 1987,   1},
	.SVE_LD1B_GATHER_D    = { 1988,   1},
	.SVE_LD1H_GATHER_S    = { 1989,   1},
	.SVE_LD1H_GATHER_D    = { 1990,   1},
	.SVE_LD1W_GATHER_S    = { 1991,   1},
	.SVE_LD1W_GATHER_D    = { 1992,   1},
	.SVE_LD1D_GATHER_D    = { 1993,   1},
	.SVE_LD1SB_GATHER_S   = { 1994,   1},
	.SVE_LD1SB_GATHER_D   = { 1995,   1},
	.SVE_LD1SH_GATHER_S   = { 1996,   1},
	.SVE_LD1SH_GATHER_D   = { 1997,   1},
	.SVE_LD1SW_GATHER_D   = { 1998,   1},
	.SVE_ST1B_SCATTER_S   = { 1999,   1},
	.SVE_ST1B_SCATTER_D   = { 2000,   1},
	.SVE_ST1H_SCATTER_S   = { 2001,   1},
	.SVE_ST1H_SCATTER_D   = { 2002,   1},
	.SVE_ST1W_SCATTER_S   = { 2003,   1},
	.SVE_ST1W_SCATTER_D   = { 2004,   1},
	.SVE_ST1D_SCATTER_D   = { 2005,   1},
	.SME_LD1B_TILE        = { 2006,   1},
	.SME_LD1H_TILE        = { 2007,   1},
	.SME_LD1W_TILE        = { 2008,   1},
	.SME_LD1D_TILE        = { 2009,   1},
	.SME_LD1Q_TILE        = { 2010,   1},
	.SME_ST1B_TILE        = { 2011,   1},
	.SME_ST1H_TILE        = { 2012,   1},
	.SME_ST1W_TILE        = { 2013,   1},
	.SME_ST1D_TILE        = { 2014,   1},
	.SME_ST1Q_TILE        = { 2015,   1},
	.SME_MOVA_Z_FROM_TILE = { 2016,   1},
	.SME_MOVA_TILE_FROM_Z = { 2017,   1},
	.FCMLA_4H             = { 2018,   1},
	.FCMLA_8H             = { 2019,   1},
	.FCMLA_4S             = { 2020,   1},
	.FCMLA_2D             = { 2021,   1},
	...
	.ASR_IMM              = { 2116,   2},
	.ROR_IMM              = { 2118,   2},
	.SVE_BFADD_UNPRED     = { 2120,   1},
	.SVE_BFSUB_UNPRED     = { 2121,   1},
	.SVE_BFMUL_UNPRED     = { 2122,   1},
	.SVE_BFCLAMP          = { 2123,   1},
	.SVE_BFMAXNM          = { 2124,   1},
	.SVE_BFMINNM          = { 2125,   1},
	.SME2_LUTI2_B         = { 2126,   1},
	...
	.AT_S12E0W            = { 2210,   1},
	.TLBI_VMALLE1         = { 2211,   1},
	.TLBI_VMALLE1IS       = { 2212,   1},
	.TLBI_VAE1            = { 2213,   1},
	.TLBI_VAE1IS          = { 2214,   1},
	.TLBI_ASIDE1          = { 2215,   1},
	.TLBI_ASIDE1IS        = { 2216,   1},
	.TLBI_VAAE1           = { 2217,   1},
	.TLBI_VAAE1IS         = { 2218,   1},
	.TLBI_VALE1           = { 2219,   1},
	.TLBI_VALE1IS         = { 2220,   1},
	.TLBI_VAALE1          = { 2221,   1},
	.TLBI_VAALE1IS        = { 2222,   1},
	.TLBI_ALLE1           = { 2223,   1},
	.TLBI_ALLE1IS         = { 2224,   1},
	.TLBI_ALLE2           = { 2225,   1},
	.TLBI_ALLE2IS         = { 2226,   1},
