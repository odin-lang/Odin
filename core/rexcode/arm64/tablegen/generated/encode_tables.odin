...
@(rodata)
ENCODE_FORMS := [1518]lib.Encoding{
	// .ADD_IMM
...
ENCODE_RUNS := [lib.Mnemonic]lib.Encode_Run{
	...
	.SVE_SUBR_PRED        = {  940,   4},
	.SVE_MUL_PRED         = {  944,   4},
	.SVE_SMULH_PRED       = {  948,   4},
	.SVE_UMULH_PRED       = {  952,   4},
	.SVE_SDIV_PRED        = {  956,   2},
	.SVE_UDIV_PRED        = {  958,   2},
	.SVE_SMAX_PRED        = {  960,   4},
	.SVE_UMAX_PRED        = {  964,   4},
	...
	.SVE_LSL_PRED         = {  992,   4},
	.SVE_LSR_PRED         = {  996,   4},
	.SVE_ASRR_PRED        = { 1000,   0},
	.SVE_LSLR_PRED        = { 1000,   0},
	.SVE_LSRR_PRED        = { 1000,   0},
	.SVE_ABS_PRED         = { 1000,   4},
	.SVE_NEG_PRED         = { 1004,   4},
	.SVE_CLS_PRED         = { 1008,   4},
	.SVE_CLZ_PRED         = { 1012,   4},
	...
	.SVE_FRSQRTS          = { 1032,   3},
	.SVE_FTSMUL           = { 1035,   3},
	.SVE_FADD_PRED        = { 1038,   3},
	.SVE_FSUB_PRED        = { 1041,   3},
	.SVE_FSUBR_PRED       = { 1044,   0},
	.SVE_FMUL_PRED        = { 1044,   3},
	.SVE_FDIV_PRED        = { 1047,   3},
	.SVE_FDIVR_PRED       = { 1050,   0},
	.SVE_FMAX_PRED        = { 1050,   3},
	.SVE_FMIN_PRED        = { 1053,   3},
	.SVE_FMAXNM_PRED      = { 1056,   3},
	.SVE_FMINNM_PRED      = { 1059,   3},
	.SVE_FABS_Z           = { 1062,   3},
	.SVE_FNEG_Z           = { 1065,   3},
	.SVE_FSQRT_Z          = { 1068,   3},
	.SVE_FRECPX_Z         = { 1071,   0},
	...
	.SME_USMOPA           = { 1239,   1},
	.SME_SUMOPA           = { 1240,   1},
	.SME_MOVA_TO_Z        = { 1241,   0},
	.SME_MOVA_TO_ZA       = { 1241,   0},
	.SME_LD1B_ZA          = { 1241,   0},
	.SME_LD1H_ZA          = { 1241,   0},
	.SME_LD1W_ZA          = { 1241,   0},
	.SME_LD1D_ZA          = { 1241,   0},
	...
	.SME_LDR_ZA           = { 1241,   1},
	.SME_STR_ZA           = { 1242,   1},
	.SVE_FMLA_IDX_H       = { 1243,   1},
	.SVE_FMLA_IDX_S       = { 1244,   1},
	.SVE_FMLA_IDX_D       = { 1245,   1},
	.SVE_FMLS_IDX_H       = { 1246,   1},
	.SVE_FMLS_IDX_S       = { 1247,   1},
	.SVE_FMLS_IDX_D       = { 1248,   1},
	.SVE_LD1B_GATHER_S    = { 1249,   1},
	.SVE_LD1B_GATHER_D    = { 1250,   1},
	.SVE_LD1H_GATHER_S    = { 1251,   1},
	.SVE_LD1H_GATHER_D    = { 1252,   1},
	.SVE_LD1W_GATHER_S    = { 1253,   1},
	.SVE_LD1W_GATHER_D    = { 1254,   1},
	.SVE_LD1D_GATHER_D    = { 1255,   1},
	.SVE_LD1SB_GATHER_S   = { 1256,   1},
	.SVE_LD1SB_GATHER_D   = { 1257,   1},
	.SVE_LD1SH_GATHER_S   = { 1258,   1},
	.SVE_LD1SH_GATHER_D   = { 1259,   1},
	.SVE_LD1SW_GATHER_D   = { 1260,   1},
	.SVE_ST1B_SCATTER_S   = { 1261,   1},
	.SVE_ST1B_SCATTER_D   = { 1262,   1},
	.SVE_ST1H_SCATTER_S   = { 1263,   1},
	.SVE_ST1H_SCATTER_D   = { 1264,   1},
	.SVE_ST1W_SCATTER_S   = { 1265,   1},
	.SVE_ST1W_SCATTER_D   = { 1266,   1},
	.SVE_ST1D_SCATTER_D   = { 1267,   1},
	.SME_LD1B_TILE        = { 1268,   1},
	.SME_LD1H_TILE        = { 1269,   1},
	.SME_LD1W_TILE        = { 1270,   1},
	.SME_LD1D_TILE        = { 1271,   1},
	.SME_LD1Q_TILE        = { 1272,   1},
	.SME_ST1B_TILE        = { 1273,   1},
	.SME_ST1H_TILE        = { 1274,   1},
	.SME_ST1W_TILE        = { 1275,   1},
	.SME_ST1D_TILE        = { 1276,   1},
	.SME_ST1Q_TILE        = { 1277,   1},
	.SME_MOVA_Z_FROM_TILE = { 1278,   1},
	.SME_MOVA_TILE_FROM_Z = { 1279,   1},
	.FCMLA_4H             = { 1280,   1},
	.FCMLA_8H             = { 1281,   1},
	.FCMLA_4S             = { 1282,   1},
	.FCMLA_2D             = { 1283,   1},
	...
	.ASR_IMM              = { 1378,   2},
	.ROR_IMM              = { 1380,   2},
	.SVE_BFADD_UNPRED     = { 1382,   1},
	.SVE_BFSUB_UNPRED     = { 1383,   1},
	.SVE_BFMUL_UNPRED     = { 1384,   1},
	.SVE_BFCLAMP          = { 1385,   1},
	.SVE_BFMAXNM          = { 1386,   1},
	.SVE_BFMINNM          = { 1387,   1},
	.SME2_LUTI2_B         = { 1388,   1},
	...
	.AT_S12E0W            = { 1472,   1},
	.TLBI_VMALLE1         = { 1473,   1},
	.TLBI_VMALLE1IS       = { 1474,   1},
	.TLBI_VAE1            = { 1475,   1},
	.TLBI_VAE1IS          = { 1476,   1},
	.TLBI_ASIDE1          = { 1477,   1},
	.TLBI_ASIDE1IS        = { 1478,   1},
	.TLBI_VAAE1           = { 1479,   1},
	.TLBI_VAAE1IS         = { 1480,   1},
	.TLBI_VALE1           = { 1481,   1},
	.TLBI_VALE1IS         = { 1482,   1},
	.TLBI_VAALE1          = { 1483,   1},
	.TLBI_VAALE1IS        = { 1484,   1},
	.TLBI_ALLE1           = { 1485,   1},
	.TLBI_ALLE1IS         = { 1486,   1},
	.TLBI_ALLE2           = { 1487,   1},
	.TLBI_ALLE2IS         = { 1488,   1},
