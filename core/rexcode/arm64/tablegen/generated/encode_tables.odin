...
@(rodata)
ENCODE_FORMS := [2219]lib.Encoding{
	// .ADD_IMM
...
ENCODE_RUNS := [lib.Mnemonic]lib.Encode_Run{
	...
	.SVE_ADD_PRED         = { 1633,   4},
	.SVE_SUB_PRED         = { 1637,   4},
	.SVE_SUBR_PRED        = { 1641,   4},
	.SVE_MUL_PRED         = { 1645,   4},
	.SVE_SMULH_PRED       = { 1649,   4},
	.SVE_UMULH_PRED       = { 1653,   4},
	.SVE_SDIV_PRED        = { 1657,   2},
	.SVE_UDIV_PRED        = { 1659,   2},
	.SVE_SMAX_PRED        = { 1661,   4},
	.SVE_UMAX_PRED        = { 1665,   4},
	.SVE_SMIN_PRED        = { 1669,   4},
	.SVE_UMIN_PRED        = { 1673,   4},
	.SVE_SABD_PRED        = { 1677,   4},
	.SVE_UABD_PRED        = { 1681,   4},
	.SVE_AND_PRED         = { 1685,   1},
	.SVE_ORR_PRED         = { 1686,   1},
	.SVE_EOR_PRED         = { 1687,   1},
	.SVE_BIC_PRED         = { 1688,   1},
	...
	.SVE_LSL_PRED         = { 1693,   4},
	.SVE_LSR_PRED         = { 1697,   4},
	.SVE_ASRR_PRED        = { 1701,   0},
	.SVE_LSLR_PRED        = { 1701,   0},
	.SVE_LSRR_PRED        = { 1701,   0},
	.SVE_ABS_PRED         = { 1701,   4},
	.SVE_NEG_PRED         = { 1705,   4},
	.SVE_CLS_PRED         = { 1709,   4},
	.SVE_CLZ_PRED         = { 1713,   4},
	...
	.SVE_FRSQRTS          = { 1733,   3},
	.SVE_FTSMUL           = { 1736,   3},
	.SVE_FADD_PRED        = { 1739,   3},
	.SVE_FSUB_PRED        = { 1742,   3},
	.SVE_FSUBR_PRED       = { 1745,   0},
	.SVE_FMUL_PRED        = { 1745,   3},
	.SVE_FDIV_PRED        = { 1748,   3},
	.SVE_FDIVR_PRED       = { 1751,   0},
	.SVE_FMAX_PRED        = { 1751,   3},
	.SVE_FMIN_PRED        = { 1754,   3},
	.SVE_FMAXNM_PRED      = { 1757,   3},
	.SVE_FMINNM_PRED      = { 1760,   3},
	.SVE_FABS_Z           = { 1763,   3},
	.SVE_FNEG_Z           = { 1766,   3},
	.SVE_FSQRT_Z          = { 1769,   3},
	.SVE_FRECPX_Z         = { 1772,   0},
	...
	.SME_USMOPA           = { 1940,   1},
	.SME_SUMOPA           = { 1941,   1},
	.SME_MOVA_TO_Z        = { 1942,   0},
	.SME_MOVA_TO_ZA       = { 1942,   0},
	.SME_LD1B_ZA          = { 1942,   0},
	.SME_LD1H_ZA          = { 1942,   0},
	.SME_LD1W_ZA          = { 1942,   0},
	.SME_LD1D_ZA          = { 1942,   0},
	...
	.SME_LDR_ZA           = { 1942,   1},
	.SME_STR_ZA           = { 1943,   1},
	.SVE_FMLA_IDX_H       = { 1944,   1},
	.SVE_FMLA_IDX_S       = { 1945,   1},
	.SVE_FMLA_IDX_D       = { 1946,   1},
	.SVE_FMLS_IDX_H       = { 1947,   1},
	.SVE_FMLS_IDX_S       = { 1948,   1},
	.SVE_FMLS_IDX_D       = { 1949,   1},
	.SVE_LD1B_GATHER_S    = { 1950,   1},
	.SVE_LD1B_GATHER_D    = { 1951,   1},
	.SVE_LD1H_GATHER_S    = { 1952,   1},
	.SVE_LD1H_GATHER_D    = { 1953,   1},
	.SVE_LD1W_GATHER_S    = { 1954,   1},
	.SVE_LD1W_GATHER_D    = { 1955,   1},
	.SVE_LD1D_GATHER_D    = { 1956,   1},
	.SVE_LD1SB_GATHER_S   = { 1957,   1},
	.SVE_LD1SB_GATHER_D   = { 1958,   1},
	.SVE_LD1SH_GATHER_S   = { 1959,   1},
	.SVE_LD1SH_GATHER_D   = { 1960,   1},
	.SVE_LD1SW_GATHER_D   = { 1961,   1},
	.SVE_ST1B_SCATTER_S   = { 1962,   1},
	.SVE_ST1B_SCATTER_D   = { 1963,   1},
	.SVE_ST1H_SCATTER_S   = { 1964,   1},
	.SVE_ST1H_SCATTER_D   = { 1965,   1},
	.SVE_ST1W_SCATTER_S   = { 1966,   1},
	.SVE_ST1W_SCATTER_D   = { 1967,   1},
	.SVE_ST1D_SCATTER_D   = { 1968,   1},
	.SME_LD1B_TILE        = { 1969,   1},
	.SME_LD1H_TILE        = { 1970,   1},
	.SME_LD1W_TILE        = { 1971,   1},
	.SME_LD1D_TILE        = { 1972,   1},
	.SME_LD1Q_TILE        = { 1973,   1},
	.SME_ST1B_TILE        = { 1974,   1},
	.SME_ST1H_TILE        = { 1975,   1},
	.SME_ST1W_TILE        = { 1976,   1},
	.SME_ST1D_TILE        = { 1977,   1},
	.SME_ST1Q_TILE        = { 1978,   1},
	.SME_MOVA_Z_FROM_TILE = { 1979,   1},
	.SME_MOVA_TILE_FROM_Z = { 1980,   1},
	.FCMLA_4H             = { 1981,   1},
	.FCMLA_8H             = { 1982,   1},
	.FCMLA_4S             = { 1983,   1},
	.FCMLA_2D             = { 1984,   1},
	...
	.ASR_IMM              = { 2079,   2},
	.ROR_IMM              = { 2081,   2},
	.SVE_BFADD_UNPRED     = { 2083,   1},
	.SVE_BFSUB_UNPRED     = { 2084,   1},
	.SVE_BFMUL_UNPRED     = { 2085,   1},
	.SVE_BFCLAMP          = { 2086,   1},
	.SVE_BFMAXNM          = { 2087,   1},
	.SVE_BFMINNM          = { 2088,   1},
	.SME2_LUTI2_B         = { 2089,   1},
	...
	.AT_S12E0W            = { 2173,   1},
	.TLBI_VMALLE1         = { 2174,   1},
	.TLBI_VMALLE1IS       = { 2175,   1},
	.TLBI_VAE1            = { 2176,   1},
	.TLBI_VAE1IS          = { 2177,   1},
	.TLBI_ASIDE1          = { 2178,   1},
	.TLBI_ASIDE1IS        = { 2179,   1},
	.TLBI_VAAE1           = { 2180,   1},
	.TLBI_VAAE1IS         = { 2181,   1},
	.TLBI_VALE1           = { 2182,   1},
	.TLBI_VALE1IS         = { 2183,   1},
	.TLBI_VAALE1          = { 2184,   1},
	.TLBI_VAALE1IS        = { 2185,   1},
	.TLBI_ALLE1           = { 2186,   1},
	.TLBI_ALLE1IS         = { 2187,   1},
	.TLBI_ALLE2           = { 2188,   1},
	.TLBI_ALLE2IS         = { 2189,   1},
