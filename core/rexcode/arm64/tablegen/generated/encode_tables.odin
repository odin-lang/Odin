...
@(rodata)
ENCODE_FORMS := [1387]lib.Encoding{
	// .ADD_IMM
...
ENCODE_RUNS := [lib.Mnemonic]lib.Encode_Run{
	...
	.SVE_SUBR_PRED        = {  809,   4},
	.SVE_MUL_PRED         = {  813,   4},
	.SVE_SMULH_PRED       = {  817,   4},
	.SVE_UMULH_PRED       = {  821,   4},
	.SVE_SDIV_PRED        = {  825,   2},
	.SVE_UDIV_PRED        = {  827,   2},
	.SVE_SMAX_PRED        = {  829,   4},
	.SVE_UMAX_PRED        = {  833,   4},
	...
	.SVE_FADD_PRED        = {  907,   3},
	.SVE_FSUB_PRED        = {  910,   3},
	.SVE_FSUBR_PRED       = {  913,   0},
	.SVE_FMUL_PRED        = {  913,   3},
	.SVE_FDIV_PRED        = {  916,   3},
	.SVE_FDIVR_PRED       = {  919,   0},
	.SVE_FMAX_PRED        = {  919,   3},
	.SVE_FMIN_PRED        = {  922,   3},
	.SVE_FMAXNM_PRED      = {  925,   3},
	.SVE_FMINNM_PRED      = {  928,   3},
	.SVE_FABS_Z           = {  931,   3},
	.SVE_FNEG_Z           = {  934,   3},
	.SVE_FSQRT_Z          = {  937,   3},
	.SVE_FRECPX_Z         = {  940,   0},
	...
	.SME_USMOPA           = { 1108,   1},
	.SME_SUMOPA           = { 1109,   1},
	.SME_MOVA_TO_Z        = { 1110,   0},
	.SME_MOVA_TO_ZA       = { 1110,   0},
	.SME_LD1B_ZA          = { 1110,   0},
	.SME_LD1H_ZA          = { 1110,   0},
	.SME_LD1W_ZA          = { 1110,   0},
	.SME_LD1D_ZA          = { 1110,   0},
	...
	.SME_LDR_ZA           = { 1110,   1},
	.SME_STR_ZA           = { 1111,   1},
	.SVE_FMLA_IDX_H       = { 1112,   1},
	.SVE_FMLA_IDX_S       = { 1113,   1},
	.SVE_FMLA_IDX_D       = { 1114,   1},
	.SVE_FMLS_IDX_H       = { 1115,   1},
	.SVE_FMLS_IDX_S       = { 1116,   1},
	.SVE_FMLS_IDX_D       = { 1117,   1},
	.SVE_LD1B_GATHER_S    = { 1118,   1},
	.SVE_LD1B_GATHER_D    = { 1119,   1},
	.SVE_LD1H_GATHER_S    = { 1120,   1},
	.SVE_LD1H_GATHER_D    = { 1121,   1},
	.SVE_LD1W_GATHER_S    = { 1122,   1},
	.SVE_LD1W_GATHER_D    = { 1123,   1},
	.SVE_LD1D_GATHER_D    = { 1124,   1},
	.SVE_LD1SB_GATHER_S   = { 1125,   1},
	.SVE_LD1SB_GATHER_D   = { 1126,   1},
	.SVE_LD1SH_GATHER_S   = { 1127,   1},
	.SVE_LD1SH_GATHER_D   = { 1128,   1},
	.SVE_LD1SW_GATHER_D   = { 1129,   1},
	.SVE_ST1B_SCATTER_S   = { 1130,   1},
	.SVE_ST1B_SCATTER_D   = { 1131,   1},
	.SVE_ST1H_SCATTER_S   = { 1132,   1},
	.SVE_ST1H_SCATTER_D   = { 1133,   1},
	.SVE_ST1W_SCATTER_S   = { 1134,   1},
	.SVE_ST1W_SCATTER_D   = { 1135,   1},
	.SVE_ST1D_SCATTER_D   = { 1136,   1},
	.SME_LD1B_TILE        = { 1137,   1},
	.SME_LD1H_TILE        = { 1138,   1},
	.SME_LD1W_TILE        = { 1139,   1},
	.SME_LD1D_TILE        = { 1140,   1},
	.SME_LD1Q_TILE        = { 1141,   1},
	.SME_ST1B_TILE        = { 1142,   1},
	.SME_ST1H_TILE        = { 1143,   1},
	.SME_ST1W_TILE        = { 1144,   1},
	.SME_ST1D_TILE        = { 1145,   1},
	.SME_ST1Q_TILE        = { 1146,   1},
	.SME_MOVA_Z_FROM_TILE = { 1147,   1},
	.SME_MOVA_TILE_FROM_Z = { 1148,   1},
	.FCMLA_4H             = { 1149,   1},
	.FCMLA_8H             = { 1150,   1},
	.FCMLA_4S             = { 1151,   1},
	.FCMLA_2D             = { 1152,   1},
	...
	.ASR_IMM              = { 1247,   2},
	.ROR_IMM              = { 1249,   2},
	.SVE_BFADD_UNPRED     = { 1251,   1},
	.SVE_BFSUB_UNPRED     = { 1252,   1},
	.SVE_BFMUL_UNPRED     = { 1253,   1},
	.SVE_BFCLAMP          = { 1254,   1},
	.SVE_BFMAXNM          = { 1255,   1},
	.SVE_BFMINNM          = { 1256,   1},
	.SME2_LUTI2_B         = { 1257,   1},
	...
	.AT_S12E0W            = { 1341,   1},
	.TLBI_VMALLE1         = { 1342,   1},
	.TLBI_VMALLE1IS       = { 1343,   1},
	.TLBI_VAE1            = { 1344,   1},
	.TLBI_VAE1IS          = { 1345,   1},
	.TLBI_ASIDE1          = { 1346,   1},
	.TLBI_ASIDE1IS        = { 1347,   1},
	.TLBI_VAAE1           = { 1348,   1},
	.TLBI_VAAE1IS         = { 1349,   1},
	.TLBI_VALE1           = { 1350,   1},
	.TLBI_VALE1IS         = { 1351,   1},
	.TLBI_VAALE1          = { 1352,   1},
	.TLBI_VAALE1IS        = { 1353,   1},
	.TLBI_ALLE1           = { 1354,   1},
	.TLBI_ALLE1IS         = { 1355,   1},
	.TLBI_ALLE2           = { 1356,   1},
	.TLBI_ALLE2IS         = { 1357,   1},
