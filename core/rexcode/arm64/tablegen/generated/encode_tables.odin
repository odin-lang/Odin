...
@(rodata)
ENCODE_FORMS := [2147]lib.Encoding{
	// .ADD_IMM
...
ENCODE_RUNS := [lib.Mnemonic]lib.Encode_Run{
	...
	.SVE_ADD_PRED         = { 1561,   4},
	.SVE_SUB_PRED         = { 1565,   4},
	.SVE_SUBR_PRED        = { 1569,   4},
	.SVE_MUL_PRED         = { 1573,   4},
	.SVE_SMULH_PRED       = { 1577,   4},
	.SVE_UMULH_PRED       = { 1581,   4},
	.SVE_SDIV_PRED        = { 1585,   2},
	.SVE_UDIV_PRED        = { 1587,   2},
	.SVE_SMAX_PRED        = { 1589,   4},
	.SVE_UMAX_PRED        = { 1593,   4},
	.SVE_SMIN_PRED        = { 1597,   4},
	.SVE_UMIN_PRED        = { 1601,   4},
	.SVE_SABD_PRED        = { 1605,   4},
	.SVE_UABD_PRED        = { 1609,   4},
	.SVE_AND_PRED         = { 1613,   1},
	.SVE_ORR_PRED         = { 1614,   1},
	.SVE_EOR_PRED         = { 1615,   1},
	.SVE_BIC_PRED         = { 1616,   1},
	...
	.SVE_LSL_PRED         = { 1621,   4},
	.SVE_LSR_PRED         = { 1625,   4},
	.SVE_ASRR_PRED        = { 1629,   0},
	.SVE_LSLR_PRED        = { 1629,   0},
	.SVE_LSRR_PRED        = { 1629,   0},
	.SVE_ABS_PRED         = { 1629,   4},
	.SVE_NEG_PRED         = { 1633,   4},
	.SVE_CLS_PRED         = { 1637,   4},
	.SVE_CLZ_PRED         = { 1641,   4},
	...
	.SVE_FRSQRTS          = { 1661,   3},
	.SVE_FTSMUL           = { 1664,   3},
	.SVE_FADD_PRED        = { 1667,   3},
	.SVE_FSUB_PRED        = { 1670,   3},
	.SVE_FSUBR_PRED       = { 1673,   0},
	.SVE_FMUL_PRED        = { 1673,   3},
	.SVE_FDIV_PRED        = { 1676,   3},
	.SVE_FDIVR_PRED       = { 1679,   0},
	.SVE_FMAX_PRED        = { 1679,   3},
	.SVE_FMIN_PRED        = { 1682,   3},
	.SVE_FMAXNM_PRED      = { 1685,   3},
	.SVE_FMINNM_PRED      = { 1688,   3},
	.SVE_FABS_Z           = { 1691,   3},
	.SVE_FNEG_Z           = { 1694,   3},
	.SVE_FSQRT_Z          = { 1697,   3},
	.SVE_FRECPX_Z         = { 1700,   0},
	...
	.SME_USMOPA           = { 1868,   1},
	.SME_SUMOPA           = { 1869,   1},
	.SME_MOVA_TO_Z        = { 1870,   0},
	.SME_MOVA_TO_ZA       = { 1870,   0},
	.SME_LD1B_ZA          = { 1870,   0},
	.SME_LD1H_ZA          = { 1870,   0},
	.SME_LD1W_ZA          = { 1870,   0},
	.SME_LD1D_ZA          = { 1870,   0},
	...
	.SME_LDR_ZA           = { 1870,   1},
	.SME_STR_ZA           = { 1871,   1},
	.SVE_FMLA_IDX_H       = { 1872,   1},
	.SVE_FMLA_IDX_S       = { 1873,   1},
	.SVE_FMLA_IDX_D       = { 1874,   1},
	.SVE_FMLS_IDX_H       = { 1875,   1},
	.SVE_FMLS_IDX_S       = { 1876,   1},
	.SVE_FMLS_IDX_D       = { 1877,   1},
	.SVE_LD1B_GATHER_S    = { 1878,   1},
	.SVE_LD1B_GATHER_D    = { 1879,   1},
	.SVE_LD1H_GATHER_S    = { 1880,   1},
	.SVE_LD1H_GATHER_D    = { 1881,   1},
	.SVE_LD1W_GATHER_S    = { 1882,   1},
	.SVE_LD1W_GATHER_D    = { 1883,   1},
	.SVE_LD1D_GATHER_D    = { 1884,   1},
	.SVE_LD1SB_GATHER_S   = { 1885,   1},
	.SVE_LD1SB_GATHER_D   = { 1886,   1},
	.SVE_LD1SH_GATHER_S   = { 1887,   1},
	.SVE_LD1SH_GATHER_D   = { 1888,   1},
	.SVE_LD1SW_GATHER_D   = { 1889,   1},
	.SVE_ST1B_SCATTER_S   = { 1890,   1},
	.SVE_ST1B_SCATTER_D   = { 1891,   1},
	.SVE_ST1H_SCATTER_S   = { 1892,   1},
	.SVE_ST1H_SCATTER_D   = { 1893,   1},
	.SVE_ST1W_SCATTER_S   = { 1894,   1},
	.SVE_ST1W_SCATTER_D   = { 1895,   1},
	.SVE_ST1D_SCATTER_D   = { 1896,   1},
	.SME_LD1B_TILE        = { 1897,   1},
	.SME_LD1H_TILE        = { 1898,   1},
	.SME_LD1W_TILE        = { 1899,   1},
	.SME_LD1D_TILE        = { 1900,   1},
	.SME_LD1Q_TILE        = { 1901,   1},
	.SME_ST1B_TILE        = { 1902,   1},
	.SME_ST1H_TILE        = { 1903,   1},
	.SME_ST1W_TILE        = { 1904,   1},
	.SME_ST1D_TILE        = { 1905,   1},
	.SME_ST1Q_TILE        = { 1906,   1},
	.SME_MOVA_Z_FROM_TILE = { 1907,   1},
	.SME_MOVA_TILE_FROM_Z = { 1908,   1},
	.FCMLA_4H             = { 1909,   1},
	.FCMLA_8H             = { 1910,   1},
	.FCMLA_4S             = { 1911,   1},
	.FCMLA_2D             = { 1912,   1},
	...
	.ASR_IMM              = { 2007,   2},
	.ROR_IMM              = { 2009,   2},
	.SVE_BFADD_UNPRED     = { 2011,   1},
	.SVE_BFSUB_UNPRED     = { 2012,   1},
	.SVE_BFMUL_UNPRED     = { 2013,   1},
	.SVE_BFCLAMP          = { 2014,   1},
	.SVE_BFMAXNM          = { 2015,   1},
	.SVE_BFMINNM          = { 2016,   1},
	.SME2_LUTI2_B         = { 2017,   1},
	...
	.AT_S12E0W            = { 2101,   1},
	.TLBI_VMALLE1         = { 2102,   1},
	.TLBI_VMALLE1IS       = { 2103,   1},
	.TLBI_VAE1            = { 2104,   1},
	.TLBI_VAE1IS          = { 2105,   1},
	.TLBI_ASIDE1          = { 2106,   1},
	.TLBI_ASIDE1IS        = { 2107,   1},
	.TLBI_VAAE1           = { 2108,   1},
	.TLBI_VAAE1IS         = { 2109,   1},
	.TLBI_VALE1           = { 2110,   1},
	.TLBI_VALE1IS         = { 2111,   1},
	.TLBI_VAALE1          = { 2112,   1},
	.TLBI_VAALE1IS        = { 2113,   1},
	.TLBI_ALLE1           = { 2114,   1},
	.TLBI_ALLE1IS         = { 2115,   1},
	.TLBI_ALLE2           = { 2116,   1},
	.TLBI_ALLE2IS         = { 2117,   1},
