...
@(rodata)
ENCODE_FORMS := [2404]lib.Encoding{
	// .ADD_IMM
	...
	// .LD2
	{ .LD2, {.V_16B,.MEM,.NONE,.NONE}, {.VD,.OFFSET_BASE_A,.NONE,.NONE}, 0x4C408000, 0xFFFFFC00, .NEON, {} },
	// .LD3
	{ .LD3, {.V_16B,.MEM,.NONE,.NONE}, {.VD,.OFFSET_BASE_A,.NONE,.NONE}, 0x4C404000, 0xFFFFFC00, .NEON, {} },
	// .LD4
	{ .LD4, {.V_16B,.MEM,.NONE,.NONE}, {.VD,.OFFSET_BASE_A,.NONE,.NONE}, 0x4C400000, 0xFFFFFC00, .NEON, {} },
	// .ST1
	...
	// .ST2
	{ .ST2, {.V_16B,.MEM,.NONE,.NONE}, {.VD,.OFFSET_BASE_A,.NONE,.NONE}, 0x4C008000, 0xFFFFFC00, .NEON, {} },
	// .ST3
	{ .ST3, {.V_16B,.MEM,.NONE,.NONE}, {.VD,.OFFSET_BASE_A,.NONE,.NONE}, 0x4C004000, 0xFFFFFC00, .NEON, {} },
	// .ST4
	{ .ST4, {.V_16B,.MEM,.NONE,.NONE}, {.VD,.OFFSET_BASE_A,.NONE,.NONE}, 0x4C000000, 0xFFFFFC00, .NEON, {} },
	// .LD1R
	{ .LD1R, {.V_16B,.MEM,.NONE,.NONE}, {.VD,.OFFSET_BASE_A,.NONE,.NONE}, 0x4D40C000, 0xFFFFFC00, .NEON, {} },
	// .LD2R
	{ .LD2R, {.V_16B,.MEM,.NONE,.NONE}, {.VD,.OFFSET_BASE_A,.NONE,.NONE}, 0x4D60C000, 0xFFFFFC00, .NEON, {} },
	// .LD3R
	{ .LD3R, {.V_16B,.MEM,.NONE,.NONE}, {.VD,.OFFSET_BASE_A,.NONE,.NONE}, 0x4D40E000, 0xFFFFFC00, .NEON, {} },
	// .LD4R
	{ .LD4R, {.V_16B,.MEM,.NONE,.NONE}, {.VD,.OFFSET_BASE_A,.NONE,.NONE}, 0x4D60E000, 0xFFFFFC00, .NEON, {} },
	// .LDR_V
	...
	// .SVE_NOT_P
	{ .SVE_NOT_P, {.P_REG,.P_REG_ZERO,.P_REG,.NONE}, {.PD,.PG4_PM_DUP,.PN,.NONE}, 0x25004200, 0xFFE0C210, .SVE, {} },
	// .SVE_MOV_P
	...
	// .SVE_MOVS_P
	{ .SVE_MOVS_P, {.P_REG,.P_REG_ZERO,.P_REG,.NONE}, {.PD,.PG4,.PN_PM_DUP,.NONE}, 0x25404000, 0xFFE0C210, .SVE, {sets_flags=true} },
	// .SVE_PTRUE
	...
	// .SVE_EXT_Z
	{ .SVE_EXT_Z, {.Z_REG_B,.Z_REG_B,.Z_REG_B,.VEC_SHIFT}, {.VD,.VD,.VN,.SVE_EXT_IMM}, 0x05200000, 0xFFE0E000, .SVE, {} },
	// .SVE_LD1B
	...
	// .SME_ADDHA
	{ .SME_ADDHA, {.ZA_TILE_S,.P_REG_MERGE,.P_REG_MERGE,.Z_REG_S}, {.ZA_TILE_LOW,.PG,.PM3,.VN}, 0xC0900000, 0xFFFF001C, .SME, {} },
	// .SME_ADDVA
	{ .SME_ADDVA, {.ZA_TILE_S,.P_REG_MERGE,.P_REG_MERGE,.Z_REG_S}, {.ZA_TILE_LOW,.PG,.PM3,.VN}, 0xC0910000, 0xFFFF001C, .SME, {} },
	// .SME_ZERO
...
ENCODE_RUNS := [lib.Mnemonic]lib.Encode_Run{
	...
	.SVE_ADD_PRED         = { 1703,   4},
	.SVE_SUB_PRED         = { 1707,   4},
	.SVE_SUBR_PRED        = { 1711,   4},
	.SVE_MUL_PRED         = { 1715,   4},
	.SVE_SMULH_PRED       = { 1719,   4},
	.SVE_UMULH_PRED       = { 1723,   4},
	.SVE_SDIV_PRED        = { 1727,   2},
	.SVE_UDIV_PRED        = { 1729,   2},
	.SVE_SMAX_PRED        = { 1731,   4},
	.SVE_UMAX_PRED        = { 1735,   4},
	.SVE_SMIN_PRED        = { 1739,   4},
	.SVE_UMIN_PRED        = { 1743,   4},
	.SVE_SABD_PRED        = { 1747,   4},
	.SVE_UABD_PRED        = { 1751,   4},
	.SVE_AND_PRED         = { 1755,   1},
	.SVE_ORR_PRED         = { 1756,   1},
	.SVE_EOR_PRED         = { 1757,   1},
	.SVE_BIC_PRED         = { 1758,   1},
	...
	.SVE_LSL_PRED         = { 1763,   4},
	.SVE_LSR_PRED         = { 1767,   4},
	.SVE_ASRR_PRED        = { 1771,   4},
	.SVE_LSLR_PRED        = { 1775,   4},
	.SVE_LSRR_PRED        = { 1779,   4},
	.SVE_ABS_PRED         = { 1783,   4},
	.SVE_NEG_PRED         = { 1787,   4},
	.SVE_CLS_PRED         = { 1791,   4},
	.SVE_CLZ_PRED         = { 1795,   4},
	...
	.SVE_FRSQRTS          = { 1819,   3},
	.SVE_FTSMUL           = { 1822,   3},
	.SVE_FADD_PRED        = { 1825,   3},
	.SVE_FSUB_PRED        = { 1828,   3},
	.SVE_FSUBR_PRED       = { 1831,   3},
	.SVE_FMUL_PRED        = { 1834,   3},
	.SVE_FDIV_PRED        = { 1837,   3},
	.SVE_FDIVR_PRED       = { 1840,   3},
	.SVE_FMAX_PRED        = { 1843,   3},
	.SVE_FMIN_PRED        = { 1846,   3},
	.SVE_FMAXNM_PRED      = { 1849,   3},
	.SVE_FMINNM_PRED      = { 1852,   3},
	.SVE_FABS_Z           = { 1855,   3},
	.SVE_FNEG_Z           = { 1858,   3},
	.SVE_FSQRT_Z          = { 1861,   3},
	.SVE_FRECPX_Z         = { 1864,   3},
	...
	.SME_USMOPA           = { 2125,   1},
	.SME_SUMOPA           = { 2126,   1},
	.SME_MOVA_TO_Z        = { 2127,   0},
	.SME_MOVA_TO_ZA       = { 2127,   0},
	.SME_LD1B_ZA          = { 2127,   0},
	.SME_LD1H_ZA          = { 2127,   0},
	.SME_LD1W_ZA          = { 2127,   0},
	.SME_LD1D_ZA          = { 2127,   0},
	...
	.SME_LDR_ZA           = { 2127,   1},
	.SME_STR_ZA           = { 2128,   1},
	.SVE_FMLA_IDX_H       = { 2129,   1},
	.SVE_FMLA_IDX_S       = { 2130,   1},
	.SVE_FMLA_IDX_D       = { 2131,   1},
	.SVE_FMLS_IDX_H       = { 2132,   1},
	.SVE_FMLS_IDX_S       = { 2133,   1},
	.SVE_FMLS_IDX_D       = { 2134,   1},
	.SVE_LD1B_GATHER_S    = { 2135,   1},
	.SVE_LD1B_GATHER_D    = { 2136,   1},
	.SVE_LD1H_GATHER_S    = { 2137,   1},
	.SVE_LD1H_GATHER_D    = { 2138,   1},
	.SVE_LD1W_GATHER_S    = { 2139,   1},
	.SVE_LD1W_GATHER_D    = { 2140,   1},
	.SVE_LD1D_GATHER_D    = { 2141,   1},
	.SVE_LD1SB_GATHER_S   = { 2142,   1},
	.SVE_LD1SB_GATHER_D   = { 2143,   1},
	.SVE_LD1SH_GATHER_S   = { 2144,   1},
	.SVE_LD1SH_GATHER_D   = { 2145,   1},
	.SVE_LD1SW_GATHER_D   = { 2146,   1},
	.SVE_ST1B_SCATTER_S   = { 2147,   1},
	.SVE_ST1B_SCATTER_D   = { 2148,   1},
	.SVE_ST1H_SCATTER_S   = { 2149,   1},
	.SVE_ST1H_SCATTER_D   = { 2150,   1},
	.SVE_ST1W_SCATTER_S   = { 2151,   1},
	.SVE_ST1W_SCATTER_D   = { 2152,   1},
	.SVE_ST1D_SCATTER_D   = { 2153,   1},
	.SME_LD1B_TILE        = { 2154,   1},
	.SME_LD1H_TILE        = { 2155,   1},
	.SME_LD1W_TILE        = { 2156,   1},
	.SME_LD1D_TILE        = { 2157,   1},
	.SME_LD1Q_TILE        = { 2158,   1},
	.SME_ST1B_TILE        = { 2159,   1},
	.SME_ST1H_TILE        = { 2160,   1},
	.SME_ST1W_TILE        = { 2161,   1},
	.SME_ST1D_TILE        = { 2162,   1},
	.SME_ST1Q_TILE        = { 2163,   1},
	.SME_MOVA_Z_FROM_TILE = { 2164,   1},
	.SME_MOVA_TILE_FROM_Z = { 2165,   1},
	.FCMLA_4H             = { 2166,   1},
	.FCMLA_8H             = { 2167,   1},
	.FCMLA_4S             = { 2168,   1},
	.FCMLA_2D             = { 2169,   1},
	...
	.ASR_IMM              = { 2264,   2},
	.ROR_IMM              = { 2266,   2},
	.SVE_BFADD_UNPRED     = { 2268,   1},
	.SVE_BFSUB_UNPRED     = { 2269,   1},
	.SVE_BFMUL_UNPRED     = { 2270,   1},
	.SVE_BFCLAMP          = { 2271,   1},
	.SVE_BFMAXNM          = { 2272,   1},
	.SVE_BFMINNM          = { 2273,   1},
	.SME2_LUTI2_B         = { 2274,   1},
	...
	.AT_S12E0W            = { 2358,   1},
	.TLBI_VMALLE1         = { 2359,   1},
	.TLBI_VMALLE1IS       = { 2360,   1},
	.TLBI_VAE1            = { 2361,   1},
	.TLBI_VAE1IS          = { 2362,   1},
	.TLBI_ASIDE1          = { 2363,   1},
	.TLBI_ASIDE1IS        = { 2364,   1},
	.TLBI_VAAE1           = { 2365,   1},
	.TLBI_VAAE1IS         = { 2366,   1},
	.TLBI_VALE1           = { 2367,   1},
	.TLBI_VALE1IS         = { 2368,   1},
	.TLBI_VAALE1          = { 2369,   1},
	.TLBI_VAALE1IS        = { 2370,   1},
	.TLBI_ALLE1           = { 2371,   1},
	.TLBI_ALLE1IS         = { 2372,   1},
	.TLBI_ALLE2           = { 2373,   1},
	.TLBI_ALLE2IS         = { 2374,   1},
