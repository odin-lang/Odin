...
@(rodata)
ENCODE_FORMS := [2119]lib.Encoding{
	// .ADD_IMM
...
ENCODE_RUNS := [lib.Mnemonic]lib.Encode_Run{
	...
	.SVE_ADD_PRED         = { 1533,   4},
	.SVE_SUB_PRED         = { 1537,   4},
	.SVE_SUBR_PRED        = { 1541,   4},
	.SVE_MUL_PRED         = { 1545,   4},
	.SVE_SMULH_PRED       = { 1549,   4},
	.SVE_UMULH_PRED       = { 1553,   4},
	.SVE_SDIV_PRED        = { 1557,   2},
	.SVE_UDIV_PRED        = { 1559,   2},
	.SVE_SMAX_PRED        = { 1561,   4},
	.SVE_UMAX_PRED        = { 1565,   4},
	.SVE_SMIN_PRED        = { 1569,   4},
	.SVE_UMIN_PRED        = { 1573,   4},
	.SVE_SABD_PRED        = { 1577,   4},
	.SVE_UABD_PRED        = { 1581,   4},
	.SVE_AND_PRED         = { 1585,   1},
	.SVE_ORR_PRED         = { 1586,   1},
	.SVE_EOR_PRED         = { 1587,   1},
	.SVE_BIC_PRED         = { 1588,   1},
	...
	.SVE_LSL_PRED         = { 1593,   4},
	.SVE_LSR_PRED         = { 1597,   4},
	.SVE_ASRR_PRED        = { 1601,   0},
	.SVE_LSLR_PRED        = { 1601,   0},
	.SVE_LSRR_PRED        = { 1601,   0},
	.SVE_ABS_PRED         = { 1601,   4},
	.SVE_NEG_PRED         = { 1605,   4},
	.SVE_CLS_PRED         = { 1609,   4},
	.SVE_CLZ_PRED         = { 1613,   4},
	...
	.SVE_FRSQRTS          = { 1633,   3},
	.SVE_FTSMUL           = { 1636,   3},
	.SVE_FADD_PRED        = { 1639,   3},
	.SVE_FSUB_PRED        = { 1642,   3},
	.SVE_FSUBR_PRED       = { 1645,   0},
	.SVE_FMUL_PRED        = { 1645,   3},
	.SVE_FDIV_PRED        = { 1648,   3},
	.SVE_FDIVR_PRED       = { 1651,   0},
	.SVE_FMAX_PRED        = { 1651,   3},
	.SVE_FMIN_PRED        = { 1654,   3},
	.SVE_FMAXNM_PRED      = { 1657,   3},
	.SVE_FMINNM_PRED      = { 1660,   3},
	.SVE_FABS_Z           = { 1663,   3},
	.SVE_FNEG_Z           = { 1666,   3},
	.SVE_FSQRT_Z          = { 1669,   3},
	.SVE_FRECPX_Z         = { 1672,   0},
	...
	.SME_USMOPA           = { 1840,   1},
	.SME_SUMOPA           = { 1841,   1},
	.SME_MOVA_TO_Z        = { 1842,   0},
	.SME_MOVA_TO_ZA       = { 1842,   0},
	.SME_LD1B_ZA          = { 1842,   0},
	.SME_LD1H_ZA          = { 1842,   0},
	.SME_LD1W_ZA          = { 1842,   0},
	.SME_LD1D_ZA          = { 1842,   0},
	...
	.SME_LDR_ZA           = { 1842,   1},
	.SME_STR_ZA           = { 1843,   1},
	.SVE_FMLA_IDX_H       = { 1844,   1},
	.SVE_FMLA_IDX_S       = { 1845,   1},
	.SVE_FMLA_IDX_D       = { 1846,   1},
	.SVE_FMLS_IDX_H       = { 1847,   1},
	.SVE_FMLS_IDX_S       = { 1848,   1},
	.SVE_FMLS_IDX_D       = { 1849,   1},
	.SVE_LD1B_GATHER_S    = { 1850,   1},
	.SVE_LD1B_GATHER_D    = { 1851,   1},
	.SVE_LD1H_GATHER_S    = { 1852,   1},
	.SVE_LD1H_GATHER_D    = { 1853,   1},
	.SVE_LD1W_GATHER_S    = { 1854,   1},
	.SVE_LD1W_GATHER_D    = { 1855,   1},
	.SVE_LD1D_GATHER_D    = { 1856,   1},
	.SVE_LD1SB_GATHER_S   = { 1857,   1},
	.SVE_LD1SB_GATHER_D   = { 1858,   1},
	.SVE_LD1SH_GATHER_S   = { 1859,   1},
	.SVE_LD1SH_GATHER_D   = { 1860,   1},
	.SVE_LD1SW_GATHER_D   = { 1861,   1},
	.SVE_ST1B_SCATTER_S   = { 1862,   1},
	.SVE_ST1B_SCATTER_D   = { 1863,   1},
	.SVE_ST1H_SCATTER_S   = { 1864,   1},
	.SVE_ST1H_SCATTER_D   = { 1865,   1},
	.SVE_ST1W_SCATTER_S   = { 1866,   1},
	.SVE_ST1W_SCATTER_D   = { 1867,   1},
	.SVE_ST1D_SCATTER_D   = { 1868,   1},
	.SME_LD1B_TILE        = { 1869,   1},
	.SME_LD1H_TILE        = { 1870,   1},
	.SME_LD1W_TILE        = { 1871,   1},
	.SME_LD1D_TILE        = { 1872,   1},
	.SME_LD1Q_TILE        = { 1873,   1},
	.SME_ST1B_TILE        = { 1874,   1},
	.SME_ST1H_TILE        = { 1875,   1},
	.SME_ST1W_TILE        = { 1876,   1},
	.SME_ST1D_TILE        = { 1877,   1},
	.SME_ST1Q_TILE        = { 1878,   1},
	.SME_MOVA_Z_FROM_TILE = { 1879,   1},
	.SME_MOVA_TILE_FROM_Z = { 1880,   1},
	.FCMLA_4H             = { 1881,   1},
	.FCMLA_8H             = { 1882,   1},
	.FCMLA_4S             = { 1883,   1},
	.FCMLA_2D             = { 1884,   1},
	...
	.ASR_IMM              = { 1979,   2},
	.ROR_IMM              = { 1981,   2},
	.SVE_BFADD_UNPRED     = { 1983,   1},
	.SVE_BFSUB_UNPRED     = { 1984,   1},
	.SVE_BFMUL_UNPRED     = { 1985,   1},
	.SVE_BFCLAMP          = { 1986,   1},
	.SVE_BFMAXNM          = { 1987,   1},
	.SVE_BFMINNM          = { 1988,   1},
	.SME2_LUTI2_B         = { 1989,   1},
	...
	.AT_S12E0W            = { 2073,   1},
	.TLBI_VMALLE1         = { 2074,   1},
	.TLBI_VMALLE1IS       = { 2075,   1},
	.TLBI_VAE1            = { 2076,   1},
	.TLBI_VAE1IS          = { 2077,   1},
	.TLBI_ASIDE1          = { 2078,   1},
	.TLBI_ASIDE1IS        = { 2079,   1},
	.TLBI_VAAE1           = { 2080,   1},
	.TLBI_VAAE1IS         = { 2081,   1},
	.TLBI_VALE1           = { 2082,   1},
	.TLBI_VALE1IS         = { 2083,   1},
	.TLBI_VAALE1          = { 2084,   1},
	.TLBI_VAALE1IS        = { 2085,   1},
	.TLBI_ALLE1           = { 2086,   1},
	.TLBI_ALLE1IS         = { 2087,   1},
	.TLBI_ALLE2           = { 2088,   1},
	.TLBI_ALLE2IS         = { 2089,   1},
