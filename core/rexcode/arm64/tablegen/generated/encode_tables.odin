...
ENCODE_RUNS := [lib.Mnemonic]lib.Encode_Run{
	...
	.SVE_ADD_PRED         = { 1735,   4},
	.SVE_SUB_PRED         = { 1739,   4},
	.SVE_SUBR_PRED        = { 1743,   4},
	.SVE_MUL_PRED         = { 1747,   4},
	.SVE_SMULH_PRED       = { 1751,   4},
	.SVE_UMULH_PRED       = { 1755,   4},
	.SVE_SDIV_PRED        = { 1759,   2},
	.SVE_UDIV_PRED        = { 1761,   2},
	.SVE_SMAX_PRED        = { 1763,   4},
	.SVE_UMAX_PRED        = { 1767,   4},
	.SVE_SMIN_PRED        = { 1771,   4},
	.SVE_UMIN_PRED        = { 1775,   4},
	.SVE_SABD_PRED        = { 1779,   4},
	.SVE_UABD_PRED        = { 1783,   4},
	.SVE_AND_PRED         = { 1787,   1},
	.SVE_ORR_PRED         = { 1788,   1},
	.SVE_EOR_PRED         = { 1789,   1},
	.SVE_BIC_PRED         = { 1790,   1},
	...
	.SVE_LSL_PRED         = { 1795,   4},
	.SVE_LSR_PRED         = { 1799,   4},
	.SVE_ASRR_PRED        = { 1803,   4},
	.SVE_LSLR_PRED        = { 1807,   4},
	.SVE_LSRR_PRED        = { 1811,   4},
	.SVE_ABS_PRED         = { 1815,   4},
	.SVE_NEG_PRED         = { 1819,   4},
	.SVE_CLS_PRED         = { 1823,   4},
	.SVE_CLZ_PRED         = { 1827,   4},
	...
	.SVE_FRSQRTS          = { 1851,   3},
	.SVE_FTSMUL           = { 1854,   3},
	.SVE_FADD_PRED        = { 1857,   3},
	.SVE_FSUB_PRED        = { 1860,   3},
	.SVE_FSUBR_PRED       = { 1863,   3},
	.SVE_FMUL_PRED        = { 1866,   3},
	.SVE_FDIV_PRED        = { 1869,   3},
	.SVE_FDIVR_PRED       = { 1872,   3},
	.SVE_FMAX_PRED        = { 1875,   3},
	.SVE_FMIN_PRED        = { 1878,   3},
	.SVE_FMAXNM_PRED      = { 1881,   3},
	.SVE_FMINNM_PRED      = { 1884,   3},
	.SVE_FABS_Z           = { 1887,   3},
	.SVE_FNEG_Z           = { 1890,   3},
	.SVE_FSQRT_Z          = { 1893,   3},
	.SVE_FRECPX_Z         = { 1896,   3},
	...
	.SME_USMOPA           = { 2157,   1},
	.SME_SUMOPA           = { 2158,   1},
	.SME_MOVA_TO_Z        = { 2159,   0},
	.SME_MOVA_TO_ZA       = { 2159,   0},
	.SME_LD1B_ZA          = { 2159,   0},
	.SME_LD1H_ZA          = { 2159,   0},
	.SME_LD1W_ZA          = { 2159,   0},
	.SME_LD1D_ZA          = { 2159,   0},
	...
	.SME_LDR_ZA           = { 2159,   1},
	.SME_STR_ZA           = { 2160,   1},
	.SVE_FMLA_IDX_H       = { 2161,   1},
	.SVE_FMLA_IDX_S       = { 2162,   1},
	.SVE_FMLA_IDX_D       = { 2163,   1},
	.SVE_FMLS_IDX_H       = { 2164,   1},
	.SVE_FMLS_IDX_S       = { 2165,   1},
	.SVE_FMLS_IDX_D       = { 2166,   1},
	.SVE_LD1B_GATHER_S    = { 2167,   1},
	.SVE_LD1B_GATHER_D    = { 2168,   1},
	.SVE_LD1H_GATHER_S    = { 2169,   1},
	.SVE_LD1H_GATHER_D    = { 2170,   1},
	.SVE_LD1W_GATHER_S    = { 2171,   1},
	.SVE_LD1W_GATHER_D    = { 2172,   1},
	.SVE_LD1D_GATHER_D    = { 2173,   1},
	.SVE_LD1SB_GATHER_S   = { 2174,   1},
	.SVE_LD1SB_GATHER_D   = { 2175,   1},
	.SVE_LD1SH_GATHER_S   = { 2176,   1},
	.SVE_LD1SH_GATHER_D   = { 2177,   1},
	.SVE_LD1SW_GATHER_D   = { 2178,   1},
	.SVE_ST1B_SCATTER_S   = { 2179,   1},
	.SVE_ST1B_SCATTER_D   = { 2180,   1},
	.SVE_ST1H_SCATTER_S   = { 2181,   1},
	.SVE_ST1H_SCATTER_D   = { 2182,   1},
	.SVE_ST1W_SCATTER_S   = { 2183,   1},
	.SVE_ST1W_SCATTER_D   = { 2184,   1},
	.SVE_ST1D_SCATTER_D   = { 2185,   1},
	.SME_LD1B_TILE        = { 2186,   1},
	.SME_LD1H_TILE        = { 2187,   1},
	.SME_LD1W_TILE        = { 2188,   1},
	.SME_LD1D_TILE        = { 2189,   1},
	.SME_LD1Q_TILE        = { 2190,   1},
	.SME_ST1B_TILE        = { 2191,   1},
	.SME_ST1H_TILE        = { 2192,   1},
	.SME_ST1W_TILE        = { 2193,   1},
	.SME_ST1D_TILE        = { 2194,   1},
	.SME_ST1Q_TILE        = { 2195,   1},
	.SME_MOVA_Z_FROM_TILE = { 2196,   1},
	.SME_MOVA_TILE_FROM_Z = { 2197,   1},
	.FCMLA_4H             = { 2198,   1},
	.FCMLA_8H             = { 2199,   1},
	.FCMLA_4S             = { 2200,   1},
	.FCMLA_2D             = { 2201,   1},
	...
	.ASR_IMM              = { 2296,   2},
	.ROR_IMM              = { 2298,   2},
	.SVE_BFADD_UNPRED     = { 2300,   1},
	.SVE_BFSUB_UNPRED     = { 2301,   1},
	.SVE_BFMUL_UNPRED     = { 2302,   1},
	.SVE_BFCLAMP          = { 2303,   1},
	.SVE_BFMAXNM          = { 2304,   1},
	.SVE_BFMINNM          = { 2305,   1},
	.SME2_LUTI2_B         = { 2306,   1},
	...
	.AT_S12E0W            = { 2390,   1},
	.TLBI_VMALLE1         = { 2391,   1},
	.TLBI_VMALLE1IS       = { 2392,   1},
	.TLBI_VAE1            = { 2393,   1},
	.TLBI_VAE1IS          = { 2394,   1},
	.TLBI_ASIDE1          = { 2395,   1},
	.TLBI_ASIDE1IS        = { 2396,   1},
	.TLBI_VAAE1           = { 2397,   1},
	.TLBI_VAAE1IS         = { 2398,   1},
	.TLBI_VALE1           = { 2399,   1},
	.TLBI_VALE1IS         = { 2400,   1},
	.TLBI_VAALE1          = { 2401,   1},
	.TLBI_VAALE1IS        = { 2402,   1},
	.TLBI_ALLE1           = { 2403,   1},
	.TLBI_ALLE1IS         = { 2404,   1},
	.TLBI_ALLE2           = { 2405,   1},
	.TLBI_ALLE2IS         = { 2406,   1},
