...
ENCODE_RUNS := [lib.Mnemonic]lib.Encode_Run{
	...
	.SVE_ADD_PRED         = { 1063,   4},
	.SVE_SUB_PRED         = { 1067,   4},
	.SVE_SUBR_PRED        = { 1071,   4},
	.SVE_MUL_PRED         = { 1075,   4},
	.SVE_SMULH_PRED       = { 1079,   4},
	.SVE_UMULH_PRED       = { 1083,   4},
	.SVE_SDIV_PRED        = { 1087,   2},
	.SVE_UDIV_PRED        = { 1089,   2},
	.SVE_SMAX_PRED        = { 1091,   4},
	.SVE_UMAX_PRED        = { 1095,   4},
	.SVE_SMIN_PRED        = { 1099,   4},
	.SVE_UMIN_PRED        = { 1103,   4},
	.SVE_SABD_PRED        = { 1107,   4},
	.SVE_UABD_PRED        = { 1111,   4},
	.SVE_AND_PRED         = { 1115,   1},
	.SVE_ORR_PRED         = { 1116,   1},
	.SVE_EOR_PRED         = { 1117,   1},
	.SVE_BIC_PRED         = { 1118,   1},
	...
	.SVE_LSL_PRED         = { 1123,   4},
	.SVE_LSR_PRED         = { 1127,   4},
	.SVE_ASRR_PRED        = { 1131,   0},
	.SVE_LSLR_PRED        = { 1131,   0},
	.SVE_LSRR_PRED        = { 1131,   0},
	.SVE_ABS_PRED         = { 1131,   4},
	.SVE_NEG_PRED         = { 1135,   4},
	.SVE_CLS_PRED         = { 1139,   4},
	.SVE_CLZ_PRED         = { 1143,   4},
	...
	.SVE_FRSQRTS          = { 1163,   3},
	.SVE_FTSMUL           = { 1166,   3},
	.SVE_FADD_PRED        = { 1169,   3},
	.SVE_FSUB_PRED        = { 1172,   3},
	.SVE_FSUBR_PRED       = { 1175,   0},
	.SVE_FMUL_PRED        = { 1175,   3},
	.SVE_FDIV_PRED        = { 1178,   3},
	.SVE_FDIVR_PRED       = { 1181,   0},
	.SVE_FMAX_PRED        = { 1181,   3},
	.SVE_FMIN_PRED        = { 1184,   3},
	.SVE_FMAXNM_PRED      = { 1187,   3},
	.SVE_FMINNM_PRED      = { 1190,   3},
	.SVE_FABS_Z           = { 1193,   3},
	.SVE_FNEG_Z           = { 1196,   3},
	.SVE_FSQRT_Z          = { 1199,   3},
	.SVE_FRECPX_Z         = { 1202,   0},
	...
	.SME_USMOPA           = { 1370,   1},
	.SME_SUMOPA           = { 1371,   1},
	.SME_MOVA_TO_Z        = { 1372,   0},
	.SME_MOVA_TO_ZA       = { 1372,   0},
	.SME_LD1B_ZA          = { 1372,   0},
	.SME_LD1H_ZA          = { 1372,   0},
	.SME_LD1W_ZA          = { 1372,   0},
	.SME_LD1D_ZA          = { 1372,   0},
	...
	.SME_LDR_ZA           = { 1372,   1},
	.SME_STR_ZA           = { 1373,   1},
	.SVE_FMLA_IDX_H       = { 1374,   1},
	.SVE_FMLA_IDX_S       = { 1375,   1},
	.SVE_FMLA_IDX_D       = { 1376,   1},
	.SVE_FMLS_IDX_H       = { 1377,   1},
	.SVE_FMLS_IDX_S       = { 1378,   1},
	.SVE_FMLS_IDX_D       = { 1379,   1},
	.SVE_LD1B_GATHER_S    = { 1380,   1},
	.SVE_LD1B_GATHER_D    = { 1381,   1},
	.SVE_LD1H_GATHER_S    = { 1382,   1},
	.SVE_LD1H_GATHER_D    = { 1383,   1},
	.SVE_LD1W_GATHER_S    = { 1384,   1},
	.SVE_LD1W_GATHER_D    = { 1385,   1},
	.SVE_LD1D_GATHER_D    = { 1386,   1},
	.SVE_LD1SB_GATHER_S   = { 1387,   1},
	.SVE_LD1SB_GATHER_D   = { 1388,   1},
	.SVE_LD1SH_GATHER_S   = { 1389,   1},
	.SVE_LD1SH_GATHER_D   = { 1390,   1},
	.SVE_LD1SW_GATHER_D   = { 1391,   1},
	.SVE_ST1B_SCATTER_S   = { 1392,   1},
	.SVE_ST1B_SCATTER_D   = { 1393,   1},
	.SVE_ST1H_SCATTER_S   = { 1394,   1},
	.SVE_ST1H_SCATTER_D   = { 1395,   1},
	.SVE_ST1W_SCATTER_S   = { 1396,   1},
	.SVE_ST1W_SCATTER_D   = { 1397,   1},
	.SVE_ST1D_SCATTER_D   = { 1398,   1},
	.SME_LD1B_TILE        = { 1399,   1},
	.SME_LD1H_TILE        = { 1400,   1},
	.SME_LD1W_TILE        = { 1401,   1},
	.SME_LD1D_TILE        = { 1402,   1},
	.SME_LD1Q_TILE        = { 1403,   1},
	.SME_ST1B_TILE        = { 1404,   1},
	.SME_ST1H_TILE        = { 1405,   1},
	.SME_ST1W_TILE        = { 1406,   1},
	.SME_ST1D_TILE        = { 1407,   1},
	.SME_ST1Q_TILE        = { 1408,   1},
	.SME_MOVA_Z_FROM_TILE = { 1409,   1},
	.SME_MOVA_TILE_FROM_Z = { 1410,   1},
	.FCMLA_4H             = { 1411,   1},
	.FCMLA_8H             = { 1412,   1},
	.FCMLA_4S             = { 1413,   1},
	.FCMLA_2D             = { 1414,   1},
	...
	.ASR_IMM              = { 1509,   2},
	.ROR_IMM              = { 1511,   2},
	.SVE_BFADD_UNPRED     = { 1513,   1},
	.SVE_BFSUB_UNPRED     = { 1514,   1},
	.SVE_BFMUL_UNPRED     = { 1515,   1},
	.SVE_BFCLAMP          = { 1516,   1},
	.SVE_BFMAXNM          = { 1517,   1},
	.SVE_BFMINNM          = { 1518,   1},
	.SME2_LUTI2_B         = { 1519,   1},
	...
	.AT_S12E0W            = { 1603,   1},
	.TLBI_VMALLE1         = { 1604,   1},
	.TLBI_VMALLE1IS       = { 1605,   1},
	.TLBI_VAE1            = { 1606,   1},
	.TLBI_VAE1IS          = { 1607,   1},
	.TLBI_ASIDE1          = { 1608,   1},
	.TLBI_ASIDE1IS        = { 1609,   1},
	.TLBI_VAAE1           = { 1610,   1},
	.TLBI_VAAE1IS         = { 1611,   1},
	.TLBI_VALE1           = { 1612,   1},
	.TLBI_VALE1IS         = { 1613,   1},
	.TLBI_VAALE1          = { 1614,   1},
	.TLBI_VAALE1IS        = { 1615,   1},
	.TLBI_ALLE1           = { 1616,   1},
	.TLBI_ALLE1IS         = { 1617,   1},
	.TLBI_ALLE2           = { 1618,   1},
	.TLBI_ALLE2IS         = { 1619,   1},
