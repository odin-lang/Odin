...
@(rodata)
ENCODE_FORMS := [2390]lib.Encoding{
	// .ADD_IMM
...
ENCODE_RUNS := [lib.Mnemonic]lib.Encode_Run{
	...
	.SVE_ADD_PRED         = { 1689,   4},
	.SVE_SUB_PRED         = { 1693,   4},
	.SVE_SUBR_PRED        = { 1697,   4},
	.SVE_MUL_PRED         = { 1701,   4},
	.SVE_SMULH_PRED       = { 1705,   4},
	.SVE_UMULH_PRED       = { 1709,   4},
	.SVE_SDIV_PRED        = { 1713,   2},
	.SVE_UDIV_PRED        = { 1715,   2},
	.SVE_SMAX_PRED        = { 1717,   4},
	.SVE_UMAX_PRED        = { 1721,   4},
	.SVE_SMIN_PRED        = { 1725,   4},
	.SVE_UMIN_PRED        = { 1729,   4},
	.SVE_SABD_PRED        = { 1733,   4},
	.SVE_UABD_PRED        = { 1737,   4},
	.SVE_AND_PRED         = { 1741,   1},
	.SVE_ORR_PRED         = { 1742,   1},
	.SVE_EOR_PRED         = { 1743,   1},
	.SVE_BIC_PRED         = { 1744,   1},
	...
	.SVE_LSL_PRED         = { 1749,   4},
	.SVE_LSR_PRED         = { 1753,   4},
	.SVE_ASRR_PRED        = { 1757,   4},
	.SVE_LSLR_PRED        = { 1761,   4},
	.SVE_LSRR_PRED        = { 1765,   4},
	.SVE_ABS_PRED         = { 1769,   4},
	.SVE_NEG_PRED         = { 1773,   4},
	.SVE_CLS_PRED         = { 1777,   4},
	.SVE_CLZ_PRED         = { 1781,   4},
	...
	.SVE_FRSQRTS          = { 1805,   3},
	.SVE_FTSMUL           = { 1808,   3},
	.SVE_FADD_PRED        = { 1811,   3},
	.SVE_FSUB_PRED        = { 1814,   3},
	.SVE_FSUBR_PRED       = { 1817,   3},
	.SVE_FMUL_PRED        = { 1820,   3},
	.SVE_FDIV_PRED        = { 1823,   3},
	.SVE_FDIVR_PRED       = { 1826,   3},
	.SVE_FMAX_PRED        = { 1829,   3},
	.SVE_FMIN_PRED        = { 1832,   3},
	.SVE_FMAXNM_PRED      = { 1835,   3},
	.SVE_FMINNM_PRED      = { 1838,   3},
	.SVE_FABS_Z           = { 1841,   3},
	.SVE_FNEG_Z           = { 1844,   3},
	.SVE_FSQRT_Z          = { 1847,   3},
	.SVE_FRECPX_Z         = { 1850,   3},
	...
	.SME_USMOPA           = { 2111,   1},
	.SME_SUMOPA           = { 2112,   1},
	.SME_MOVA_TO_Z        = { 2113,   0},
	.SME_MOVA_TO_ZA       = { 2113,   0},
	.SME_LD1B_ZA          = { 2113,   0},
	.SME_LD1H_ZA          = { 2113,   0},
	.SME_LD1W_ZA          = { 2113,   0},
	.SME_LD1D_ZA          = { 2113,   0},
	...
	.SME_LDR_ZA           = { 2113,   1},
	.SME_STR_ZA           = { 2114,   1},
	.SVE_FMLA_IDX_H       = { 2115,   1},
	.SVE_FMLA_IDX_S       = { 2116,   1},
	.SVE_FMLA_IDX_D       = { 2117,   1},
	.SVE_FMLS_IDX_H       = { 2118,   1},
	.SVE_FMLS_IDX_S       = { 2119,   1},
	.SVE_FMLS_IDX_D       = { 2120,   1},
	.SVE_LD1B_GATHER_S    = { 2121,   1},
	.SVE_LD1B_GATHER_D    = { 2122,   1},
	.SVE_LD1H_GATHER_S    = { 2123,   1},
	.SVE_LD1H_GATHER_D    = { 2124,   1},
	.SVE_LD1W_GATHER_S    = { 2125,   1},
	.SVE_LD1W_GATHER_D    = { 2126,   1},
	.SVE_LD1D_GATHER_D    = { 2127,   1},
	.SVE_LD1SB_GATHER_S   = { 2128,   1},
	.SVE_LD1SB_GATHER_D   = { 2129,   1},
	.SVE_LD1SH_GATHER_S   = { 2130,   1},
	.SVE_LD1SH_GATHER_D   = { 2131,   1},
	.SVE_LD1SW_GATHER_D   = { 2132,   1},
	.SVE_ST1B_SCATTER_S   = { 2133,   1},
	.SVE_ST1B_SCATTER_D   = { 2134,   1},
	.SVE_ST1H_SCATTER_S   = { 2135,   1},
	.SVE_ST1H_SCATTER_D   = { 2136,   1},
	.SVE_ST1W_SCATTER_S   = { 2137,   1},
	.SVE_ST1W_SCATTER_D   = { 2138,   1},
	.SVE_ST1D_SCATTER_D   = { 2139,   1},
	.SME_LD1B_TILE        = { 2140,   1},
	.SME_LD1H_TILE        = { 2141,   1},
	.SME_LD1W_TILE        = { 2142,   1},
	.SME_LD1D_TILE        = { 2143,   1},
	.SME_LD1Q_TILE        = { 2144,   1},
	.SME_ST1B_TILE        = { 2145,   1},
	.SME_ST1H_TILE        = { 2146,   1},
	.SME_ST1W_TILE        = { 2147,   1},
	.SME_ST1D_TILE        = { 2148,   1},
	.SME_ST1Q_TILE        = { 2149,   1},
	.SME_MOVA_Z_FROM_TILE = { 2150,   1},
	.SME_MOVA_TILE_FROM_Z = { 2151,   1},
	.FCMLA_4H             = { 2152,   1},
	.FCMLA_8H             = { 2153,   1},
	.FCMLA_4S             = { 2154,   1},
	.FCMLA_2D             = { 2155,   1},
	...
	.ASR_IMM              = { 2250,   2},
	.ROR_IMM              = { 2252,   2},
	.SVE_BFADD_UNPRED     = { 2254,   1},
	.SVE_BFSUB_UNPRED     = { 2255,   1},
	.SVE_BFMUL_UNPRED     = { 2256,   1},
	.SVE_BFCLAMP          = { 2257,   1},
	.SVE_BFMAXNM          = { 2258,   1},
	.SVE_BFMINNM          = { 2259,   1},
	.SME2_LUTI2_B         = { 2260,   1},
	...
	.AT_S12E0W            = { 2344,   1},
	.TLBI_VMALLE1         = { 2345,   1},
	.TLBI_VMALLE1IS       = { 2346,   1},
	.TLBI_VAE1            = { 2347,   1},
	.TLBI_VAE1IS          = { 2348,   1},
	.TLBI_ASIDE1          = { 2349,   1},
	.TLBI_ASIDE1IS        = { 2350,   1},
	.TLBI_VAAE1           = { 2351,   1},
	.TLBI_VAAE1IS         = { 2352,   1},
	.TLBI_VALE1           = { 2353,   1},
	.TLBI_VALE1IS         = { 2354,   1},
	.TLBI_VAALE1          = { 2355,   1},
	.TLBI_VAALE1IS        = { 2356,   1},
	.TLBI_ALLE1           = { 2357,   1},
	.TLBI_ALLE1IS         = { 2358,   1},
	.TLBI_ALLE2           = { 2359,   1},
	.TLBI_ALLE2IS         = { 2360,   1},
