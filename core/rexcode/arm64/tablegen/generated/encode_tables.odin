...
@(rodata)
ENCODE_FORMS := [2388]lib.Encoding{
	// .ADD_IMM
...
ENCODE_RUNS := [lib.Mnemonic]lib.Encode_Run{
	...
	.SME_USMOPA           = { 2109,   1},
	.SME_SUMOPA           = { 2110,   1},
	.SME_MOVA_TO_Z        = { 2111,   0},
	.SME_MOVA_TO_ZA       = { 2111,   0},
	.SME_LD1B_ZA          = { 2111,   0},
	.SME_LD1H_ZA          = { 2111,   0},
	.SME_LD1W_ZA          = { 2111,   0},
	.SME_LD1D_ZA          = { 2111,   0},
	...
	.SME_LDR_ZA           = { 2111,   1},
	.SME_STR_ZA           = { 2112,   1},
	.SVE_FMLA_IDX_H       = { 2113,   1},
	.SVE_FMLA_IDX_S       = { 2114,   1},
	.SVE_FMLA_IDX_D       = { 2115,   1},
	.SVE_FMLS_IDX_H       = { 2116,   1},
	.SVE_FMLS_IDX_S       = { 2117,   1},
	.SVE_FMLS_IDX_D       = { 2118,   1},
	.SVE_LD1B_GATHER_S    = { 2119,   1},
	.SVE_LD1B_GATHER_D    = { 2120,   1},
	.SVE_LD1H_GATHER_S    = { 2121,   1},
	.SVE_LD1H_GATHER_D    = { 2122,   1},
	.SVE_LD1W_GATHER_S    = { 2123,   1},
	.SVE_LD1W_GATHER_D    = { 2124,   1},
	.SVE_LD1D_GATHER_D    = { 2125,   1},
	.SVE_LD1SB_GATHER_S   = { 2126,   1},
	.SVE_LD1SB_GATHER_D   = { 2127,   1},
	.SVE_LD1SH_GATHER_S   = { 2128,   1},
	.SVE_LD1SH_GATHER_D   = { 2129,   1},
	.SVE_LD1SW_GATHER_D   = { 2130,   1},
	.SVE_ST1B_SCATTER_S   = { 2131,   1},
	.SVE_ST1B_SCATTER_D   = { 2132,   1},
	.SVE_ST1H_SCATTER_S   = { 2133,   1},
	.SVE_ST1H_SCATTER_D   = { 2134,   1},
	.SVE_ST1W_SCATTER_S   = { 2135,   1},
	.SVE_ST1W_SCATTER_D   = { 2136,   1},
	.SVE_ST1D_SCATTER_D   = { 2137,   1},
	.SME_LD1B_TILE        = { 2138,   1},
	.SME_LD1H_TILE        = { 2139,   1},
	.SME_LD1W_TILE        = { 2140,   1},
	.SME_LD1D_TILE        = { 2141,   1},
	.SME_LD1Q_TILE        = { 2142,   1},
	.SME_ST1B_TILE        = { 2143,   1},
	.SME_ST1H_TILE        = { 2144,   1},
	.SME_ST1W_TILE        = { 2145,   1},
	.SME_ST1D_TILE        = { 2146,   1},
	.SME_ST1Q_TILE        = { 2147,   1},
	.SME_MOVA_Z_FROM_TILE = { 2148,   1},
	.SME_MOVA_TILE_FROM_Z = { 2149,   1},
	.FCMLA_4H             = { 2150,   1},
	.FCMLA_8H             = { 2151,   1},
	.FCMLA_4S             = { 2152,   1},
	.FCMLA_2D             = { 2153,   1},
	...
	.ASR_IMM              = { 2248,   2},
	.ROR_IMM              = { 2250,   2},
	.SVE_BFADD_UNPRED     = { 2252,   1},
	.SVE_BFSUB_UNPRED     = { 2253,   1},
	.SVE_BFMUL_UNPRED     = { 2254,   1},
	.SVE_BFCLAMP          = { 2255,   1},
	.SVE_BFMAXNM          = { 2256,   1},
	.SVE_BFMINNM          = { 2257,   1},
	.SME2_LUTI2_B         = { 2258,   1},
	...
	.AT_S12E0W            = { 2342,   1},
	.TLBI_VMALLE1         = { 2343,   1},
	.TLBI_VMALLE1IS       = { 2344,   1},
	.TLBI_VAE1            = { 2345,   1},
	.TLBI_VAE1IS          = { 2346,   1},
	.TLBI_ASIDE1          = { 2347,   1},
	.TLBI_ASIDE1IS        = { 2348,   1},
	.TLBI_VAAE1           = { 2349,   1},
	.TLBI_VAAE1IS         = { 2350,   1},
	.TLBI_VALE1           = { 2351,   1},
	.TLBI_VALE1IS         = { 2352,   1},
	.TLBI_VAALE1          = { 2353,   1},
	.TLBI_VAALE1IS        = { 2354,   1},
	.TLBI_ALLE1           = { 2355,   1},
	.TLBI_ALLE1IS         = { 2356,   1},
	.TLBI_ALLE2           = { 2357,   1},
	.TLBI_ALLE2IS         = { 2358,   1},
