...
@(rodata)
ENCODE_FORMS := [1890]lib.Encoding{
	// .ADD_IMM
...
ENCODE_RUNS := [lib.Mnemonic]lib.Encode_Run{
	...
	.SVE_ADD_PRED         = { 1304,   4},
	.SVE_SUB_PRED         = { 1308,   4},
	.SVE_SUBR_PRED        = { 1312,   4},
	.SVE_MUL_PRED         = { 1316,   4},
	.SVE_SMULH_PRED       = { 1320,   4},
	.SVE_UMULH_PRED       = { 1324,   4},
	.SVE_SDIV_PRED        = { 1328,   2},
	.SVE_UDIV_PRED        = { 1330,   2},
	.SVE_SMAX_PRED        = { 1332,   4},
	.SVE_UMAX_PRED        = { 1336,   4},
	.SVE_SMIN_PRED        = { 1340,   4},
	.SVE_UMIN_PRED        = { 1344,   4},
	.SVE_SABD_PRED        = { 1348,   4},
	.SVE_UABD_PRED        = { 1352,   4},
	.SVE_AND_PRED         = { 1356,   1},
	.SVE_ORR_PRED         = { 1357,   1},
	.SVE_EOR_PRED         = { 1358,   1},
	.SVE_BIC_PRED         = { 1359,   1},
	...
	.SVE_LSL_PRED         = { 1364,   4},
	.SVE_LSR_PRED         = { 1368,   4},
	.SVE_ASRR_PRED        = { 1372,   0},
	.SVE_LSLR_PRED        = { 1372,   0},
	.SVE_LSRR_PRED        = { 1372,   0},
	.SVE_ABS_PRED         = { 1372,   4},
	.SVE_NEG_PRED         = { 1376,   4},
	.SVE_CLS_PRED         = { 1380,   4},
	.SVE_CLZ_PRED         = { 1384,   4},
	...
	.SVE_FRSQRTS          = { 1404,   3},
	.SVE_FTSMUL           = { 1407,   3},
	.SVE_FADD_PRED        = { 1410,   3},
	.SVE_FSUB_PRED        = { 1413,   3},
	.SVE_FSUBR_PRED       = { 1416,   0},
	.SVE_FMUL_PRED        = { 1416,   3},
	.SVE_FDIV_PRED        = { 1419,   3},
	.SVE_FDIVR_PRED       = { 1422,   0},
	.SVE_FMAX_PRED        = { 1422,   3},
	.SVE_FMIN_PRED        = { 1425,   3},
	.SVE_FMAXNM_PRED      = { 1428,   3},
	.SVE_FMINNM_PRED      = { 1431,   3},
	.SVE_FABS_Z           = { 1434,   3},
	.SVE_FNEG_Z           = { 1437,   3},
	.SVE_FSQRT_Z          = { 1440,   3},
	.SVE_FRECPX_Z         = { 1443,   0},
	...
	.SME_USMOPA           = { 1611,   1},
	.SME_SUMOPA           = { 1612,   1},
	.SME_MOVA_TO_Z        = { 1613,   0},
	.SME_MOVA_TO_ZA       = { 1613,   0},
	.SME_LD1B_ZA          = { 1613,   0},
	.SME_LD1H_ZA          = { 1613,   0},
	.SME_LD1W_ZA          = { 1613,   0},
	.SME_LD1D_ZA          = { 1613,   0},
	...
	.SME_LDR_ZA           = { 1613,   1},
	.SME_STR_ZA           = { 1614,   1},
	.SVE_FMLA_IDX_H       = { 1615,   1},
	.SVE_FMLA_IDX_S       = { 1616,   1},
	.SVE_FMLA_IDX_D       = { 1617,   1},
	.SVE_FMLS_IDX_H       = { 1618,   1},
	.SVE_FMLS_IDX_S       = { 1619,   1},
	.SVE_FMLS_IDX_D       = { 1620,   1},
	.SVE_LD1B_GATHER_S    = { 1621,   1},
	.SVE_LD1B_GATHER_D    = { 1622,   1},
	.SVE_LD1H_GATHER_S    = { 1623,   1},
	.SVE_LD1H_GATHER_D    = { 1624,   1},
	.SVE_LD1W_GATHER_S    = { 1625,   1},
	.SVE_LD1W_GATHER_D    = { 1626,   1},
	.SVE_LD1D_GATHER_D    = { 1627,   1},
	.SVE_LD1SB_GATHER_S   = { 1628,   1},
	.SVE_LD1SB_GATHER_D   = { 1629,   1},
	.SVE_LD1SH_GATHER_S   = { 1630,   1},
	.SVE_LD1SH_GATHER_D   = { 1631,   1},
	.SVE_LD1SW_GATHER_D   = { 1632,   1},
	.SVE_ST1B_SCATTER_S   = { 1633,   1},
	.SVE_ST1B_SCATTER_D   = { 1634,   1},
	.SVE_ST1H_SCATTER_S   = { 1635,   1},
	.SVE_ST1H_SCATTER_D   = { 1636,   1},
	.SVE_ST1W_SCATTER_S   = { 1637,   1},
	.SVE_ST1W_SCATTER_D   = { 1638,   1},
	.SVE_ST1D_SCATTER_D   = { 1639,   1},
	.SME_LD1B_TILE        = { 1640,   1},
	.SME_LD1H_TILE        = { 1641,   1},
	.SME_LD1W_TILE        = { 1642,   1},
	.SME_LD1D_TILE        = { 1643,   1},
	.SME_LD1Q_TILE        = { 1644,   1},
	.SME_ST1B_TILE        = { 1645,   1},
	.SME_ST1H_TILE        = { 1646,   1},
	.SME_ST1W_TILE        = { 1647,   1},
	.SME_ST1D_TILE        = { 1648,   1},
	.SME_ST1Q_TILE        = { 1649,   1},
	.SME_MOVA_Z_FROM_TILE = { 1650,   1},
	.SME_MOVA_TILE_FROM_Z = { 1651,   1},
	.FCMLA_4H             = { 1652,   1},
	.FCMLA_8H             = { 1653,   1},
	.FCMLA_4S             = { 1654,   1},
	.FCMLA_2D             = { 1655,   1},
	...
	.ASR_IMM              = { 1750,   2},
	.ROR_IMM              = { 1752,   2},
	.SVE_BFADD_UNPRED     = { 1754,   1},
	.SVE_BFSUB_UNPRED     = { 1755,   1},
	.SVE_BFMUL_UNPRED     = { 1756,   1},
	.SVE_BFCLAMP          = { 1757,   1},
	.SVE_BFMAXNM          = { 1758,   1},
	.SVE_BFMINNM          = { 1759,   1},
	.SME2_LUTI2_B         = { 1760,   1},
	...
	.AT_S12E0W            = { 1844,   1},
	.TLBI_VMALLE1         = { 1845,   1},
	.TLBI_VMALLE1IS       = { 1846,   1},
	.TLBI_VAE1            = { 1847,   1},
	.TLBI_VAE1IS          = { 1848,   1},
	.TLBI_ASIDE1          = { 1849,   1},
	.TLBI_ASIDE1IS        = { 1850,   1},
	.TLBI_VAAE1           = { 1851,   1},
	.TLBI_VAAE1IS         = { 1852,   1},
	.TLBI_VALE1           = { 1853,   1},
	.TLBI_VALE1IS         = { 1854,   1},
	.TLBI_VAALE1          = { 1855,   1},
	.TLBI_VAALE1IS        = { 1856,   1},
	.TLBI_ALLE1           = { 1857,   1},
	.TLBI_ALLE1IS         = { 1858,   1},
	.TLBI_ALLE2           = { 1859,   1},
	.TLBI_ALLE2IS         = { 1860,   1},
