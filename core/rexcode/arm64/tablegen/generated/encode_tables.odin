...
@(rodata)
ENCODE_FORMS := [1734]lib.Encoding{
	// .ADD_IMM
...
ENCODE_RUNS := [lib.Mnemonic]lib.Encode_Run{
	...
	.SVE_ADD_PRED         = { 1148,   4},
	.SVE_SUB_PRED         = { 1152,   4},
	.SVE_SUBR_PRED        = { 1156,   4},
	.SVE_MUL_PRED         = { 1160,   4},
	.SVE_SMULH_PRED       = { 1164,   4},
	.SVE_UMULH_PRED       = { 1168,   4},
	.SVE_SDIV_PRED        = { 1172,   2},
	.SVE_UDIV_PRED        = { 1174,   2},
	.SVE_SMAX_PRED        = { 1176,   4},
	.SVE_UMAX_PRED        = { 1180,   4},
	.SVE_SMIN_PRED        = { 1184,   4},
	.SVE_UMIN_PRED        = { 1188,   4},
	.SVE_SABD_PRED        = { 1192,   4},
	.SVE_UABD_PRED        = { 1196,   4},
	.SVE_AND_PRED         = { 1200,   1},
	.SVE_ORR_PRED         = { 1201,   1},
	.SVE_EOR_PRED         = { 1202,   1},
	.SVE_BIC_PRED         = { 1203,   1},
	...
	.SVE_LSL_PRED         = { 1208,   4},
	.SVE_LSR_PRED         = { 1212,   4},
	.SVE_ASRR_PRED        = { 1216,   0},
	.SVE_LSLR_PRED        = { 1216,   0},
	.SVE_LSRR_PRED        = { 1216,   0},
	.SVE_ABS_PRED         = { 1216,   4},
	.SVE_NEG_PRED         = { 1220,   4},
	.SVE_CLS_PRED         = { 1224,   4},
	.SVE_CLZ_PRED         = { 1228,   4},
	...
	.SVE_FRSQRTS          = { 1248,   3},
	.SVE_FTSMUL           = { 1251,   3},
	.SVE_FADD_PRED        = { 1254,   3},
	.SVE_FSUB_PRED        = { 1257,   3},
	.SVE_FSUBR_PRED       = { 1260,   0},
	.SVE_FMUL_PRED        = { 1260,   3},
	.SVE_FDIV_PRED        = { 1263,   3},
	.SVE_FDIVR_PRED       = { 1266,   0},
	.SVE_FMAX_PRED        = { 1266,   3},
	.SVE_FMIN_PRED        = { 1269,   3},
	.SVE_FMAXNM_PRED      = { 1272,   3},
	.SVE_FMINNM_PRED      = { 1275,   3},
	.SVE_FABS_Z           = { 1278,   3},
	.SVE_FNEG_Z           = { 1281,   3},
	.SVE_FSQRT_Z          = { 1284,   3},
	.SVE_FRECPX_Z         = { 1287,   0},
	...
	.SME_USMOPA           = { 1455,   1},
	.SME_SUMOPA           = { 1456,   1},
	.SME_MOVA_TO_Z        = { 1457,   0},
	.SME_MOVA_TO_ZA       = { 1457,   0},
	.SME_LD1B_ZA          = { 1457,   0},
	.SME_LD1H_ZA          = { 1457,   0},
	.SME_LD1W_ZA          = { 1457,   0},
	.SME_LD1D_ZA          = { 1457,   0},
	...
	.SME_LDR_ZA           = { 1457,   1},
	.SME_STR_ZA           = { 1458,   1},
	.SVE_FMLA_IDX_H       = { 1459,   1},
	.SVE_FMLA_IDX_S       = { 1460,   1},
	.SVE_FMLA_IDX_D       = { 1461,   1},
	.SVE_FMLS_IDX_H       = { 1462,   1},
	.SVE_FMLS_IDX_S       = { 1463,   1},
	.SVE_FMLS_IDX_D       = { 1464,   1},
	.SVE_LD1B_GATHER_S    = { 1465,   1},
	.SVE_LD1B_GATHER_D    = { 1466,   1},
	.SVE_LD1H_GATHER_S    = { 1467,   1},
	.SVE_LD1H_GATHER_D    = { 1468,   1},
	.SVE_LD1W_GATHER_S    = { 1469,   1},
	.SVE_LD1W_GATHER_D    = { 1470,   1},
	.SVE_LD1D_GATHER_D    = { 1471,   1},
	.SVE_LD1SB_GATHER_S   = { 1472,   1},
	.SVE_LD1SB_GATHER_D   = { 1473,   1},
	.SVE_LD1SH_GATHER_S   = { 1474,   1},
	.SVE_LD1SH_GATHER_D   = { 1475,   1},
	.SVE_LD1SW_GATHER_D   = { 1476,   1},
	.SVE_ST1B_SCATTER_S   = { 1477,   1},
	.SVE_ST1B_SCATTER_D   = { 1478,   1},
	.SVE_ST1H_SCATTER_S   = { 1479,   1},
	.SVE_ST1H_SCATTER_D   = { 1480,   1},
	.SVE_ST1W_SCATTER_S   = { 1481,   1},
	.SVE_ST1W_SCATTER_D   = { 1482,   1},
	.SVE_ST1D_SCATTER_D   = { 1483,   1},
	.SME_LD1B_TILE        = { 1484,   1},
	.SME_LD1H_TILE        = { 1485,   1},
	.SME_LD1W_TILE        = { 1486,   1},
	.SME_LD1D_TILE        = { 1487,   1},
	.SME_LD1Q_TILE        = { 1488,   1},
	.SME_ST1B_TILE        = { 1489,   1},
	.SME_ST1H_TILE        = { 1490,   1},
	.SME_ST1W_TILE        = { 1491,   1},
	.SME_ST1D_TILE        = { 1492,   1},
	.SME_ST1Q_TILE        = { 1493,   1},
	.SME_MOVA_Z_FROM_TILE = { 1494,   1},
	.SME_MOVA_TILE_FROM_Z = { 1495,   1},
	.FCMLA_4H             = { 1496,   1},
	.FCMLA_8H             = { 1497,   1},
	.FCMLA_4S             = { 1498,   1},
	.FCMLA_2D             = { 1499,   1},
	...
	.ASR_IMM              = { 1594,   2},
	.ROR_IMM              = { 1596,   2},
	.SVE_BFADD_UNPRED     = { 1598,   1},
	.SVE_BFSUB_UNPRED     = { 1599,   1},
	.SVE_BFMUL_UNPRED     = { 1600,   1},
	.SVE_BFCLAMP          = { 1601,   1},
	.SVE_BFMAXNM          = { 1602,   1},
	.SVE_BFMINNM          = { 1603,   1},
	.SME2_LUTI2_B         = { 1604,   1},
	...
	.AT_S12E0W            = { 1688,   1},
	.TLBI_VMALLE1         = { 1689,   1},
	.TLBI_VMALLE1IS       = { 1690,   1},
	.TLBI_VAE1            = { 1691,   1},
	.TLBI_VAE1IS          = { 1692,   1},
	.TLBI_ASIDE1          = { 1693,   1},
	.TLBI_ASIDE1IS        = { 1694,   1},
	.TLBI_VAAE1           = { 1695,   1},
	.TLBI_VAAE1IS         = { 1696,   1},
	.TLBI_VALE1           = { 1697,   1},
	.TLBI_VALE1IS         = { 1698,   1},
	.TLBI_VAALE1          = { 1699,   1},
	.TLBI_VAALE1IS        = { 1700,   1},
	.TLBI_ALLE1           = { 1701,   1},
	.TLBI_ALLE1IS         = { 1702,   1},
	.TLBI_ALLE2           = { 1703,   1},
	.TLBI_ALLE2IS         = { 1704,   1},
