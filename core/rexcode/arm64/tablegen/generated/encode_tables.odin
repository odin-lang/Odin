...
@(rodata)
ENCODE_FORMS := [2371]lib.Encoding{
	// .ADD_IMM
...
ENCODE_RUNS := [lib.Mnemonic]lib.Encode_Run{
	...
	.SVE_FRSQRTS          = { 1801,   3},
	.SVE_FTSMUL           = { 1804,   3},
	.SVE_FADD_PRED        = { 1807,   3},
	.SVE_FSUB_PRED        = { 1810,   3},
	.SVE_FSUBR_PRED       = { 1813,   3},
	.SVE_FMUL_PRED        = { 1816,   3},
	.SVE_FDIV_PRED        = { 1819,   3},
	.SVE_FDIVR_PRED       = { 1822,   3},
	.SVE_FMAX_PRED        = { 1825,   3},
	.SVE_FMIN_PRED        = { 1828,   3},
	.SVE_FMAXNM_PRED      = { 1831,   3},
	.SVE_FMINNM_PRED      = { 1834,   3},
	.SVE_FABS_Z           = { 1837,   3},
	.SVE_FNEG_Z           = { 1840,   3},
	.SVE_FSQRT_Z          = { 1843,   3},
	.SVE_FRECPX_Z         = { 1846,   3},
	...
	.SME_USMOPA           = { 2092,   1},
	.SME_SUMOPA           = { 2093,   1},
	.SME_MOVA_TO_Z        = { 2094,   0},
	.SME_MOVA_TO_ZA       = { 2094,   0},
	.SME_LD1B_ZA          = { 2094,   0},
	.SME_LD1H_ZA          = { 2094,   0},
	.SME_LD1W_ZA          = { 2094,   0},
	.SME_LD1D_ZA          = { 2094,   0},
	...
	.SME_LDR_ZA           = { 2094,   1},
	.SME_STR_ZA           = { 2095,   1},
	.SVE_FMLA_IDX_H       = { 2096,   1},
	.SVE_FMLA_IDX_S       = { 2097,   1},
	.SVE_FMLA_IDX_D       = { 2098,   1},
	.SVE_FMLS_IDX_H       = { 2099,   1},
	.SVE_FMLS_IDX_S       = { 2100,   1},
	.SVE_FMLS_IDX_D       = { 2101,   1},
	.SVE_LD1B_GATHER_S    = { 2102,   1},
	.SVE_LD1B_GATHER_D    = { 2103,   1},
	.SVE_LD1H_GATHER_S    = { 2104,   1},
	.SVE_LD1H_GATHER_D    = { 2105,   1},
	.SVE_LD1W_GATHER_S    = { 2106,   1},
	.SVE_LD1W_GATHER_D    = { 2107,   1},
	.SVE_LD1D_GATHER_D    = { 2108,   1},
	.SVE_LD1SB_GATHER_S   = { 2109,   1},
	.SVE_LD1SB_GATHER_D   = { 2110,   1},
	.SVE_LD1SH_GATHER_S   = { 2111,   1},
	.SVE_LD1SH_GATHER_D   = { 2112,   1},
	.SVE_LD1SW_GATHER_D   = { 2113,   1},
	.SVE_ST1B_SCATTER_S   = { 2114,   1},
	.SVE_ST1B_SCATTER_D   = { 2115,   1},
	.SVE_ST1H_SCATTER_S   = { 2116,   1},
	.SVE_ST1H_SCATTER_D   = { 2117,   1},
	.SVE_ST1W_SCATTER_S   = { 2118,   1},
	.SVE_ST1W_SCATTER_D   = { 2119,   1},
	.SVE_ST1D_SCATTER_D   = { 2120,   1},
	.SME_LD1B_TILE        = { 2121,   1},
	.SME_LD1H_TILE        = { 2122,   1},
	.SME_LD1W_TILE        = { 2123,   1},
	.SME_LD1D_TILE        = { 2124,   1},
	.SME_LD1Q_TILE        = { 2125,   1},
	.SME_ST1B_TILE        = { 2126,   1},
	.SME_ST1H_TILE        = { 2127,   1},
	.SME_ST1W_TILE        = { 2128,   1},
	.SME_ST1D_TILE        = { 2129,   1},
	.SME_ST1Q_TILE        = { 2130,   1},
	.SME_MOVA_Z_FROM_TILE = { 2131,   1},
	.SME_MOVA_TILE_FROM_Z = { 2132,   1},
	.FCMLA_4H             = { 2133,   1},
	.FCMLA_8H             = { 2134,   1},
	.FCMLA_4S             = { 2135,   1},
	.FCMLA_2D             = { 2136,   1},
	...
	.ASR_IMM              = { 2231,   2},
	.ROR_IMM              = { 2233,   2},
	.SVE_BFADD_UNPRED     = { 2235,   1},
	.SVE_BFSUB_UNPRED     = { 2236,   1},
	.SVE_BFMUL_UNPRED     = { 2237,   1},
	.SVE_BFCLAMP          = { 2238,   1},
	.SVE_BFMAXNM          = { 2239,   1},
	.SVE_BFMINNM          = { 2240,   1},
	.SME2_LUTI2_B         = { 2241,   1},
	...
	.AT_S12E0W            = { 2325,   1},
	.TLBI_VMALLE1         = { 2326,   1},
	.TLBI_VMALLE1IS       = { 2327,   1},
	.TLBI_VAE1            = { 2328,   1},
	.TLBI_VAE1IS          = { 2329,   1},
	.TLBI_ASIDE1          = { 2330,   1},
	.TLBI_ASIDE1IS        = { 2331,   1},
	.TLBI_VAAE1           = { 2332,   1},
	.TLBI_VAAE1IS         = { 2333,   1},
	.TLBI_VALE1           = { 2334,   1},
	.TLBI_VALE1IS         = { 2335,   1},
	.TLBI_VAALE1          = { 2336,   1},
	.TLBI_VAALE1IS        = { 2337,   1},
	.TLBI_ALLE1           = { 2338,   1},
	.TLBI_ALLE1IS         = { 2339,   1},
	.TLBI_ALLE2           = { 2340,   1},
	.TLBI_ALLE2IS         = { 2341,   1},
