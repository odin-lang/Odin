...
@(rodata)
ENCODE_FORMS := [1590]lib.Encoding{
	// .ADD_IMM
...
ENCODE_RUNS := [lib.Mnemonic]lib.Encode_Run{
	...
	.SVE_ADD_PRED         = { 1004,   4},
	.SVE_SUB_PRED         = { 1008,   4},
	.SVE_SUBR_PRED        = { 1012,   4},
	.SVE_MUL_PRED         = { 1016,   4},
	.SVE_SMULH_PRED       = { 1020,   4},
	.SVE_UMULH_PRED       = { 1024,   4},
	.SVE_SDIV_PRED        = { 1028,   2},
	.SVE_UDIV_PRED        = { 1030,   2},
	.SVE_SMAX_PRED        = { 1032,   4},
	.SVE_UMAX_PRED        = { 1036,   4},
	.SVE_SMIN_PRED        = { 1040,   4},
	.SVE_UMIN_PRED        = { 1044,   4},
	.SVE_SABD_PRED        = { 1048,   4},
	.SVE_UABD_PRED        = { 1052,   4},
	.SVE_AND_PRED         = { 1056,   1},
	.SVE_ORR_PRED         = { 1057,   1},
	.SVE_EOR_PRED         = { 1058,   1},
	.SVE_BIC_PRED         = { 1059,   1},
	...
	.SVE_LSL_PRED         = { 1064,   4},
	.SVE_LSR_PRED         = { 1068,   4},
	.SVE_ASRR_PRED        = { 1072,   0},
	.SVE_LSLR_PRED        = { 1072,   0},
	.SVE_LSRR_PRED        = { 1072,   0},
	.SVE_ABS_PRED         = { 1072,   4},
	.SVE_NEG_PRED         = { 1076,   4},
	.SVE_CLS_PRED         = { 1080,   4},
	.SVE_CLZ_PRED         = { 1084,   4},
	...
	.SVE_FRSQRTS          = { 1104,   3},
	.SVE_FTSMUL           = { 1107,   3},
	.SVE_FADD_PRED        = { 1110,   3},
	.SVE_FSUB_PRED        = { 1113,   3},
	.SVE_FSUBR_PRED       = { 1116,   0},
	.SVE_FMUL_PRED        = { 1116,   3},
	.SVE_FDIV_PRED        = { 1119,   3},
	.SVE_FDIVR_PRED       = { 1122,   0},
	.SVE_FMAX_PRED        = { 1122,   3},
	.SVE_FMIN_PRED        = { 1125,   3},
	.SVE_FMAXNM_PRED      = { 1128,   3},
	.SVE_FMINNM_PRED      = { 1131,   3},
	.SVE_FABS_Z           = { 1134,   3},
	.SVE_FNEG_Z           = { 1137,   3},
	.SVE_FSQRT_Z          = { 1140,   3},
	.SVE_FRECPX_Z         = { 1143,   0},
	...
	.SME_USMOPA           = { 1311,   1},
	.SME_SUMOPA           = { 1312,   1},
	.SME_MOVA_TO_Z        = { 1313,   0},
	.SME_MOVA_TO_ZA       = { 1313,   0},
	.SME_LD1B_ZA          = { 1313,   0},
	.SME_LD1H_ZA          = { 1313,   0},
	.SME_LD1W_ZA          = { 1313,   0},
	.SME_LD1D_ZA          = { 1313,   0},
	...
	.SME_LDR_ZA           = { 1313,   1},
	.SME_STR_ZA           = { 1314,   1},
	.SVE_FMLA_IDX_H       = { 1315,   1},
	.SVE_FMLA_IDX_S       = { 1316,   1},
	.SVE_FMLA_IDX_D       = { 1317,   1},
	.SVE_FMLS_IDX_H       = { 1318,   1},
	.SVE_FMLS_IDX_S       = { 1319,   1},
	.SVE_FMLS_IDX_D       = { 1320,   1},
	.SVE_LD1B_GATHER_S    = { 1321,   1},
	.SVE_LD1B_GATHER_D    = { 1322,   1},
	.SVE_LD1H_GATHER_S    = { 1323,   1},
	.SVE_LD1H_GATHER_D    = { 1324,   1},
	.SVE_LD1W_GATHER_S    = { 1325,   1},
	.SVE_LD1W_GATHER_D    = { 1326,   1},
	.SVE_LD1D_GATHER_D    = { 1327,   1},
	.SVE_LD1SB_GATHER_S   = { 1328,   1},
	.SVE_LD1SB_GATHER_D   = { 1329,   1},
	.SVE_LD1SH_GATHER_S   = { 1330,   1},
	.SVE_LD1SH_GATHER_D   = { 1331,   1},
	.SVE_LD1SW_GATHER_D   = { 1332,   1},
	.SVE_ST1B_SCATTER_S   = { 1333,   1},
	.SVE_ST1B_SCATTER_D   = { 1334,   1},
	.SVE_ST1H_SCATTER_S   = { 1335,   1},
	.SVE_ST1H_SCATTER_D   = { 1336,   1},
	.SVE_ST1W_SCATTER_S   = { 1337,   1},
	.SVE_ST1W_SCATTER_D   = { 1338,   1},
	.SVE_ST1D_SCATTER_D   = { 1339,   1},
	.SME_LD1B_TILE        = { 1340,   1},
	.SME_LD1H_TILE        = { 1341,   1},
	.SME_LD1W_TILE        = { 1342,   1},
	.SME_LD1D_TILE        = { 1343,   1},
	.SME_LD1Q_TILE        = { 1344,   1},
	.SME_ST1B_TILE        = { 1345,   1},
	.SME_ST1H_TILE        = { 1346,   1},
	.SME_ST1W_TILE        = { 1347,   1},
	.SME_ST1D_TILE        = { 1348,   1},
	.SME_ST1Q_TILE        = { 1349,   1},
	.SME_MOVA_Z_FROM_TILE = { 1350,   1},
	.SME_MOVA_TILE_FROM_Z = { 1351,   1},
	.FCMLA_4H             = { 1352,   1},
	.FCMLA_8H             = { 1353,   1},
	.FCMLA_4S             = { 1354,   1},
	.FCMLA_2D             = { 1355,   1},
	...
	.ASR_IMM              = { 1450,   2},
	.ROR_IMM              = { 1452,   2},
	.SVE_BFADD_UNPRED     = { 1454,   1},
	.SVE_BFSUB_UNPRED     = { 1455,   1},
	.SVE_BFMUL_UNPRED     = { 1456,   1},
	.SVE_BFCLAMP          = { 1457,   1},
	.SVE_BFMAXNM          = { 1458,   1},
	.SVE_BFMINNM          = { 1459,   1},
	.SME2_LUTI2_B         = { 1460,   1},
	...
	.AT_S12E0W            = { 1544,   1},
	.TLBI_VMALLE1         = { 1545,   1},
	.TLBI_VMALLE1IS       = { 1546,   1},
	.TLBI_VAE1            = { 1547,   1},
	.TLBI_VAE1IS          = { 1548,   1},
	.TLBI_ASIDE1          = { 1549,   1},
	.TLBI_ASIDE1IS        = { 1550,   1},
	.TLBI_VAAE1           = { 1551,   1},
	.TLBI_VAAE1IS         = { 1552,   1},
	.TLBI_VALE1           = { 1553,   1},
	.TLBI_VALE1IS         = { 1554,   1},
	.TLBI_VAALE1          = { 1555,   1},
	.TLBI_VAALE1IS        = { 1556,   1},
	.TLBI_ALLE1           = { 1557,   1},
	.TLBI_ALLE1IS         = { 1558,   1},
	.TLBI_ALLE2           = { 1559,   1},
	.TLBI_ALLE2IS         = { 1560,   1},
