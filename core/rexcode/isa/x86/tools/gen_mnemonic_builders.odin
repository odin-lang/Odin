...
//
// Run with: odin run x86/tools/gen_mnemonic_builders.odin -file
//
// Output: x86/mnemonic_builders.odin. The path is anchored via #directory, so
// this runs correctly from any working directory (e.g. the repo root).
