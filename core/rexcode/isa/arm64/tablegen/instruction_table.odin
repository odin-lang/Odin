...
INSTRUCTION_TABLE := [Mnemonic][]Form{
	...
	.ADD = {
		...
		{{.ADD,            {.Z_REG_B, .P_REG_MERGE, .Z_REG_B,    .Z_REG_B}, {.VD, .PG, .VD,    .VN},   0x04000000, 0xFFFFE000, .SVE,  {}},                                    {written={0}, read={1, 2, 3}}},
		{{.ADD,            {.Z_REG_H, .P_REG_MERGE, .Z_REG_H,    .Z_REG_H}, {.VD, .PG, .VD,    .VN},   0x04400000, 0xFFFFE000, .SVE,  {}},                                    {written={0}, read={1, 2, 3}}},
		{{.ADD,            {.Z_REG_S, .P_REG_MERGE, .Z_REG_S,    .Z_REG_S}, {.VD, .PG, .VD,    .VN},   0x04800000, 0xFFFFE000, .SVE,  {}},                                    {written={0}, read={1, 2, 3}}},
		{{.ADD,            {.Z_REG_D, .P_REG_MERGE, .Z_REG_D,    .Z_REG_D}, {.VD, .PG, .VD,    .VN},   0x04C00000, 0xFFFFE000, .SVE,  {is_64=true}},                          {written={0}, read={1, 2, 3}}},
	},
	.ADDS = {
	...
	.SUB = {
		...
		{{.SUB,            {.Z_REG_B, .P_REG_MERGE, .Z_REG_B,    .Z_REG_B}, {.VD, .PG, .VD,    .VN},   0x04010000, 0xFFFFE000, .SVE,  {}},                                    {written={0}, read={1, 2, 3}}},
		{{.SUB,            {.Z_REG_H, .P_REG_MERGE, .Z_REG_H,    .Z_REG_H}, {.VD, .PG, .VD,    .VN},   0x04410000, 0xFFFFE000, .SVE,  {}},                                    {written={0}, read={1, 2, 3}}},
		{{.SUB,            {.Z_REG_S, .P_REG_MERGE, .Z_REG_S,    .Z_REG_S}, {.VD, .PG, .VD,    .VN},   0x04810000, 0xFFFFE000, .SVE,  {}},                                    {written={0}, read={1, 2, 3}}},
		{{.SUB,            {.Z_REG_D, .P_REG_MERGE, .Z_REG_D,    .Z_REG_D}, {.VD, .PG, .VD,    .VN},   0x04C10000, 0xFFFFE000, .SVE,  {is_64=true}},                          {written={0}, read={1, 2, 3}}},
	},
	.SUBS = {
	...
	.AND = {
		...
		{{.AND,            {.Z_REG_B, .P_REG_MERGE, .Z_REG_B,     .Z_REG_B}, {.VD, .PG,  .VD,            .VN},   0x041A0000, 0xFFFFE000, .SVE,  {}},                {written={0}, read={1, 2, 3}}},
		{{.AND,            {.Z_REG_H, .P_REG_MERGE, .Z_REG_H,     .Z_REG_H}, {.VD, .PG,  .VD,            .VN},   0x045A0000, 0xFFFFE000, .SVE,  {}},                {written={0}, read={1, 2, 3}}},
		{{.AND,            {.Z_REG_S, .P_REG_MERGE, .Z_REG_S,     .Z_REG_S}, {.VD, .PG,  .VD,            .VN},   0x049A0000, 0xFFFFE000, .SVE,  {}},                {written={0}, read={1, 2, 3}}},
		{{.AND,            {.Z_REG_D, .P_REG_MERGE, .Z_REG_D,     .Z_REG_D}, {.VD, .PG,  .VD,            .VN},   0x04DA0000, 0xFFFFE000, .SVE,  {is_64=true}},                {written={0}, read={1, 2, 3}}},
		{{.AND,            {.P_REG_B,   .P_REG_ZERO,  .P_REG_B,       .P_REG_B},   {.PD, .PG4, .PN,            .PM},   0x25004000, 0xFFE0C210, .SVE,  {}},                          {written={0}, read={1, 2, 3}}},
	},
	.ANDS = {
	...
	.ORR = {
		...
		{{.ORR,            {.Z_REG_B, .P_REG_MERGE, .Z_REG_B,     .Z_REG_B}, {.VD, .PG,  .VD,            .VN},   0x04180000, 0xFFFFE000, .SVE,  {}},                {written={0}, read={1, 2, 3}}},
	...
	.EOR = {
		...
		{{.EOR,            {.Z_REG_B, .P_REG_MERGE, .Z_REG_B,     .Z_REG_B}, {.VD, .PG,  .VD,            .VN},   0x04190000, 0xFFFFE000, .SVE,  {}},                {written={0}, read={1, 2, 3}}},
		{{.EOR,            {.Z_REG_H, .P_REG_MERGE, .Z_REG_H,     .Z_REG_H}, {.VD, .PG,  .VD,            .VN},   0x04590000, 0xFFFFE000, .SVE,  {}},                {written={0}, read={1, 2, 3}}},
		{{.EOR,            {.Z_REG_S, .P_REG_MERGE, .Z_REG_S,     .Z_REG_S}, {.VD, .PG,  .VD,            .VN},   0x04990000, 0xFFFFE000, .SVE,  {}},                {written={0}, read={1, 2, 3}}},
		{{.EOR,            {.Z_REG_D, .P_REG_MERGE, .Z_REG_D,     .Z_REG_D}, {.VD, .PG,  .VD,            .VN},   0x04D90000, 0xFFFFE000, .SVE,  {is_64=true}},                {written={0}, read={1, 2, 3}}},
		{{.EOR,            {.P_REG_B,   .P_REG_ZERO,  .P_REG_B,       .P_REG_B},   {.PD, .PG4, .PN,            .PM},   0x25004200, 0xFFE0C210, .SVE,  {}},                          {written={0}, read={1, 2, 3}}},
	},
	.BIC = {
		...
		{{.BIC,            {.Z_REG_B, .P_REG_MERGE, .Z_REG_B,   .Z_REG_B}, {.VD, .PG,  .VD, .VN},   0x041B0000, 0xFFFFE000, .SVE,  {}},                             {written={0}, read={1, 2, 3}}},
		{{.BIC,            {.Z_REG_H, .P_REG_MERGE, .Z_REG_H,   .Z_REG_H}, {.VD, .PG,  .VD, .VN},   0x045B0000, 0xFFFFE000, .SVE,  {}},                             {written={0}, read={1, 2, 3}}},
		{{.BIC,            {.Z_REG_S, .P_REG_MERGE, .Z_REG_S,   .Z_REG_S}, {.VD, .PG,  .VD, .VN},   0x049B0000, 0xFFFFE000, .SVE,  {}},                             {written={0}, read={1, 2, 3}}},
		{{.BIC,            {.Z_REG_D, .P_REG_MERGE, .Z_REG_D,   .Z_REG_D}, {.VD, .PG,  .VD, .VN},   0x04DB0000, 0xFFFFE000, .SVE,  {is_64=true}},                             {written={0}, read={1, 2, 3}}},
		{{.BIC,            {.P_REG_B,   .P_REG_ZERO,  .P_REG_B,     .P_REG_B},   {.PD, .PG4, .PN, .PM},   0x25004010, 0xFFE0C210, .SVE,  {}},                                       {written={0}, read={1, 2, 3}}},
	},
	.BICS = {
	...
	.LSL = {
		...
		{{.LSL,            {.Z_REG_B, .P_REG_MERGE, .Z_REG_B, .Z_REG_B}, {.VD, .PG, .VD,            .VN},   0x04138000, 0xFFFFE000, .SVE,  {}},                               {written={0}, read={1, 2, 3}}},
		{{.LSL,            {.Z_REG_H, .P_REG_MERGE, .Z_REG_H, .Z_REG_H}, {.VD, .PG, .VD,            .VN},   0x04538000, 0xFFFFE000, .SVE,  {}},                               {written={0}, read={1, 2, 3}}},
		{{.LSL,            {.Z_REG_S, .P_REG_MERGE, .Z_REG_S, .Z_REG_S}, {.VD, .PG, .VD,            .VN},   0x04938000, 0xFFFFE000, .SVE,  {}},                               {written={0}, read={1, 2, 3}}},
		{{.LSL,            {.Z_REG_D, .P_REG_MERGE, .Z_REG_D, .Z_REG_D}, {.VD, .PG, .VD,            .VN},   0x04D38000, 0xFFFFE000, .SVE,  {is_64=true}},                     {written={0}, read={1, 2, 3}}},
	...
	.LSR = {
		...
		{{.LSR,            {.Z_REG_B, .P_REG_MERGE, .Z_REG_B, .Z_REG_B}, {.VD, .PG, .VD,             .VN},   0x04118000, 0xFFFFE000, .SVE,  {}},                              {written={0}, read={1, 2, 3}}},
		{{.LSR,            {.Z_REG_H, .P_REG_MERGE, .Z_REG_H, .Z_REG_H}, {.VD, .PG, .VD,             .VN},   0x04518000, 0xFFFFE000, .SVE,  {}},                              {written={0}, read={1, 2, 3}}},
		{{.LSR,            {.Z_REG_S, .P_REG_MERGE, .Z_REG_S, .Z_REG_S}, {.VD, .PG, .VD,             .VN},   0x04918000, 0xFFFFE000, .SVE,  {}},                              {written={0}, read={1, 2, 3}}},
		{{.LSR,            {.Z_REG_D, .P_REG_MERGE, .Z_REG_D, .Z_REG_D}, {.VD, .PG, .VD,             .VN},   0x04D18000, 0xFFFFE000, .SVE,  {is_64=true}},                    {written={0}, read={1, 2, 3}}},
	...
	.ASR = {
		...
		{{.ASR,            {.Z_REG_B, .P_REG_MERGE, .Z_REG_B, .Z_REG_B}, {.VD, .PG, .VD,             .VN},   0x04108000, 0xFFFFE000, .SVE,  {}},                              {written={0}, read={1, 2, 3}}},
		{{.ASR,            {.Z_REG_H, .P_REG_MERGE, .Z_REG_H, .Z_REG_H}, {.VD, .PG, .VD,             .VN},   0x04508000, 0xFFFFE000, .SVE,  {}},                              {written={0}, read={1, 2, 3}}},
		{{.ASR,            {.Z_REG_S, .P_REG_MERGE, .Z_REG_S, .Z_REG_S}, {.VD, .PG, .VD,             .VN},   0x04908000, 0xFFFFE000, .SVE,  {}},                              {written={0}, read={1, 2, 3}}},
		{{.ASR,            {.Z_REG_D, .P_REG_MERGE, .Z_REG_D, .Z_REG_D}, {.VD, .PG, .VD,             .VN},   0x04D08000, 0xFFFFE000, .SVE,  {is_64=true}},                    {written={0}, read={1, 2, 3}}},
	...
	.UDIV = {
		...
		{{.UDIV,           {.Z_REG_S, .P_REG_MERGE, .Z_REG_S, .Z_REG_S}, {.VD, .PG, .VD, .VN},   0x04950000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}}},
		{{.UDIV,           {.Z_REG_D, .P_REG_MERGE, .Z_REG_D, .Z_REG_D}, {.VD, .PG, .VD, .VN},   0x04D50000, 0xFFFFE000, .SVE,  {is_64=true}},                                {written={0}, read={1, 2, 3}}},
	},
	.SDIV = {
		...
		{{.SDIV,           {.Z_REG_S, .P_REG_MERGE, .Z_REG_S, .Z_REG_S}, {.VD, .PG, .VD, .VN},   0x04940000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}}},
		{{.SDIV,           {.Z_REG_D, .P_REG_MERGE, .Z_REG_D, .Z_REG_D}, {.VD, .PG, .VD, .VN},   0x04D40000, 0xFFFFE000, .SVE,  {is_64=true}},                                {written={0}, read={1, 2, 3}}},
	},
	.MADD = {
	...
	.SMULH = {
		...
		{{.SMULH,          {.Z_REG_B, .P_REG_MERGE, .Z_REG_B, .Z_REG_B}, {.VD, .PG, .VD, .VN},   0x04120000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}}},
		{{.SMULH,          {.Z_REG_H, .P_REG_MERGE, .Z_REG_H, .Z_REG_H}, {.VD, .PG, .VD, .VN},   0x04520000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}}},
		{{.SMULH,          {.Z_REG_S, .P_REG_MERGE, .Z_REG_S, .Z_REG_S}, {.VD, .PG, .VD, .VN},   0x04920000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}}},
		{{.SMULH,          {.Z_REG_D, .P_REG_MERGE, .Z_REG_D, .Z_REG_D}, {.VD, .PG, .VD, .VN},   0x04D20000, 0xFFFFE000, .SVE,  {is_64=true}},                                {written={0}, read={1, 2, 3}}},
	},
	.UMULH = {
		{{.UMULH,          {.X_REG,   .X_REG,       .X_REG,   .NONE},    {.RD, .RN, .RM, .NONE}, 0x9BC07C00, 0xFFE0FC00, .BASE, {is_64=true}},                                {written={0}, read={1, 2}}},
		{{.UMULH,          {.Z_REG_B, .P_REG_MERGE, .Z_REG_B, .Z_REG_B}, {.VD, .PG, .VD, .VN},   0x04130000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}}},
		{{.UMULH,          {.Z_REG_H, .P_REG_MERGE, .Z_REG_H, .Z_REG_H}, {.VD, .PG, .VD, .VN},   0x04530000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}}},
		{{.UMULH,          {.Z_REG_S, .P_REG_MERGE, .Z_REG_S, .Z_REG_S}, {.VD, .PG, .VD, .VN},   0x04930000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}}},
		{{.UMULH,          {.Z_REG_D, .P_REG_MERGE, .Z_REG_D, .Z_REG_D}, {.VD, .PG, .VD, .VN},   0x04D30000, 0xFFFFE000, .SVE,  {is_64=true}},                                {written={0}, read={1, 2, 3}}},
	},
	.CLZ = {
		...
		{{.CLZ,            {.Z_REG_B, .P_REG_MERGE, .Z_REG_B, .NONE}, {.VD, .PG, .VN,   .NONE}, 0x0419A000, 0xFFF9E000, .SVE,  {}},                                           {written={0}, read={1, 2}}},
		{{.CLZ,            {.Z_REG_H, .P_REG_MERGE, .Z_REG_H, .NONE}, {.VD, .PG, .VN,   .NONE}, 0x0459A000, 0xFFF9E000, .SVE,  {}},                                           {written={0}, read={1, 2}}},
		{{.CLZ,            {.Z_REG_S, .P_REG_MERGE, .Z_REG_S, .NONE}, {.VD, .PG, .VN,   .NONE}, 0x0499A000, 0xFFF9E000, .SVE,  {}},                                           {written={0}, read={1, 2}}},
		{{.CLZ,            {.Z_REG_D, .P_REG_MERGE, .Z_REG_D, .NONE}, {.VD, .PG, .VN,   .NONE}, 0x04D9A000, 0xFFF9E000, .SVE,  {is_64=true}},                                 {written={0}, read={1, 2}}},
	},
	.CLS = {
		...
		{{.CLS,            {.Z_REG_B, .P_REG_MERGE, .Z_REG_B, .NONE}, {.VD, .PG, .VN,   .NONE}, 0x0418A000, 0xFFF8E000, .SVE,  {}},                                           {written={0}, read={1, 2}}},
		{{.CLS,            {.Z_REG_H, .P_REG_MERGE, .Z_REG_H, .NONE}, {.VD, .PG, .VN,   .NONE}, 0x0458A000, 0xFFF8E000, .SVE,  {}},                                           {written={0}, read={1, 2}}},
		{{.CLS,            {.Z_REG_S, .P_REG_MERGE, .Z_REG_S, .NONE}, {.VD, .PG, .VN,   .NONE}, 0x0498A000, 0xFFF8E000, .SVE,  {}},                                           {written={0}, read={1, 2}}},
		{{.CLS,            {.Z_REG_D, .P_REG_MERGE, .Z_REG_D, .NONE}, {.VD, .PG, .VN,   .NONE}, 0x04D8A000, 0xFFF8E000, .SVE,  {is_64=true}},                                 {written={0}, read={1, 2}}},
	},
	.RBIT = {
	...
	.REV = {
		...
		{{.REV,            {.P_REG_B,   .P_REG_B,   .NONE, .NONE}, {.PD, .PN, .NONE, .NONE}, 0x05344000, 0xFFFFFE10, .SVE,  {}},                                                  {written={0}, read={1}}},
	},
	.REV16 = {
	...
	.CSET = {
		{{.CSET,          {.W_REG, .COND_NOT_AL, .NONE, .NONE}, {.RD, .COND_HI_INV, .NONE, .NONE}, 0x1A9F07E0, 0xFFFF8FE0, .BASE, {}}, {written={0}, nzcv_rd={.N, .Z, .C, .V}}},
		{{.CSET,          {.W_REG, .COND_NOT_AL, .NONE, .NONE}, {.RD, .COND_HI_INV, .NONE, .NONE}, 0x1A9F87E0, 0xFFFFCFE0, .BASE, {}}, {written={0}, nzcv_rd={.N, .Z, .C, .V}}},
		{{.CSET,          {.W_REG, .COND_NOT_AL, .NONE, .NONE}, {.RD, .COND_HI_INV, .NONE, .NONE}, 0x1A9FC7E0, 0xFFFFEFE0, .BASE, {}}, {written={0}, nzcv_rd={.N, .Z, .C, .V}}},
		{{.CSET,          {.X_REG, .COND_NOT_AL, .NONE, .NONE}, {.RD, .COND_HI_INV, .NONE, .NONE}, 0x9A9F07E0, 0xFFFF8FE0, .BASE, {is_64=true}}, {written={0}, nzcv_rd={.N, .Z, .C, .V}}},
		{{.CSET,          {.X_REG, .COND_NOT_AL, .NONE, .NONE}, {.RD, .COND_HI_INV, .NONE, .NONE}, 0x9A9F87E0, 0xFFFFCFE0, .BASE, {is_64=true}}, {written={0}, nzcv_rd={.N, .Z, .C, .V}}},
		{{.CSET,          {.X_REG, .COND_NOT_AL, .NONE, .NONE}, {.RD, .COND_HI_INV, .NONE, .NONE}, 0x9A9FC7E0, 0xFFFFEFE0, .BASE, {is_64=true}}, {written={0}, nzcv_rd={.N, .Z, .C, .V}}},
	},
	.CSETM = {
		{{.CSETM,         {.W_REG, .COND_NOT_AL, .NONE, .NONE}, {.RD, .COND_HI_INV, .NONE, .NONE}, 0x5A9F03E0, 0xFFFF8FE0, .BASE, {}}, {written={0}, nzcv_rd={.N, .Z, .C, .V}}},
		{{.CSETM,         {.W_REG, .COND_NOT_AL, .NONE, .NONE}, {.RD, .COND_HI_INV, .NONE, .NONE}, 0x5A9F83E0, 0xFFFFCFE0, .BASE, {}}, {written={0}, nzcv_rd={.N, .Z, .C, .V}}},
		{{.CSETM,         {.W_REG, .COND_NOT_AL, .NONE, .NONE}, {.RD, .COND_HI_INV, .NONE, .NONE}, 0x5A9FC3E0, 0xFFFFEFE0, .BASE, {}}, {written={0}, nzcv_rd={.N, .Z, .C, .V}}},
		{{.CSETM,         {.X_REG, .COND_NOT_AL, .NONE, .NONE}, {.RD, .COND_HI_INV, .NONE, .NONE}, 0xDA9F03E0, 0xFFFF8FE0, .BASE, {is_64=true}}, {written={0}, nzcv_rd={.N, .Z, .C, .V}}},
		{{.CSETM,         {.X_REG, .COND_NOT_AL, .NONE, .NONE}, {.RD, .COND_HI_INV, .NONE, .NONE}, 0xDA9F83E0, 0xFFFFCFE0, .BASE, {is_64=true}}, {written={0}, nzcv_rd={.N, .Z, .C, .V}}},
		{{.CSETM,         {.X_REG, .COND_NOT_AL, .NONE, .NONE}, {.RD, .COND_HI_INV, .NONE, .NONE}, 0xDA9FC3E0, 0xFFFFEFE0, .BASE, {is_64=true}}, {written={0}, nzcv_rd={.N, .Z, .C, .V}}},
	},
	.CINC = {
		{{.CINC,          {.W_REG, .W_REG, .COND_NOT_AL, .NONE}, {.RD, .RN_RM, .COND_HI_INV, .NONE}, 0x1A800400, 0xFFE08C00, .BASE, {}}, {written={0}, read={1}, nzcv_rd={.N, .Z, .C, .V}}},
		{{.CINC,          {.W_REG, .W_REG, .COND_NOT_AL, .NONE}, {.RD, .RN_RM, .COND_HI_INV, .NONE}, 0x1A808400, 0xFFE0CC00, .BASE, {}}, {written={0}, read={1}, nzcv_rd={.N, .Z, .C, .V}}},
		{{.CINC,          {.W_REG, .W_REG, .COND_NOT_AL, .NONE}, {.RD, .RN_RM, .COND_HI_INV, .NONE}, 0x1A80C400, 0xFFE0EC00, .BASE, {}}, {written={0}, read={1}, nzcv_rd={.N, .Z, .C, .V}}},
		{{.CINC,          {.X_REG, .X_REG, .COND_NOT_AL, .NONE}, {.RD, .RN_RM, .COND_HI_INV, .NONE}, 0x9A800400, 0xFFE08C00, .BASE, {is_64=true}}, {written={0}, read={1}, nzcv_rd={.N, .Z, .C, .V}}},
		{{.CINC,          {.X_REG, .X_REG, .COND_NOT_AL, .NONE}, {.RD, .RN_RM, .COND_HI_INV, .NONE}, 0x9A808400, 0xFFE0CC00, .BASE, {is_64=true}}, {written={0}, read={1}, nzcv_rd={.N, .Z, .C, .V}}},
		{{.CINC,          {.X_REG, .X_REG, .COND_NOT_AL, .NONE}, {.RD, .RN_RM, .COND_HI_INV, .NONE}, 0x9A80C400, 0xFFE0EC00, .BASE, {is_64=true}}, {written={0}, read={1}, nzcv_rd={.N, .Z, .C, .V}}},
	},
	.CINV = {
		{{.CINV,          {.W_REG, .W_REG, .COND_NOT_AL, .NONE}, {.RD, .RN_RM, .COND_HI_INV, .NONE}, 0x5A800000, 0xFFE08C00, .BASE, {}}, {written={0}, read={1}, nzcv_rd={.N, .Z, .C, .V}}},
		{{.CINV,          {.W_REG, .W_REG, .COND_NOT_AL, .NONE}, {.RD, .RN_RM, .COND_HI_INV, .NONE}, 0x5A808000, 0xFFE0CC00, .BASE, {}}, {written={0}, read={1}, nzcv_rd={.N, .Z, .C, .V}}},
		{{.CINV,          {.W_REG, .W_REG, .COND_NOT_AL, .NONE}, {.RD, .RN_RM, .COND_HI_INV, .NONE}, 0x5A80C000, 0xFFE0EC00, .BASE, {}}, {written={0}, read={1}, nzcv_rd={.N, .Z, .C, .V}}},
		{{.CINV,          {.X_REG, .X_REG, .COND_NOT_AL, .NONE}, {.RD, .RN_RM, .COND_HI_INV, .NONE}, 0xDA800000, 0xFFE08C00, .BASE, {is_64=true}}, {written={0}, read={1}, nzcv_rd={.N, .Z, .C, .V}}},
		{{.CINV,          {.X_REG, .X_REG, .COND_NOT_AL, .NONE}, {.RD, .RN_RM, .COND_HI_INV, .NONE}, 0xDA808000, 0xFFE0CC00, .BASE, {is_64=true}}, {written={0}, read={1}, nzcv_rd={.N, .Z, .C, .V}}},
		{{.CINV,          {.X_REG, .X_REG, .COND_NOT_AL, .NONE}, {.RD, .RN_RM, .COND_HI_INV, .NONE}, 0xDA80C000, 0xFFE0EC00, .BASE, {is_64=true}}, {written={0}, read={1}, nzcv_rd={.N, .Z, .C, .V}}},
	},
	.CNEG = {
		{{.CNEG,          {.W_REG, .W_REG, .COND_NOT_AL, .NONE}, {.RD, .RN_RM, .COND_HI_INV, .NONE}, 0x5A800400, 0xFFE08C00, .BASE, {}}, {written={0}, read={1}, nzcv_rd={.N, .Z, .C, .V}}},
		{{.CNEG,          {.W_REG, .W_REG, .COND_NOT_AL, .NONE}, {.RD, .RN_RM, .COND_HI_INV, .NONE}, 0x5A808400, 0xFFE0CC00, .BASE, {}}, {written={0}, read={1}, nzcv_rd={.N, .Z, .C, .V}}},
		{{.CNEG,          {.W_REG, .W_REG, .COND_NOT_AL, .NONE}, {.RD, .RN_RM, .COND_HI_INV, .NONE}, 0x5A80C400, 0xFFE0EC00, .BASE, {}}, {written={0}, read={1}, nzcv_rd={.N, .Z, .C, .V}}},
		{{.CNEG,          {.X_REG, .X_REG, .COND_NOT_AL, .NONE}, {.RD, .RN_RM, .COND_HI_INV, .NONE}, 0xDA800400, 0xFFE08C00, .BASE, {is_64=true}}, {written={0}, read={1}, nzcv_rd={.N, .Z, .C, .V}}},
		{{.CNEG,          {.X_REG, .X_REG, .COND_NOT_AL, .NONE}, {.RD, .RN_RM, .COND_HI_INV, .NONE}, 0xDA808400, 0xFFE0CC00, .BASE, {is_64=true}}, {written={0}, read={1}, nzcv_rd={.N, .Z, .C, .V}}},
		{{.CNEG,          {.X_REG, .X_REG, .COND_NOT_AL, .NONE}, {.RD, .RN_RM, .COND_HI_INV, .NONE}, 0xDA80C400, 0xFFE0EC00, .BASE, {is_64=true}}, {written={0}, read={1}, nzcv_rd={.N, .Z, .C, .V}}},
	},
	.CSINC = {
	...
	.LDR = {
		...
		{{.LDR,            {.Z_REG_ANY, .MEM_SVE_SI, .NONE, .NONE}, {.VD,       .SVE_OFFSET_BASE_SI, .NONE, .NONE}, 0x85804000, 0xFFE0E000, .SVE,  {}},                         {written={0}, read={1}, reads_mem=true}},
	...
	.STR = {
		...
		{{.STR,            {.Z_REG_ANY, .MEM_SVE_SI, .NONE, .NONE}, {.VD,       .SVE_OFFSET_BASE_SI, .NONE, .NONE}, 0xE5804000, 0xFFE0E000, .SVE,  {}},                         {read={0, 1}, writes_mem=true}},
	...
	.LDXR = {
		{{.LDXR,           {.W_REG, .MEM_OFFSET, .NONE, .NONE}, {.RT, .OFFSET_BASE_A, .NONE, .NONE}, 0x885F7C00, 0xFFFFFC00, .BASE, {}},                                      {written={0}, read={1}, reads_mem=true, side_effects={.ATOMIC, .RESERVATION}}},
		{{.LDXR,           {.X_REG, .MEM_OFFSET, .NONE, .NONE}, {.RT, .OFFSET_BASE_A, .NONE, .NONE}, 0xC85F7C00, 0xFFFFFC00, .BASE, {is_64=true}},                            {written={0}, read={1}, reads_mem=true, side_effects={.ATOMIC, .RESERVATION}}},
	},
	.STXR = {
	...
	.LDAXR = {
		{{.LDAXR,          {.W_REG, .MEM_OFFSET, .NONE, .NONE}, {.RT, .OFFSET_BASE_A, .NONE, .NONE}, 0x885FFC00, 0xFFFFFC00, .BASE, {}},                                      {written={0}, read={1}, reads_mem=true, side_effects={.FENCE, .ATOMIC, .RESERVATION}}},
		{{.LDAXR,          {.X_REG, .MEM_OFFSET, .NONE, .NONE}, {.RT, .OFFSET_BASE_A, .NONE, .NONE}, 0xC85FFC00, 0xFFFFFC00, .BASE, {is_64=true}},                            {written={0}, read={1}, reads_mem=true, side_effects={.FENCE, .ATOMIC, .RESERVATION}}},
	},
	.STLXR = {
	...
	.FABS = {
		...
		{{.FABS,           {.Z_REG_H,   .P_REG_MERGE, .Z_REG_H, .NONE}, {.VD, .PG, .VN,   .NONE}, 0x045CA000, 0xFFFCE000, .SVE,  {}},                                         {written={0}, read={1, 2}}},
		{{.FABS,           {.Z_REG_S,   .P_REG_MERGE, .Z_REG_S, .NONE}, {.VD, .PG, .VN,   .NONE}, 0x049CA000, 0xFFFCE000, .SVE,  {}},                                         {written={0}, read={1, 2}}},
		{{.FABS,           {.Z_REG_D,   .P_REG_MERGE, .Z_REG_D, .NONE}, {.VD, .PG, .VN,   .NONE}, 0x04DCA000, 0xFFFCE000, .SVE,  {is_64=true}},                               {written={0}, read={1, 2}}},
	},
	.FNEG = {
		...
		{{.FNEG,           {.Z_REG_H,   .P_REG_MERGE, .Z_REG_H, .NONE}, {.VD, .PG, .VN,   .NONE}, 0x045DA000, 0xFFFDE000, .SVE,  {}},                                         {written={0}, read={1, 2}}},
		{{.FNEG,           {.Z_REG_S,   .P_REG_MERGE, .Z_REG_S, .NONE}, {.VD, .PG, .VN,   .NONE}, 0x049DA000, 0xFFFDE000, .SVE,  {}},                                         {written={0}, read={1, 2}}},
		{{.FNEG,           {.Z_REG_D,   .P_REG_MERGE, .Z_REG_D, .NONE}, {.VD, .PG, .VN,   .NONE}, 0x04DDA000, 0xFFFDE000, .SVE,  {is_64=true}},                               {written={0}, read={1, 2}}},
	},
	.FSQRT = {
		...
		{{.FSQRT,          {.Z_REG_H,   .P_REG_MERGE, .Z_REG_H, .NONE}, {.VD, .PG, .VN,   .NONE}, 0x654DA000, 0xFFEDE000, .SVE,  {}},                                         {written={0}, read={1, 2}, fpsr_wr={.IOC, .IXC, .IDC}, reads_fpcr=true}},
		{{.FSQRT,          {.Z_REG_S,   .P_REG_MERGE, .Z_REG_S, .NONE}, {.VD, .PG, .VN,   .NONE}, 0x658DA000, 0xFFEDE000, .SVE,  {}},                                         {written={0}, read={1, 2}, fpsr_wr={.IOC, .IXC, .IDC}, reads_fpcr=true}},
		{{.FSQRT,          {.Z_REG_D,   .P_REG_MERGE, .Z_REG_D, .NONE}, {.VD, .PG, .VN,   .NONE}, 0x65CDA000, 0xFFEDE000, .SVE,  {is_64=true}},                               {written={0}, read={1, 2}, fpsr_wr={.IOC, .IXC, .IDC}, reads_fpcr=true}},
	},
	.FADD = {
		...
		{{.FADD,           {.Z_REG_H, .P_REG_MERGE, .Z_REG_H, .Z_REG_H}, {.VD, .PG, .VD, .VN},   0x65408000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}, fpsr_wr={.IOC, .OFC, .UFC, .IXC, .IDC}, reads_fpcr=true}},
		{{.FADD,           {.Z_REG_S, .P_REG_MERGE, .Z_REG_S, .Z_REG_S}, {.VD, .PG, .VD, .VN},   0x65808000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}, fpsr_wr={.IOC, .OFC, .UFC, .IXC, .IDC}, reads_fpcr=true}},
		{{.FADD,           {.Z_REG_D, .P_REG_MERGE, .Z_REG_D, .Z_REG_D}, {.VD, .PG, .VD, .VN},   0x65C08000, 0xFFFFE000, .SVE,  {is_64=true}},                                {written={0}, read={1, 2, 3}, fpsr_wr={.IOC, .OFC, .UFC, .IXC, .IDC}, reads_fpcr=true}},
	},
	.FSUB = {
		...
		{{.FSUB,           {.Z_REG_H, .P_REG_MERGE, .Z_REG_H, .Z_REG_H}, {.VD, .PG, .VD, .VN},   0x65418000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}, fpsr_wr={.IOC, .OFC, .UFC, .IXC, .IDC}, reads_fpcr=true}},
		{{.FSUB,           {.Z_REG_S, .P_REG_MERGE, .Z_REG_S, .Z_REG_S}, {.VD, .PG, .VD, .VN},   0x65818000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}, fpsr_wr={.IOC, .OFC, .UFC, .IXC, .IDC}, reads_fpcr=true}},
		{{.FSUB,           {.Z_REG_D, .P_REG_MERGE, .Z_REG_D, .Z_REG_D}, {.VD, .PG, .VD, .VN},   0x65C18000, 0xFFFFE000, .SVE,  {is_64=true}},                                {written={0}, read={1, 2, 3}, fpsr_wr={.IOC, .OFC, .UFC, .IXC, .IDC}, reads_fpcr=true}},
	},
	.FMUL = {
		...
		{{.FMUL,           {.Z_REG_H, .P_REG_MERGE, .Z_REG_H, .Z_REG_H}, {.VD, .PG, .VD, .VN},   0x65428000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}, fpsr_wr={.IOC, .OFC, .UFC, .IXC, .IDC}, reads_fpcr=true}},
		{{.FMUL,           {.Z_REG_S, .P_REG_MERGE, .Z_REG_S, .Z_REG_S}, {.VD, .PG, .VD, .VN},   0x65828000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}, fpsr_wr={.IOC, .OFC, .UFC, .IXC, .IDC}, reads_fpcr=true}},
		{{.FMUL,           {.Z_REG_D, .P_REG_MERGE, .Z_REG_D, .Z_REG_D}, {.VD, .PG, .VD, .VN},   0x65C28000, 0xFFFFE000, .SVE,  {is_64=true}},                                {written={0}, read={1, 2, 3}, fpsr_wr={.IOC, .OFC, .UFC, .IXC, .IDC}, reads_fpcr=true}},
	},
	.FDIV = {
		...
		{{.FDIV,           {.Z_REG_H, .P_REG_MERGE, .Z_REG_H, .Z_REG_H}, {.VD, .PG, .VD, .VN},   0x654D8000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}, fpsr_wr={.IOC, .DZC, .OFC, .UFC, .IXC, .IDC}, reads_fpcr=true}},
		{{.FDIV,           {.Z_REG_S, .P_REG_MERGE, .Z_REG_S, .Z_REG_S}, {.VD, .PG, .VD, .VN},   0x658D8000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}, fpsr_wr={.IOC, .DZC, .OFC, .UFC, .IXC, .IDC}, reads_fpcr=true}},
		{{.FDIV,           {.Z_REG_D, .P_REG_MERGE, .Z_REG_D, .Z_REG_D}, {.VD, .PG, .VD, .VN},   0x65CD8000, 0xFFFFE000, .SVE,  {is_64=true}},                                {written={0}, read={1, 2, 3}, fpsr_wr={.IOC, .DZC, .OFC, .UFC, .IXC, .IDC}, reads_fpcr=true}},
	},
	.FNMUL = {
	...
	.FMAX = {
		...
		{{.FMAX,           {.Z_REG_H,   .P_REG_MERGE, .Z_REG_H,   .Z_REG_H}, {.VD, .PG, .VD, .VN},   0x65468000, 0xFFFFE000, .SVE,  {}},                                      {written={0}, read={1, 2, 3}, fpsr_wr={.IOC, .IDC}, reads_fpcr=true}},
		{{.FMAX,           {.Z_REG_S,   .P_REG_MERGE, .Z_REG_S,   .Z_REG_S}, {.VD, .PG, .VD, .VN},   0x65868000, 0xFFFFE000, .SVE,  {}},                                      {written={0}, read={1, 2, 3}, fpsr_wr={.IOC, .IDC}, reads_fpcr=true}},
		{{.FMAX,           {.Z_REG_D,   .P_REG_MERGE, .Z_REG_D,   .Z_REG_D}, {.VD, .PG, .VD, .VN},   0x65C68000, 0xFFFFE000, .SVE,  {is_64=true}},                            {written={0}, read={1, 2, 3}, fpsr_wr={.IOC, .IDC}, reads_fpcr=true}},
	},
	.FMIN = {
		...
		{{.FMIN,           {.Z_REG_H,   .P_REG_MERGE, .Z_REG_H,   .Z_REG_H}, {.VD, .PG, .VD, .VN},   0x65478000, 0xFFFFE000, .SVE,  {}},                                      {written={0}, read={1, 2, 3}, fpsr_wr={.IOC, .IDC}, reads_fpcr=true}},
		{{.FMIN,           {.Z_REG_S,   .P_REG_MERGE, .Z_REG_S,   .Z_REG_S}, {.VD, .PG, .VD, .VN},   0x65878000, 0xFFFFE000, .SVE,  {}},                                      {written={0}, read={1, 2, 3}, fpsr_wr={.IOC, .IDC}, reads_fpcr=true}},
		{{.FMIN,           {.Z_REG_D,   .P_REG_MERGE, .Z_REG_D,   .Z_REG_D}, {.VD, .PG, .VD, .VN},   0x65C78000, 0xFFFFE000, .SVE,  {is_64=true}},                            {written={0}, read={1, 2, 3}, fpsr_wr={.IOC, .IDC}, reads_fpcr=true}},
	},
	.FMAXNM = {
		...
		{{.FMAXNM,         {.Z_REG_H,   .P_REG_MERGE, .Z_REG_H,   .Z_REG_H}, {.VD, .PG, .VD, .VN},   0x65448000, 0xFFFFE000, .SVE,  {}},                                      {written={0}, read={1, 2, 3}, fpsr_wr={.IOC, .IDC}, reads_fpcr=true}},
		{{.FMAXNM,         {.Z_REG_S,   .P_REG_MERGE, .Z_REG_S,   .Z_REG_S}, {.VD, .PG, .VD, .VN},   0x65848000, 0xFFFFE000, .SVE,  {}},                                      {written={0}, read={1, 2, 3}, fpsr_wr={.IOC, .IDC}, reads_fpcr=true}},
		{{.FMAXNM,         {.Z_REG_D,   .P_REG_MERGE, .Z_REG_D,   .Z_REG_D}, {.VD, .PG, .VD, .VN},   0x65C48000, 0xFFFFE000, .SVE,  {is_64=true}},                            {written={0}, read={1, 2, 3}, fpsr_wr={.IOC, .IDC}, reads_fpcr=true}},
	},
	.FMINNM = {
		...
		{{.FMINNM,         {.Z_REG_H,   .P_REG_MERGE, .Z_REG_H,   .Z_REG_H}, {.VD, .PG, .VD, .VN},   0x65458000, 0xFFFFE000, .SVE,  {}},                                      {written={0}, read={1, 2, 3}, fpsr_wr={.IOC, .IDC}, reads_fpcr=true}},
		{{.FMINNM,         {.Z_REG_S,   .P_REG_MERGE, .Z_REG_S,   .Z_REG_S}, {.VD, .PG, .VD, .VN},   0x65858000, 0xFFFFE000, .SVE,  {}},                                      {written={0}, read={1, 2, 3}, fpsr_wr={.IOC, .IDC}, reads_fpcr=true}},
		{{.FMINNM,         {.Z_REG_D,   .P_REG_MERGE, .Z_REG_D,   .Z_REG_D}, {.VD, .PG, .VD, .VN},   0x65C58000, 0xFFFFE000, .SVE,  {is_64=true}},                            {written={0}, read={1, 2, 3}, fpsr_wr={.IOC, .IDC}, reads_fpcr=true}},
	},
	.FCVT = {
	...
	.LDXRB = {
		{{.LDXRB,          {.W_REG, .MEM_OFFSET, .NONE, .NONE}, {.RT, .OFFSET_BASE_A, .NONE, .NONE}, 0x085F7C00, 0xFFFFFC00, .BASE, {}},                                      {written={0}, read={1}, reads_mem=true, side_effects={.ATOMIC, .RESERVATION}}},
	},
	.STXRB = {
	...
	.LDAXRB = {
		{{.LDAXRB,         {.W_REG, .MEM_OFFSET, .NONE, .NONE}, {.RT, .OFFSET_BASE_A, .NONE, .NONE}, 0x085FFC00, 0xFFFFFC00, .BASE, {}},                                      {written={0}, read={1}, reads_mem=true, side_effects={.FENCE, .ATOMIC, .RESERVATION}}},
	},
	.STLXRB = {
	...
	.LDXRH = {
		{{.LDXRH,          {.W_REG, .MEM_OFFSET, .NONE, .NONE}, {.RT, .OFFSET_BASE_A, .NONE, .NONE}, 0x485F7C00, 0xFFFFFC00, .BASE, {}},                                      {written={0}, read={1}, reads_mem=true, side_effects={.ATOMIC, .RESERVATION}}},
	},
	.STXRH = {
	...
	.LDAXRH = {
		{{.LDAXRH,         {.W_REG, .MEM_OFFSET, .NONE, .NONE}, {.RT, .OFFSET_BASE_A, .NONE, .NONE}, 0x485FFC00, 0xFFFFFC00, .BASE, {}},                                      {written={0}, read={1}, reads_mem=true, side_effects={.FENCE, .ATOMIC, .RESERVATION}}},
	},
	.STLXRH = {
	...
	.BTI = {
		{{.BTI,            {.NONE, .NONE, .NONE, .NONE}, {.NONE, .NONE, .NONE, .NONE}, 0xD503241F, 0xFFFFFFFF, .BTI, {}},                                              {side_effects={.BTI}}},
	},
	.IRG = {
	...
	.XAR = {
		...
		{{.XAR,            {.Z_REG_ANY, .Z_REG_ANY, .Z_REG_ANY, .VEC_SHIFT}, {.VD_TSZ, .VD_TSZ, .VN_TSZ, .SVE_XAR_SHIFT}, 0x04203400, 0xFF20FC00, .SVE2,   {}},                                 {written={0}, read={1, 2}}},
	},
	.SM3PARTW1 = {
	...
	.SM3TT1A = {
		{{.SM3TT1A,        {.V_4S, .V_4S, .V_ELEM_S, .VEC_INDEX}, {.VD, .VN, .VM, .NEON_IDX2}, 0xCE408000, 0xFFE0CC00, .CRYPTO, {}},                                                    {written={0}, read={0, 1, 2}}},
	},
	.SM3TT1B = {
		{{.SM3TT1B,        {.V_4S, .V_4S, .V_ELEM_S, .VEC_INDEX}, {.VD, .VN, .VM, .NEON_IDX2}, 0xCE408400, 0xFFE0CC00, .CRYPTO, {}},                                                    {written={0}, read={0, 1, 2}}},
	},
	.SM3TT2A = {
		{{.SM3TT2A,        {.V_4S, .V_4S, .V_ELEM_S, .VEC_INDEX}, {.VD, .VN, .VM, .NEON_IDX2}, 0xCE408800, 0xFFE0CC00, .CRYPTO, {}},                                                    {written={0}, read={0, 1, 2}}},
	},
	.SM3TT2B = {
		{{.SM3TT2B,        {.V_4S, .V_4S, .V_ELEM_S, .VEC_INDEX}, {.VD, .VN, .VM, .NEON_IDX2}, 0xCE408C00, 0xFFE0CC00, .CRYPTO, {}},                                                    {written={0}, read={0, 1, 2}}},
	},
	.SM4E = {
	...
	.PMULL = {
		...
		{{.PMULL,          {.V_1Q, .V_1D, .V_1D, .NONE}, {.VD, .VN, .VM, .NONE}, 0x0EE0E000, 0xFFE0FC00, .CRYPTO, {}},                                                        {written={0}, read={1, 2}}},
	},
	.PMULL2 = {
		{{.PMULL2,         {.V_8H, .V_16B, .V_16B, .NONE}, {.VD, .VN, .VM, .NONE}, 0x4E20E000, 0xFFE0FC00, .CRYPTO, {}},                                                      {written={0}, read={1, 2}}},
		{{.PMULL2,         {.V_1Q, .V_2D,  .V_2D,  .NONE}, {.VD, .VN, .VM, .NONE}, 0x4EE0E000, 0xFFE0FC00, .CRYPTO, {}},                                                      {written={0}, read={1, 2}}},
	},
	.BFCVT = {
	...
	.MUL = {
		...
		{{.MUL,            {.Z_REG_B, .P_REG_MERGE, .Z_REG_B, .Z_REG_B}, {.VD, .PG, .VD, .VN},   0x04100000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}}},
		{{.MUL,            {.Z_REG_H, .P_REG_MERGE, .Z_REG_H, .Z_REG_H}, {.VD, .PG, .VD, .VN},   0x04500000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}}},
		{{.MUL,            {.Z_REG_S, .P_REG_MERGE, .Z_REG_S, .Z_REG_S}, {.VD, .PG, .VD, .VN},   0x04900000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}}},
		{{.MUL,            {.Z_REG_D, .P_REG_MERGE, .Z_REG_D, .Z_REG_D}, {.VD, .PG, .VD, .VN},   0x04D00000, 0xFFFFE000, .SVE,  {is_64=true}},                                {written={0}, read={1, 2, 3}}},
	},
	.MLA = {
	...
	.NEG = {
		...
		{{.NEG,            {.Z_REG_B, .P_REG_MERGE, .Z_REG_B, .NONE}, {.VD, .PG, .VN,   .NONE}, 0x0417A000, 0xFFF7E000, .SVE,  {}},                                           {written={0}, read={1, 2}}},
		{{.NEG,            {.Z_REG_H, .P_REG_MERGE, .Z_REG_H, .NONE}, {.VD, .PG, .VN,   .NONE}, 0x0457A000, 0xFFF7E000, .SVE,  {}},                                           {written={0}, read={1, 2}}},
		{{.NEG,            {.Z_REG_S, .P_REG_MERGE, .Z_REG_S, .NONE}, {.VD, .PG, .VN,   .NONE}, 0x0497A000, 0xFFF7E000, .SVE,  {}},                                           {written={0}, read={1, 2}}},
		{{.NEG,            {.Z_REG_D, .P_REG_MERGE, .Z_REG_D, .NONE}, {.VD, .PG, .VN,   .NONE}, 0x04D7A000, 0xFFF7E000, .SVE,  {is_64=true}},                                 {written={0}, read={1, 2}}},
	...
	.ABS = {
		...
		{{.ABS,            {.Z_REG_B, .P_REG_MERGE, .Z_REG_B, .NONE}, {.VD, .PG, .VN,   .NONE}, 0x0416A000, 0xFFF6E000, .SVE,  {}},                                           {written={0}, read={1, 2}}},
		{{.ABS,            {.Z_REG_H, .P_REG_MERGE, .Z_REG_H, .NONE}, {.VD, .PG, .VN,   .NONE}, 0x0456A000, 0xFFF6E000, .SVE,  {}},                                           {written={0}, read={1, 2}}},
		{{.ABS,            {.Z_REG_S, .P_REG_MERGE, .Z_REG_S, .NONE}, {.VD, .PG, .VN,   .NONE}, 0x0496A000, 0xFFF6E000, .SVE,  {}},                                           {written={0}, read={1, 2}}},
		{{.ABS,            {.Z_REG_D, .P_REG_MERGE, .Z_REG_D, .NONE}, {.VD, .PG, .VN,   .NONE}, 0x04D6A000, 0xFFF6E000, .SVE,  {is_64=true}},                                 {written={0}, read={1, 2}}},
	},
	.SHADD = {
	...
	.SMAX = {
		...
		{{.SMAX,           {.Z_REG_B, .P_REG_MERGE, .Z_REG_B, .Z_REG_B}, {.VD, .PG, .VD, .VN},   0x04080000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}}},
		{{.SMAX,           {.Z_REG_H, .P_REG_MERGE, .Z_REG_H, .Z_REG_H}, {.VD, .PG, .VD, .VN},   0x04480000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}}},
		{{.SMAX,           {.Z_REG_S, .P_REG_MERGE, .Z_REG_S, .Z_REG_S}, {.VD, .PG, .VD, .VN},   0x04880000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}}},
		{{.SMAX,           {.Z_REG_D, .P_REG_MERGE, .Z_REG_D, .Z_REG_D}, {.VD, .PG, .VD, .VN},   0x04C80000, 0xFFFFE000, .SVE,  {is_64=true}},                                {written={0}, read={1, 2, 3}}},
	},
	.UMAX = {
		...
		{{.UMAX,           {.Z_REG_B, .P_REG_MERGE, .Z_REG_B, .Z_REG_B}, {.VD, .PG, .VD, .VN},   0x04090000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}}},
		{{.UMAX,           {.Z_REG_H, .P_REG_MERGE, .Z_REG_H, .Z_REG_H}, {.VD, .PG, .VD, .VN},   0x04490000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}}},
		{{.UMAX,           {.Z_REG_S, .P_REG_MERGE, .Z_REG_S, .Z_REG_S}, {.VD, .PG, .VD, .VN},   0x04890000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}}},
		{{.UMAX,           {.Z_REG_D, .P_REG_MERGE, .Z_REG_D, .Z_REG_D}, {.VD, .PG, .VD, .VN},   0x04C90000, 0xFFFFE000, .SVE,  {is_64=true}},                                {written={0}, read={1, 2, 3}}},
	},
	.SMIN = {
		...
		{{.SMIN,           {.Z_REG_B, .P_REG_MERGE, .Z_REG_B, .Z_REG_B}, {.VD, .PG, .VD, .VN},   0x040A0000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}}},
		{{.SMIN,           {.Z_REG_H, .P_REG_MERGE, .Z_REG_H, .Z_REG_H}, {.VD, .PG, .VD, .VN},   0x044A0000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}}},
		{{.SMIN,           {.Z_REG_S, .P_REG_MERGE, .Z_REG_S, .Z_REG_S}, {.VD, .PG, .VD, .VN},   0x048A0000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}}},
		{{.SMIN,           {.Z_REG_D, .P_REG_MERGE, .Z_REG_D, .Z_REG_D}, {.VD, .PG, .VD, .VN},   0x04CA0000, 0xFFFFE000, .SVE,  {is_64=true}},                                {written={0}, read={1, 2, 3}}},
	},
	.UMIN = {
		...
		{{.UMIN,           {.Z_REG_B, .P_REG_MERGE, .Z_REG_B, .Z_REG_B}, {.VD, .PG, .VD, .VN},   0x040B0000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}}},
		{{.UMIN,           {.Z_REG_H, .P_REG_MERGE, .Z_REG_H, .Z_REG_H}, {.VD, .PG, .VD, .VN},   0x044B0000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}}},
		{{.UMIN,           {.Z_REG_S, .P_REG_MERGE, .Z_REG_S, .Z_REG_S}, {.VD, .PG, .VD, .VN},   0x048B0000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}}},
		{{.UMIN,           {.Z_REG_D, .P_REG_MERGE, .Z_REG_D, .Z_REG_D}, {.VD, .PG, .VD, .VN},   0x04CB0000, 0xFFFFE000, .SVE,  {is_64=true}},                                {written={0}, read={1, 2, 3}}},
	},
	.SABD = {
		...
		{{.SABD,           {.Z_REG_B, .P_REG_MERGE, .Z_REG_B, .Z_REG_B}, {.VD, .PG, .VD, .VN},   0x040C0000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}}},
		{{.SABD,           {.Z_REG_H, .P_REG_MERGE, .Z_REG_H, .Z_REG_H}, {.VD, .PG, .VD, .VN},   0x044C0000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}}},
		{{.SABD,           {.Z_REG_S, .P_REG_MERGE, .Z_REG_S, .Z_REG_S}, {.VD, .PG, .VD, .VN},   0x048C0000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}}},
		{{.SABD,           {.Z_REG_D, .P_REG_MERGE, .Z_REG_D, .Z_REG_D}, {.VD, .PG, .VD, .VN},   0x04CC0000, 0xFFFFE000, .SVE,  {is_64=true}},                                {written={0}, read={1, 2, 3}}},
	},
	.UABD = {
		...
		{{.UABD,           {.Z_REG_B, .P_REG_MERGE, .Z_REG_B, .Z_REG_B}, {.VD, .PG, .VD, .VN},   0x040D0000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}}},
		{{.UABD,           {.Z_REG_H, .P_REG_MERGE, .Z_REG_H, .Z_REG_H}, {.VD, .PG, .VD, .VN},   0x044D0000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}}},
		{{.UABD,           {.Z_REG_S, .P_REG_MERGE, .Z_REG_S, .Z_REG_S}, {.VD, .PG, .VD, .VN},   0x048D0000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}}},
		{{.UABD,           {.Z_REG_D, .P_REG_MERGE, .Z_REG_D, .Z_REG_D}, {.VD, .PG, .VD, .VN},   0x04CD0000, 0xFFFFE000, .SVE,  {is_64=true}},                                {written={0}, read={1, 2, 3}}},
	},
	.SABA = {
	...
	.FCMEQ = {
		...
		{{.FCMEQ,          {.P_REG_H,     .P_REG_ZERO, .Z_REG_H,   .Z_REG_H}, {.PD, .PG, .VN, .VM},   0x65406000, 0xFFE0E010, .SVE,  {}},                                       {written={0}, read={1, 2, 3}, fpsr_wr={.IOC}}},
		{{.FCMEQ,          {.P_REG_S,     .P_REG_ZERO, .Z_REG_S,   .Z_REG_S}, {.PD, .PG, .VN, .VM},   0x65806000, 0xFFE0E010, .SVE,  {}},                                       {written={0}, read={1, 2, 3}, fpsr_wr={.IOC}}},
		{{.FCMEQ,          {.P_REG_D,     .P_REG_ZERO, .Z_REG_D,   .Z_REG_D}, {.PD, .PG, .VN, .VM},   0x65C06000, 0xFFE0E010, .SVE,  {is_64=true}},                             {written={0}, read={1, 2, 3}, fpsr_wr={.IOC}}},
	},
	.FCMGE = {
		...
		{{.FCMGE,          {.P_REG_H,     .P_REG_ZERO, .Z_REG_H,   .Z_REG_H}, {.PD, .PG, .VN, .VM},   0x65404000, 0xFFE0E010, .SVE,  {}},                                       {written={0}, read={1, 2, 3}, fpsr_wr={.IOC}}},
		{{.FCMGE,          {.P_REG_S,     .P_REG_ZERO, .Z_REG_S,   .Z_REG_S}, {.PD, .PG, .VN, .VM},   0x65804000, 0xFFE0E010, .SVE,  {}},                                       {written={0}, read={1, 2, 3}, fpsr_wr={.IOC}}},
		{{.FCMGE,          {.P_REG_D,     .P_REG_ZERO, .Z_REG_D,   .Z_REG_D}, {.PD, .PG, .VN, .VM},   0x65C04000, 0xFFE0E010, .SVE,  {is_64=true}},                             {written={0}, read={1, 2, 3}, fpsr_wr={.IOC}}},
	},
	.FCMGT = {
		...
		{{.FCMGT,          {.P_REG_H,     .P_REG_ZERO, .Z_REG_H,   .Z_REG_H}, {.PD, .PG, .VN, .VM},   0x65404010, 0xFFE0E010, .SVE,  {}},                                       {written={0}, read={1, 2, 3}, fpsr_wr={.IOC}}},
		{{.FCMGT,          {.P_REG_S,     .P_REG_ZERO, .Z_REG_S,   .Z_REG_S}, {.PD, .PG, .VN, .VM},   0x65804010, 0xFFE0E010, .SVE,  {}},                                       {written={0}, read={1, 2, 3}, fpsr_wr={.IOC}}},
		{{.FCMGT,          {.P_REG_D,     .P_REG_ZERO, .Z_REG_D,   .Z_REG_D}, {.PD, .PG, .VN, .VM},   0x65C04010, 0xFFE0E010, .SVE,  {is_64=true}},                             {written={0}, read={1, 2, 3}, fpsr_wr={.IOC}}},
	},
	.FCMLE = {
		...
		{{.FCMLE,          {.P_REG_H,     .P_REG_ZERO, .Z_REG_H, .NONE}, {.PD, .PG, .VN,   .NONE}, 0x65512010, 0xFFFFE010, .SVE,  {}},                                          {written={0}, read={1, 2}, fpsr_wr={.IOC}}},
		{{.FCMLE,          {.P_REG_S,     .P_REG_ZERO, .Z_REG_S, .NONE}, {.PD, .PG, .VN,   .NONE}, 0x65912010, 0xFFFFE010, .SVE,  {}},                                          {written={0}, read={1, 2}, fpsr_wr={.IOC}}},
		{{.FCMLE,          {.P_REG_D,     .P_REG_ZERO, .Z_REG_D, .NONE}, {.PD, .PG, .VN,   .NONE}, 0x65D12010, 0xFFFFE010, .SVE,  {is_64=true}},                                {written={0}, read={1, 2}, fpsr_wr={.IOC}}},
	},
	.FCMLT = {
		...
		{{.FCMLT,          {.P_REG_H,     .P_REG_ZERO, .Z_REG_H, .NONE}, {.PD, .PG, .VN,   .NONE}, 0x65512000, 0xFFFFE010, .SVE,  {}},                                          {written={0}, read={1, 2}, fpsr_wr={.IOC}}},
		{{.FCMLT,          {.P_REG_S,     .P_REG_ZERO, .Z_REG_S, .NONE}, {.PD, .PG, .VN,   .NONE}, 0x65912000, 0xFFFFE010, .SVE,  {}},                                          {written={0}, read={1, 2}, fpsr_wr={.IOC}}},
		{{.FCMLT,          {.P_REG_D,     .P_REG_ZERO, .Z_REG_D, .NONE}, {.PD, .PG, .VN,   .NONE}, 0x65D12000, 0xFFFFE010, .SVE,  {is_64=true}},                                {written={0}, read={1, 2}, fpsr_wr={.IOC}}},
	},
	.FACGE = {
	...
	.TBL = {
		{{.TBL,            {.V_8B,    .V_16B,        .V_8B,    .NONE}, {.VD, .VN_LIST1, .VM, .NONE}, 0x0E000000, 0xFFE0FC00, .NEON, {}},                                                 {written={0}, read={1, 2}}},
		{{.TBL,            {.V_16B,   .V_16B,        .V_16B,   .NONE}, {.VD, .VN_LIST1, .VM, .NONE}, 0x4E000000, 0xFFE0FC00, .NEON, {}},                                                 {written={0}, read={1, 2}}},
	...
	.TBX = {
		{{.TBX,            {.V_8B,    .V_16B,        .V_8B,    .NONE}, {.VD, .VN_LIST1, .VM, .NONE}, 0x0E001000, 0xFFE0FC00, .NEON, {}},                                                 {written={0}, read={0, 1, 2}}},
		{{.TBX,            {.V_16B,   .V_16B,        .V_16B,   .NONE}, {.VD, .VN_LIST1, .VM, .NONE}, 0x4E001000, 0xFFE0FC00, .NEON, {}},                                                 {written={0}, read={0, 1, 2}}},
	...
	.ZIP1 = {
		...
		{{.ZIP1,           {.P_REG_B,   .P_REG_B,   .P_REG_B,   .NONE}, {.PD, .PN, .PM, .NONE}, 0x05204000, 0xFFE0FE10, .SVE,  {}},                                                 {written={0}, read={1, 2}}},
	},
	.ZIP2 = {
		...
		{{.ZIP2,           {.P_REG_B,   .P_REG_B,   .P_REG_B,   .NONE}, {.PD, .PN, .PM, .NONE}, 0x05204400, 0xFFE0FE10, .SVE,  {}},                                                 {written={0}, read={1, 2}}},
	},
	.UZP1 = {
		...
		{{.UZP1,           {.P_REG_B,   .P_REG_B,   .P_REG_B,   .NONE}, {.PD, .PN, .PM, .NONE}, 0x05204800, 0xFFE0FE10, .SVE,  {}},                                                 {written={0}, read={1, 2}}},
	},
	.UZP2 = {
		...
		{{.UZP2,           {.P_REG_B,   .P_REG_B,   .P_REG_B,   .NONE}, {.PD, .PN, .PM, .NONE}, 0x05204C00, 0xFFE0FE10, .SVE,  {}},                                                 {written={0}, read={1, 2}}},
	},
	.TRN1 = {
		...
		{{.TRN1,           {.P_REG_B,   .P_REG_B,   .P_REG_B,   .NONE}, {.PD, .PN, .PM, .NONE}, 0x05205000, 0xFFE0FE10, .SVE,  {}},                                                 {written={0}, read={1, 2}}},
	},
	.TRN2 = {
		...
		{{.TRN2,           {.P_REG_B,   .P_REG_B,   .P_REG_B,   .NONE}, {.PD, .PN, .PM, .NONE}, 0x05205400, 0xFFE0FE10, .SVE,  {}},                                                 {written={0}, read={1, 2}}},
	},
	.NOT = {
		...
		{{.NOT,            {.P_REG_B, .P_REG_ZERO, .P_REG_B, .NONE}, {.PD, .PG4_PM_DUP, .PN,   .NONE}, 0x25004200, 0xFFE0C210, .SVE,  {}},                                        {written={0}, read={1, 2}}},
	},
	.REV64 = {
	...
	.CNT = {
		...
		{{.CNT,            {.Z_REG_B, .P_REG_MERGE, .Z_REG_B, .NONE}, {.VD, .PG, .VN,   .NONE}, 0x041AA000, 0xFFFAE000, .SVE,  {}},                                           {written={0}, read={1, 2}}},
		{{.CNT,            {.Z_REG_H, .P_REG_MERGE, .Z_REG_H, .NONE}, {.VD, .PG, .VN,   .NONE}, 0x045AA000, 0xFFFAE000, .SVE,  {}},                                           {written={0}, read={1, 2}}},
		{{.CNT,            {.Z_REG_S, .P_REG_MERGE, .Z_REG_S, .NONE}, {.VD, .PG, .VN,   .NONE}, 0x049AA000, 0xFFFAE000, .SVE,  {}},                                           {written={0}, read={1, 2}}},
		{{.CNT,            {.Z_REG_D, .P_REG_MERGE, .Z_REG_D, .NONE}, {.VD, .PG, .VN,   .NONE}, 0x04DAA000, 0xFFFAE000, .SVE,  {is_64=true}},                                 {written={0}, read={1, 2}}},
	},
	.URECPE = {
	...
	.LD1 = {
		{{.LD1,            {.V_16B,    .MEM_OFFSET, .NONE,       .NONE}, {.VD_LIST1, .OFFSET_BASE_A, .NONE,          .NONE}, 0x4C407000, 0xFFFFF000, .NEON, {}},                    {written={0}, read={1}, reads_mem=true}},
		{{.LD1,            {.V_8H,     .MEM_OFFSET, .NONE,       .NONE}, {.VD_LIST1, .OFFSET_BASE_A, .NONE,          .NONE}, 0x4C407400, 0xFFFFF400, .NEON, {}},                    {written={0}, read={1}, reads_mem=true}},
		{{.LD1,            {.V_4S,     .MEM_OFFSET, .NONE,       .NONE}, {.VD_LIST1, .OFFSET_BASE_A, .NONE,          .NONE}, 0x4C407800, 0xFFFFF800, .NEON, {}},                    {written={0}, read={1}, reads_mem=true}},
		{{.LD1,            {.V_2D,     .MEM_OFFSET, .NONE,       .NONE}, {.VD_LIST1, .OFFSET_BASE_A, .NONE,          .NONE}, 0x4C407C00, 0xFFFFFC00, .NEON, {}},                    {written={0}, read={1}, reads_mem=true}},
		{{.LD1,            {.V_ELEM_B, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST1, .NEON_LANE_B,   .OFFSET_BASE_A, .NONE}, 0x0D400000, 0xBFFFE000, .NEON, {}},                    {written={0}, read={2}, reads_mem=true}},
		{{.LD1,            {.V_ELEM_H, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST1, .NEON_LANE_H,   .OFFSET_BASE_A, .NONE}, 0x0D404000, 0xBFFFE400, .NEON, {}},                    {written={0}, read={2}, reads_mem=true}},
		{{.LD1,            {.V_ELEM_S, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST1, .NEON_LANE_S,   .OFFSET_BASE_A, .NONE}, 0x0D408000, 0xBFFFEC00, .NEON, {}},                    {written={0}, read={2}, reads_mem=true}},
		{{.LD1,            {.V_ELEM_D, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST1, .NEON_LANE_D,   .OFFSET_BASE_A, .NONE}, 0x0D408400, 0xBFFFFC00, .NEON, {}},                    {written={0}, read={2}, reads_mem=true}},
	},
	.LD2 = {
		{{.LD2,            {.V_16B,    .MEM_OFFSET, .NONE,       .NONE}, {.VD_LIST2, .OFFSET_BASE_A, .NONE,          .NONE}, 0x4C408000, 0xFFFFFC00, .NEON, {}},                    {written={0}, read={1}, reads_mem=true}},
		{{.LD2,            {.V_ELEM_B, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST2, .NEON_LANE_B,   .OFFSET_BASE_A, .NONE}, 0x0D600000, 0xBFFFE000, .NEON, {}},                    {written={0}, read={2}, reads_mem=true}},
		{{.LD2,            {.V_ELEM_H, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST2, .NEON_LANE_H,   .OFFSET_BASE_A, .NONE}, 0x0D604000, 0xBFFFE400, .NEON, {}},                    {written={0}, read={2}, reads_mem=true}},
		{{.LD2,            {.V_ELEM_S, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST2, .NEON_LANE_S,   .OFFSET_BASE_A, .NONE}, 0x0D608000, 0xBFFFEC00, .NEON, {}},                    {written={0}, read={2}, reads_mem=true}},
		{{.LD2,            {.V_ELEM_D, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST2, .NEON_LANE_D,   .OFFSET_BASE_A, .NONE}, 0x0D608400, 0xBFFFFC00, .NEON, {}},                    {written={0}, read={2}, reads_mem=true}},
	},
	.LD3 = {
		{{.LD3,            {.V_16B,    .MEM_OFFSET, .NONE,       .NONE}, {.VD_LIST3, .OFFSET_BASE_A, .NONE,          .NONE}, 0x4C404000, 0xFFFFFC00, .NEON, {}},                    {written={0}, read={1}, reads_mem=true}},
		{{.LD3,            {.V_ELEM_B, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST3, .NEON_LANE_B,   .OFFSET_BASE_A, .NONE}, 0x0D402000, 0xBFFFE000, .NEON, {}},                    {written={0}, read={2}, reads_mem=true}},
		{{.LD3,            {.V_ELEM_H, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST3, .NEON_LANE_H,   .OFFSET_BASE_A, .NONE}, 0x0D406000, 0xBFFFE400, .NEON, {}},                    {written={0}, read={2}, reads_mem=true}},
		{{.LD3,            {.V_ELEM_S, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST3, .NEON_LANE_S,   .OFFSET_BASE_A, .NONE}, 0x0D40A000, 0xBFFFEC00, .NEON, {}},                    {written={0}, read={2}, reads_mem=true}},
		{{.LD3,            {.V_ELEM_D, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST3, .NEON_LANE_D,   .OFFSET_BASE_A, .NONE}, 0x0D40A400, 0xBFFFFC00, .NEON, {}},                    {written={0}, read={2}, reads_mem=true}},
	},
	.LD4 = {
		{{.LD4,            {.V_16B,    .MEM_OFFSET, .NONE,       .NONE}, {.VD_LIST4, .OFFSET_BASE_A, .NONE,          .NONE}, 0x4C400000, 0xFFFFFC00, .NEON, {}},                    {written={0}, read={1}, reads_mem=true}},
		{{.LD4,            {.V_ELEM_B, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST4, .NEON_LANE_B,   .OFFSET_BASE_A, .NONE}, 0x0D602000, 0xBFFFE000, .NEON, {}},                    {written={0}, read={2}, reads_mem=true}},
		{{.LD4,            {.V_ELEM_H, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST4, .NEON_LANE_H,   .OFFSET_BASE_A, .NONE}, 0x0D606000, 0xBFFFE400, .NEON, {}},                    {written={0}, read={2}, reads_mem=true}},
		{{.LD4,            {.V_ELEM_S, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST4, .NEON_LANE_S,   .OFFSET_BASE_A, .NONE}, 0x0D60A000, 0xBFFFEC00, .NEON, {}},                    {written={0}, read={2}, reads_mem=true}},
		{{.LD4,            {.V_ELEM_D, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST4, .NEON_LANE_D,   .OFFSET_BASE_A, .NONE}, 0x0D60A400, 0xBFFFFC00, .NEON, {}},                    {written={0}, read={2}, reads_mem=true}},
	},
	.ST1 = {
		{{.ST1,            {.V_16B,    .MEM_OFFSET, .NONE,       .NONE}, {.VD_LIST1, .OFFSET_BASE_A, .NONE,          .NONE}, 0x4C007000, 0xFFFFF000, .NEON, {}},                    {read={0, 1}, writes_mem=true}},
		{{.ST1,            {.V_8H,     .MEM_OFFSET, .NONE,       .NONE}, {.VD_LIST1, .OFFSET_BASE_A, .NONE,          .NONE}, 0x4C007400, 0xFFFFF400, .NEON, {}},                    {read={0, 1}, writes_mem=true}},
		{{.ST1,            {.V_4S,     .MEM_OFFSET, .NONE,       .NONE}, {.VD_LIST1, .OFFSET_BASE_A, .NONE,          .NONE}, 0x4C007800, 0xFFFFF800, .NEON, {}},                    {read={0, 1}, writes_mem=true}},
		{{.ST1,            {.V_2D,     .MEM_OFFSET, .NONE,       .NONE}, {.VD_LIST1, .OFFSET_BASE_A, .NONE,          .NONE}, 0x4C007C00, 0xFFFFFC00, .NEON, {}},                    {read={0, 1}, writes_mem=true}},
		{{.ST1,            {.V_ELEM_B, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST1, .NEON_LANE_B,   .OFFSET_BASE_A, .NONE}, 0x0D000000, 0xBFFFE000, .NEON, {}},                    {read={0, 2}, writes_mem=true}},
		{{.ST1,            {.V_ELEM_H, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST1, .NEON_LANE_H,   .OFFSET_BASE_A, .NONE}, 0x0D004000, 0xBFFFE400, .NEON, {}},                    {read={0, 2}, writes_mem=true}},
		{{.ST1,            {.V_ELEM_S, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST1, .NEON_LANE_S,   .OFFSET_BASE_A, .NONE}, 0x0D008000, 0xBFFFEC00, .NEON, {}},                    {read={0, 2}, writes_mem=true}},
		{{.ST1,            {.V_ELEM_D, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST1, .NEON_LANE_D,   .OFFSET_BASE_A, .NONE}, 0x0D008400, 0xBFFFFC00, .NEON, {}},                    {read={0, 2}, writes_mem=true}},
	},
	.ST2 = {
		{{.ST2,            {.V_16B,    .MEM_OFFSET, .NONE,       .NONE}, {.VD_LIST2, .OFFSET_BASE_A, .NONE,          .NONE}, 0x4C008000, 0xFFFFFC00, .NEON, {}},                    {read={0, 1}, writes_mem=true}},
		{{.ST2,            {.V_ELEM_B, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST2, .NEON_LANE_B,   .OFFSET_BASE_A, .NONE}, 0x0D200000, 0xBFFFE000, .NEON, {}},                    {read={0, 2}, writes_mem=true}},
		{{.ST2,            {.V_ELEM_H, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST2, .NEON_LANE_H,   .OFFSET_BASE_A, .NONE}, 0x0D204000, 0xBFFFE400, .NEON, {}},                    {read={0, 2}, writes_mem=true}},
		{{.ST2,            {.V_ELEM_S, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST2, .NEON_LANE_S,   .OFFSET_BASE_A, .NONE}, 0x0D208000, 0xBFFFEC00, .NEON, {}},                    {read={0, 2}, writes_mem=true}},
		{{.ST2,            {.V_ELEM_D, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST2, .NEON_LANE_D,   .OFFSET_BASE_A, .NONE}, 0x0D208400, 0xBFFFFC00, .NEON, {}},                    {read={0, 2}, writes_mem=true}},
	},
	.ST3 = {
		{{.ST3,            {.V_16B,    .MEM_OFFSET, .NONE,       .NONE}, {.VD_LIST3, .OFFSET_BASE_A, .NONE,          .NONE}, 0x4C004000, 0xFFFFFC00, .NEON, {}},                    {read={0, 1}, writes_mem=true}},
		{{.ST3,            {.V_ELEM_B, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST3, .NEON_LANE_B,   .OFFSET_BASE_A, .NONE}, 0x0D002000, 0xBFFFE000, .NEON, {}},                    {read={0, 2}, writes_mem=true}},
		{{.ST3,            {.V_ELEM_H, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST3, .NEON_LANE_H,   .OFFSET_BASE_A, .NONE}, 0x0D006000, 0xBFFFE400, .NEON, {}},                    {read={0, 2}, writes_mem=true}},
		{{.ST3,            {.V_ELEM_S, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST3, .NEON_LANE_S,   .OFFSET_BASE_A, .NONE}, 0x0D00A000, 0xBFFFEC00, .NEON, {}},                    {read={0, 2}, writes_mem=true}},
		{{.ST3,            {.V_ELEM_D, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST3, .NEON_LANE_D,   .OFFSET_BASE_A, .NONE}, 0x0D00A400, 0xBFFFFC00, .NEON, {}},                    {read={0, 2}, writes_mem=true}},
	},
	.ST4 = {
		{{.ST4,            {.V_16B,    .MEM_OFFSET, .NONE,       .NONE}, {.VD_LIST4, .OFFSET_BASE_A, .NONE,          .NONE}, 0x4C000000, 0xFFFFFC00, .NEON, {}},                    {read={0, 1}, writes_mem=true}},
		{{.ST4,            {.V_ELEM_B, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST4, .NEON_LANE_B,   .OFFSET_BASE_A, .NONE}, 0x0D202000, 0xBFFFE000, .NEON, {}},                    {read={0, 2}, writes_mem=true}},
		{{.ST4,            {.V_ELEM_H, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST4, .NEON_LANE_H,   .OFFSET_BASE_A, .NONE}, 0x0D206000, 0xBFFFE400, .NEON, {}},                    {read={0, 2}, writes_mem=true}},
		{{.ST4,            {.V_ELEM_S, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST4, .NEON_LANE_S,   .OFFSET_BASE_A, .NONE}, 0x0D20A000, 0xBFFFEC00, .NEON, {}},                    {read={0, 2}, writes_mem=true}},
		{{.ST4,            {.V_ELEM_D, .VEC_INDEX,  .MEM_OFFSET, .NONE}, {.VD_LIST4, .NEON_LANE_D,   .OFFSET_BASE_A, .NONE}, 0x0D20A400, 0xBFFFFC00, .NEON, {}},                    {read={0, 2}, writes_mem=true}},
	},
	.LD1R = {
		{{.LD1R,           {.V_16B, .MEM_OFFSET, .NONE, .NONE}, {.VD_LIST1, .OFFSET_BASE_A, .NONE, .NONE}, 0x4D40C000, 0xFFFFFC00, .NEON, {}},                                      {written={0}, read={1}, reads_mem=true}},
	},
	.LD2R = {
		{{.LD2R,           {.V_16B, .MEM_OFFSET, .NONE, .NONE}, {.VD_LIST2, .OFFSET_BASE_A, .NONE, .NONE}, 0x4D60C000, 0xFFFFFC00, .NEON, {}},                                      {written={0}, read={1}, reads_mem=true}},
	},
	.LD3R = {
		{{.LD3R,           {.V_16B, .MEM_OFFSET, .NONE, .NONE}, {.VD_LIST3, .OFFSET_BASE_A, .NONE, .NONE}, 0x4D40E000, 0xFFFFFC00, .NEON, {}},                                      {written={0}, read={1}, reads_mem=true}},
	},
	.LD4R = {
		{{.LD4R,           {.V_16B, .MEM_OFFSET, .NONE, .NONE}, {.VD_LIST4, .OFFSET_BASE_A, .NONE, .NONE}, 0x4D60E000, 0xFFFFFC00, .NEON, {}},                                      {written={0}, read={1}, reads_mem=true}},
	},
	.SUBR = {
		{{.SUBR,           {.Z_REG_B, .P_REG_MERGE, .Z_REG_B, .Z_REG_B}, {.VD, .PG, .VD, .VN}, 0x04030000, 0xFFFFE000, .SVE, {}},                                             {written={0}, read={1, 2, 3}}},
		{{.SUBR,           {.Z_REG_H, .P_REG_MERGE, .Z_REG_H, .Z_REG_H}, {.VD, .PG, .VD, .VN}, 0x04430000, 0xFFFFE000, .SVE, {}},                                             {written={0}, read={1, 2, 3}}},
		{{.SUBR,           {.Z_REG_S, .P_REG_MERGE, .Z_REG_S, .Z_REG_S}, {.VD, .PG, .VD, .VN}, 0x04830000, 0xFFFFE000, .SVE, {}},                                             {written={0}, read={1, 2, 3}}},
		{{.SUBR,           {.Z_REG_D, .P_REG_MERGE, .Z_REG_D, .Z_REG_D}, {.VD, .PG, .VD, .VN}, 0x04C30000, 0xFFFFE000, .SVE, {is_64=true}},                                   {written={0}, read={1, 2, 3}}},
	},
	.ASRR = {
	...
	.PTRUES = {
		{{.PTRUES,         {.P_REG_B, .SVE_PATTERN, .NONE, .NONE}, {.PD, .SVE_PATTERN, .NONE, .NONE}, 0x2519E000, 0xFFFFFC10, .SVE, {sets_flags=true}},                         {written={0}, nzcv_wr={.N, .Z, .C, .V}}},
	},
	.PFALSE = {
	...
	.BRKPB = {
		{{.BRKPB,          {.P_REG_B, .P_REG_ZERO, .P_REG_B, .P_REG_B}, {.PD, .PG4, .PN, .PM}, 0x2500C010, 0xFFF0C210, .SVE, {}},                                                   {written={0}, read={1, 2, 3}}},
	},
	.BRKN = {
		{{.BRKN,           {.P_REG_B, .P_REG_ZERO, .P_REG_B, .P_REG_B}, {.PD, .PG4, .PN, .PD}, 0x25184000, 0xFFFFC210, .SVE, {}},                                                   {written={0}, read={1, 2, 3}}},
	},
	.RDFFR = {
		{{.RDFFR,          {.P_REG_B, .NONE, .NONE, .NONE}, {.PD, .NONE, .NONE, .NONE}, 0x2519F000, 0xFFFFFFF0, .SVE, {}},                                                      {written={0}, side_effects={.FFR}}},
	},
	.WRFFR = {
		{{.WRFFR,          {.P_REG_B, .NONE, .NONE, .NONE}, {.PN, .NONE, .NONE, .NONE}, 0x25289000, 0xFFFFFE1F, .SVE, {}},                                                      {read={0}, side_effects={.FFR}}},
	},
	.SETFFR = {
		{{.SETFFR,         {.NONE, .NONE, .NONE, .NONE}, {.NONE, .NONE, .NONE, .NONE}, 0x252C9000, 0xFFFFFFFF, .SVE, {}},                                                     {side_effects={.FFR}}},
	},
	.CMPEQ = {
		{{.CMPEQ,          {.P_REG_B, .P_REG_ZERO, .Z_REG_B, .Z_REG_B}, {.PD, .PG, .VN, .VM}, 0x2400A000, 0xFFE0E000, .SVE, {sets_flags=true}},                                 {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.CMPEQ,          {.P_REG_H, .P_REG_ZERO, .Z_REG_H, .Z_REG_H}, {.PD, .PG, .VN, .VM}, 0x2440A000, 0xFFE0E000, .SVE, {sets_flags=true}},                                 {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.CMPEQ,          {.P_REG_S, .P_REG_ZERO, .Z_REG_S, .Z_REG_S}, {.PD, .PG, .VN, .VM}, 0x2480A000, 0xFFE0E000, .SVE, {sets_flags=true}},                                 {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.CMPEQ,          {.P_REG_D, .P_REG_ZERO, .Z_REG_D, .Z_REG_D}, {.PD, .PG, .VN, .VM}, 0x24C0A000, 0xFFE0E000, .SVE, {sets_flags=true, is_64=true}},                     {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
	},
	.CMPNE = {
		{{.CMPNE,          {.P_REG_B, .P_REG_ZERO, .Z_REG_B, .Z_REG_B}, {.PD, .PG, .VN, .VM}, 0x2400A010, 0xFFE0E010, .SVE, {sets_flags=true}},                                 {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.CMPNE,          {.P_REG_H, .P_REG_ZERO, .Z_REG_H, .Z_REG_H}, {.PD, .PG, .VN, .VM}, 0x2440A010, 0xFFE0E010, .SVE, {sets_flags=true}},                                 {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.CMPNE,          {.P_REG_S, .P_REG_ZERO, .Z_REG_S, .Z_REG_S}, {.PD, .PG, .VN, .VM}, 0x2480A010, 0xFFE0E010, .SVE, {sets_flags=true}},                                 {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.CMPNE,          {.P_REG_D, .P_REG_ZERO, .Z_REG_D, .Z_REG_D}, {.PD, .PG, .VN, .VM}, 0x24C0A010, 0xFFE0E010, .SVE, {sets_flags=true, is_64=true}},                     {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
	},
	.CMPGE = {
		{{.CMPGE,          {.P_REG_B, .P_REG_ZERO, .Z_REG_B, .Z_REG_B}, {.PD, .PG, .VN, .VM}, 0x24008000, 0xFFE0E010, .SVE, {sets_flags=true}},                                 {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.CMPGE,          {.P_REG_H, .P_REG_ZERO, .Z_REG_H, .Z_REG_H}, {.PD, .PG, .VN, .VM}, 0x24408000, 0xFFE0E010, .SVE, {sets_flags=true}},                                 {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.CMPGE,          {.P_REG_S, .P_REG_ZERO, .Z_REG_S, .Z_REG_S}, {.PD, .PG, .VN, .VM}, 0x24808000, 0xFFE0E010, .SVE, {sets_flags=true}},                                 {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.CMPGE,          {.P_REG_D, .P_REG_ZERO, .Z_REG_D, .Z_REG_D}, {.PD, .PG, .VN, .VM}, 0x24C08000, 0xFFE0E010, .SVE, {sets_flags=true, is_64=true}},                     {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
	},
	.CMPGT = {
		{{.CMPGT,          {.P_REG_B, .P_REG_ZERO, .Z_REG_B, .Z_REG_B}, {.PD, .PG, .VN, .VM}, 0x24008010, 0xFFE0E010, .SVE, {sets_flags=true}},                                 {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.CMPGT,          {.P_REG_H, .P_REG_ZERO, .Z_REG_H, .Z_REG_H}, {.PD, .PG, .VN, .VM}, 0x24408010, 0xFFE0E010, .SVE, {sets_flags=true}},                                 {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.CMPGT,          {.P_REG_S, .P_REG_ZERO, .Z_REG_S, .Z_REG_S}, {.PD, .PG, .VN, .VM}, 0x24808010, 0xFFE0E010, .SVE, {sets_flags=true}},                                 {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.CMPGT,          {.P_REG_D, .P_REG_ZERO, .Z_REG_D, .Z_REG_D}, {.PD, .PG, .VN, .VM}, 0x24C08010, 0xFFE0E010, .SVE, {sets_flags=true, is_64=true}},                     {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
	},
	.CMPLE = {
		{{.CMPLE,          {.P_REG_B, .P_REG_ZERO, .Z_REG_B, .Z_REG_B}, {.PD, .PG, .VM, .VN}, 0x24008000, 0xFFE0E010, .SVE, {sets_flags=true}},                                 {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.CMPLE,          {.P_REG_H, .P_REG_ZERO, .Z_REG_H, .Z_REG_H}, {.PD, .PG, .VM, .VN}, 0x24408000, 0xFFE0E010, .SVE, {sets_flags=true}},                                 {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.CMPLE,          {.P_REG_S, .P_REG_ZERO, .Z_REG_S, .Z_REG_S}, {.PD, .PG, .VM, .VN}, 0x24808000, 0xFFE0E010, .SVE, {sets_flags=true}},                                 {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.CMPLE,          {.P_REG_D, .P_REG_ZERO, .Z_REG_D, .Z_REG_D}, {.PD, .PG, .VM, .VN}, 0x24C08000, 0xFFE0E010, .SVE, {sets_flags=true, is_64=true}},                     {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
	},
	.CMPLT = {
		{{.CMPLT,          {.P_REG_B, .P_REG_ZERO, .Z_REG_B, .Z_REG_B}, {.PD, .PG, .VM, .VN}, 0x24008010, 0xFFE0E010, .SVE, {sets_flags=true}},                                 {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.CMPLT,          {.P_REG_H, .P_REG_ZERO, .Z_REG_H, .Z_REG_H}, {.PD, .PG, .VM, .VN}, 0x24408010, 0xFFE0E010, .SVE, {sets_flags=true}},                                 {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.CMPLT,          {.P_REG_S, .P_REG_ZERO, .Z_REG_S, .Z_REG_S}, {.PD, .PG, .VM, .VN}, 0x24808010, 0xFFE0E010, .SVE, {sets_flags=true}},                                 {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.CMPLT,          {.P_REG_D, .P_REG_ZERO, .Z_REG_D, .Z_REG_D}, {.PD, .PG, .VM, .VN}, 0x24C08010, 0xFFE0E010, .SVE, {sets_flags=true, is_64=true}},                     {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
	},
	.CMPHI = {
		{{.CMPHI,          {.P_REG_B, .P_REG_ZERO, .Z_REG_B, .Z_REG_B}, {.PD, .PG, .VN, .VM}, 0x24000010, 0xFFE0E010, .SVE, {sets_flags=true}},                                 {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.CMPHI,          {.P_REG_H, .P_REG_ZERO, .Z_REG_H, .Z_REG_H}, {.PD, .PG, .VN, .VM}, 0x24400010, 0xFFE0E010, .SVE, {sets_flags=true}},                                 {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.CMPHI,          {.P_REG_S, .P_REG_ZERO, .Z_REG_S, .Z_REG_S}, {.PD, .PG, .VN, .VM}, 0x24800010, 0xFFE0E010, .SVE, {sets_flags=true}},                                 {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.CMPHI,          {.P_REG_D, .P_REG_ZERO, .Z_REG_D, .Z_REG_D}, {.PD, .PG, .VN, .VM}, 0x24C00010, 0xFFE0E010, .SVE, {sets_flags=true, is_64=true}},                     {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
	},
	.CMPHS = {
		{{.CMPHS,          {.P_REG_B, .P_REG_ZERO, .Z_REG_B, .Z_REG_B}, {.PD, .PG, .VN, .VM}, 0x24000000, 0xFFE0E010, .SVE, {sets_flags=true}},                                 {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.CMPHS,          {.P_REG_H, .P_REG_ZERO, .Z_REG_H, .Z_REG_H}, {.PD, .PG, .VN, .VM}, 0x24400000, 0xFFE0E010, .SVE, {sets_flags=true}},                                 {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.CMPHS,          {.P_REG_S, .P_REG_ZERO, .Z_REG_S, .Z_REG_S}, {.PD, .PG, .VN, .VM}, 0x24800000, 0xFFE0E010, .SVE, {sets_flags=true}},                                 {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.CMPHS,          {.P_REG_D, .P_REG_ZERO, .Z_REG_D, .Z_REG_D}, {.PD, .PG, .VN, .VM}, 0x24C00000, 0xFFE0E010, .SVE, {sets_flags=true, is_64=true}},                     {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
	},
	.CMPLO = {
		{{.CMPLO,          {.P_REG_B, .P_REG_ZERO, .Z_REG_B, .Z_REG_B}, {.PD, .PG, .VM, .VN}, 0x24000010, 0xFFE0E010, .SVE, {sets_flags=true}},                                 {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.CMPLO,          {.P_REG_H, .P_REG_ZERO, .Z_REG_H, .Z_REG_H}, {.PD, .PG, .VM, .VN}, 0x24400010, 0xFFE0E010, .SVE, {sets_flags=true}},                                 {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.CMPLO,          {.P_REG_S, .P_REG_ZERO, .Z_REG_S, .Z_REG_S}, {.PD, .PG, .VM, .VN}, 0x24800010, 0xFFE0E010, .SVE, {sets_flags=true}},                                 {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.CMPLO,          {.P_REG_D, .P_REG_ZERO, .Z_REG_D, .Z_REG_D}, {.PD, .PG, .VM, .VN}, 0x24C00010, 0xFFE0E010, .SVE, {sets_flags=true, is_64=true}},                     {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
	},
	.CMPLS = {
		{{.CMPLS,          {.P_REG_B, .P_REG_ZERO, .Z_REG_B, .Z_REG_B}, {.PD, .PG, .VM, .VN}, 0x24000000, 0xFFE0E010, .SVE, {sets_flags=true}},                                 {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.CMPLS,          {.P_REG_H, .P_REG_ZERO, .Z_REG_H, .Z_REG_H}, {.PD, .PG, .VM, .VN}, 0x24400000, 0xFFE0E010, .SVE, {sets_flags=true}},                                 {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.CMPLS,          {.P_REG_S, .P_REG_ZERO, .Z_REG_S, .Z_REG_S}, {.PD, .PG, .VM, .VN}, 0x24800000, 0xFFE0E010, .SVE, {sets_flags=true}},                                 {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.CMPLS,          {.P_REG_D, .P_REG_ZERO, .Z_REG_D, .Z_REG_D}, {.PD, .PG, .VM, .VN}, 0x24C00000, 0xFFE0E010, .SVE, {sets_flags=true, is_64=true}},                     {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
	},
	.FCMNE = {
		{{.FCMNE,          {.P_REG_H, .P_REG_ZERO, .Z_REG_H, .Z_REG_H}, {.PD, .PG, .VN, .VM}, 0x65406010, 0xFFE0E010, .SVE, {}},                                                {written={0}, read={1, 2, 3}, fpsr_wr={.IOC}}},
		{{.FCMNE,          {.P_REG_S, .P_REG_ZERO, .Z_REG_S, .Z_REG_S}, {.PD, .PG, .VN, .VM}, 0x65806010, 0xFFE0E010, .SVE, {}},                                                {written={0}, read={1, 2, 3}, fpsr_wr={.IOC}}},
		{{.FCMNE,          {.P_REG_D, .P_REG_ZERO, .Z_REG_D, .Z_REG_D}, {.PD, .PG, .VN, .VM}, 0x65C06010, 0xFFE0E010, .SVE, {is_64=true}},                                      {written={0}, read={1, 2, 3}, fpsr_wr={.IOC}}},
	},
	.FCMUO = {
		{{.FCMUO,          {.P_REG_H, .P_REG_ZERO, .Z_REG_H, .Z_REG_H}, {.PD, .PG, .VN, .VM}, 0x6540C000, 0xFFE0E010, .SVE, {}},                                                {written={0}, read={1, 2, 3}, fpsr_wr={.IOC}}},
		{{.FCMUO,          {.P_REG_S, .P_REG_ZERO, .Z_REG_S, .Z_REG_S}, {.PD, .PG, .VN, .VM}, 0x6580C000, 0xFFE0E010, .SVE, {}},                                                {written={0}, read={1, 2, 3}, fpsr_wr={.IOC}}},
		{{.FCMUO,          {.P_REG_D, .P_REG_ZERO, .Z_REG_D, .Z_REG_D}, {.PD, .PG, .VN, .VM}, 0x65C0C000, 0xFFE0E010, .SVE, {is_64=true}},                                      {written={0}, read={1, 2, 3}, fpsr_wr={.IOC}}},
	},
	.INSR = {
	...
	.LD1B = {
		{{.LD1B,           {.Z_REG_B,     .P_REG_ZERO, .MEM_SVE_SS,  .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_SS,  .NONE}, 0xA4004000, 0xFFE0E000, .SVE, {}},           {written={0}, read={1, 2}, reads_mem=true}},
		{{.LD1B,           {.Z_REG_S,     .P_REG_ZERO, .MEM_SVE_VEC, .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_VEC_S, .NONE}, 0x84004000, 0xFFA0E000, .SVE, {}},           {written={0}, read={1, 2}, reads_mem=true}},
		{{.LD1B,           {.Z_REG_D,     .P_REG_ZERO, .MEM_SVE_VEC, .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_VEC_D, .NONE}, 0xC4004000, 0xFFA0E000, .SVE, {is_64=true}}, {written={0}, read={1, 2}, reads_mem=true}},
		...
		{{.LD1B,           {.Z_PAIR_B,      .PN_REG_ZERO, .MEM_SVE_SS,  .NONE}, {.ENC_Z_PAIR_VD, .PNG, .SVE_OFFSET_BASE_SS,  .NONE}, 0xA0000000, 0xFFE0E000, .SME, {}},           {written={0}, read={1, 2}, reads_mem=true}},
		{{.LD1B,           {.Z_QUAD_B,      .PN_REG_ZERO, .MEM_SVE_SS,  .NONE}, {.ENC_Z_QUAD_VD, .PNG, .SVE_OFFSET_BASE_SS,  .NONE}, 0xA0008000, 0xFFE0E000, .SME, {}},           {written={0}, read={1, 2}, reads_mem=true}},
	},
	.LD1H = {
		{{.LD1H,           {.Z_REG_H,     .P_REG_ZERO, .MEM_SVE_SS,  .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_SS1,  .NONE}, 0xA4A04000, 0xFFE0E000, .SVE, {}},           {written={0}, read={1, 2}, reads_mem=true}},
		{{.LD1H,           {.Z_REG_S,     .P_REG_ZERO, .MEM_SVE_VEC, .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_VEC_S, .NONE}, 0x84804000, 0xFFA0E000, .SVE, {}},           {written={0}, read={1, 2}, reads_mem=true}},
		{{.LD1H,           {.Z_REG_D,     .P_REG_ZERO, .MEM_SVE_VEC, .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_VEC_D, .NONE}, 0xC4804000, 0xFFA0E000, .SVE, {is_64=true}}, {written={0}, read={1, 2}, reads_mem=true}},
		{{.LD1H,           {.SME_SLICE_H, .P_REG_ZERO, .MEM_SVE_SS,  .NONE}, {.SME_SLICE_H,   .PG, .SVE_OFFSET_BASE_SS1,  .NONE}, 0xE0400000, 0xFFE00010, .SME, {}},           {written={0}, read={1, 2}, reads_mem=true}},
		{{.LD1H,           {.Z_PAIR_H,      .PN_REG_ZERO, .MEM_SVE_SS,  .NONE}, {.ENC_Z_PAIR_VD, .PNG, .SVE_OFFSET_BASE_SS1,  .NONE}, 0xA0002000, 0xFFE0E000, .SME, {}},           {written={0}, read={1, 2}, reads_mem=true}},
		{{.LD1H,           {.Z_QUAD_H,      .PN_REG_ZERO, .MEM_SVE_SS,  .NONE}, {.ENC_Z_QUAD_VD, .PNG, .SVE_OFFSET_BASE_SS1,  .NONE}, 0xA000A000, 0xFFE0E000, .SME, {}},           {written={0}, read={1, 2}, reads_mem=true}},
	},
	.LD1W = {
		{{.LD1W,           {.Z_REG_S,     .P_REG_ZERO, .MEM_SVE_SS,  .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_SS2,  .NONE}, 0xA5404000, 0xFFE0E000, .SVE, {}},           {written={0}, read={1, 2}, reads_mem=true}},
		{{.LD1W,           {.Z_REG_S,     .P_REG_ZERO, .MEM_SVE_VEC, .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_VEC_S, .NONE}, 0x85004000, 0xFFA0E000, .SVE, {}},           {written={0}, read={1, 2}, reads_mem=true}},
		{{.LD1W,           {.Z_REG_D,     .P_REG_ZERO, .MEM_SVE_VEC, .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_VEC_D, .NONE}, 0xC5004000, 0xFFA0E000, .SVE, {is_64=true}}, {written={0}, read={1, 2}, reads_mem=true}},
		{{.LD1W,           {.SME_SLICE_W, .P_REG_ZERO, .MEM_SVE_SS,  .NONE}, {.SME_SLICE_W,   .PG, .SVE_OFFSET_BASE_SS2,  .NONE}, 0xE0800000, 0xFFE00010, .SME, {}},           {written={0}, read={1, 2}, reads_mem=true}},
		{{.LD1W,           {.Z_PAIR_S,      .PN_REG_ZERO, .MEM_SVE_SS,  .NONE}, {.ENC_Z_PAIR_VD, .PNG, .SVE_OFFSET_BASE_SS2,  .NONE}, 0xA0004000, 0xFFE0E000, .SME, {}},           {written={0}, read={1, 2}, reads_mem=true}},
		{{.LD1W,           {.Z_QUAD_S,      .PN_REG_ZERO, .MEM_SVE_SS,  .NONE}, {.ENC_Z_QUAD_VD, .PNG, .SVE_OFFSET_BASE_SS2,  .NONE}, 0xA000C000, 0xFFE0E000, .SME, {}},           {written={0}, read={1, 2}, reads_mem=true}},
	},
	.LD1D = {
		{{.LD1D,           {.Z_REG_D,     .P_REG_ZERO, .MEM_SVE_SS,  .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_SS3,  .NONE}, 0xA5E04000, 0xFFE0E000, .SVE, {is_64=true}}, {written={0}, read={1, 2}, reads_mem=true}},
		{{.LD1D,           {.Z_REG_D,     .P_REG_ZERO, .MEM_SVE_VEC, .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_VEC_D, .NONE}, 0xC5804000, 0xFFA0E000, .SVE, {is_64=true}}, {written={0}, read={1, 2}, reads_mem=true}},
		{{.LD1D,           {.SME_SLICE_D, .P_REG_ZERO, .MEM_SVE_SS,  .NONE}, {.SME_SLICE_D,   .PG, .SVE_OFFSET_BASE_SS3,  .NONE}, 0xE0C00000, 0xFFE00010, .SME, {is_64=true}}, {written={0}, read={1, 2}, reads_mem=true}},
		{{.LD1D,           {.Z_PAIR_D,      .PN_REG_ZERO, .MEM_SVE_SS,  .NONE}, {.ENC_Z_PAIR_VD, .PNG, .SVE_OFFSET_BASE_SS3,  .NONE}, 0xA0006000, 0xFFE0E000, .SME, {is_64=true}}, {written={0}, read={1, 2}, reads_mem=true}},
		{{.LD1D,           {.Z_QUAD_D,      .PN_REG_ZERO, .MEM_SVE_SS,  .NONE}, {.ENC_Z_QUAD_VD, .PNG, .SVE_OFFSET_BASE_SS3,  .NONE}, 0xA000E000, 0xFFE0E000, .SME, {is_64=true}}, {written={0}, read={1, 2}, reads_mem=true}},
	},
	.LD1SB = {
		{{.LD1SB,          {.Z_REG_H, .P_REG_ZERO, .MEM_SVE_SS,  .NONE}, {.VD_LIST1, .PG, .SVE_OFFSET_BASE_SS,  .NONE}, 0xA5C04000, 0xFFE0E000, .SVE, {}},                          {written={0}, read={1, 2}, reads_mem=true}},
		{{.LD1SB,          {.Z_REG_S, .P_REG_ZERO, .MEM_SVE_VEC, .NONE}, {.VD_LIST1, .PG, .SVE_OFFSET_BASE_VEC_S, .NONE}, 0x84000000, 0xFFA0E000, .SVE, {}},                          {written={0}, read={1, 2}, reads_mem=true}},
		{{.LD1SB,          {.Z_REG_D, .P_REG_ZERO, .MEM_SVE_VEC, .NONE}, {.VD_LIST1, .PG, .SVE_OFFSET_BASE_VEC_D, .NONE}, 0xC4000000, 0xFFA0E000, .SVE, {is_64=true}},                {written={0}, read={1, 2}, reads_mem=true}},
	},
	.LD1SH = {
		{{.LD1SH,          {.Z_REG_D, .P_REG_ZERO, .MEM_SVE_SS,  .NONE}, {.VD_LIST1, .PG, .SVE_OFFSET_BASE_SS1,  .NONE}, 0xA5004000, 0xFFE0E000, .SVE, {}},                          {written={0}, read={1, 2}, reads_mem=true}},
		{{.LD1SH,          {.Z_REG_S, .P_REG_ZERO, .MEM_SVE_SS,  .NONE}, {.VD_LIST1, .PG, .SVE_OFFSET_BASE_SS1,  .NONE}, 0xA5204000, 0xFFE0E000, .SVE, {}},                          {written={0}, read={1, 2}, reads_mem=true}},
		{{.LD1SH,          {.Z_REG_S, .P_REG_ZERO, .MEM_SVE_VEC, .NONE}, {.VD_LIST1, .PG, .SVE_OFFSET_BASE_VEC_S, .NONE}, 0x84800000, 0xFFA0E000, .SVE, {}},                          {written={0}, read={1, 2}, reads_mem=true}},
		{{.LD1SH,          {.Z_REG_D, .P_REG_ZERO, .MEM_SVE_VEC, .NONE}, {.VD_LIST1, .PG, .SVE_OFFSET_BASE_VEC_D, .NONE}, 0xC4800000, 0xFFA0E000, .SVE, {is_64=true}},                {written={0}, read={1, 2}, reads_mem=true}},
	},
	.LD1SW = {
		{{.LD1SW,          {.Z_REG_D, .P_REG_ZERO, .MEM_SVE_SS,  .NONE}, {.VD_LIST1, .PG, .SVE_OFFSET_BASE_SS2,  .NONE}, 0xA4804000, 0xFFE0E000, .SVE, {is_64=true}},                {written={0}, read={1, 2}, reads_mem=true}},
		{{.LD1SW,          {.Z_REG_D, .P_REG_ZERO, .MEM_SVE_VEC, .NONE}, {.VD_LIST1, .PG, .SVE_OFFSET_BASE_VEC_D, .NONE}, 0xC5000000, 0xFFA0E000, .SVE, {is_64=true}},                {written={0}, read={1, 2}, reads_mem=true}},
	},
	.ST1B = {
		{{.ST1B,           {.Z_REG_B,     .P_REG, .MEM_SVE_SS,  .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_SS,  .NONE}, 0xE4004000, 0xFFE0E000, .SVE, {}},                {read={0, 1, 2}, writes_mem=true}},
		{{.ST1B,           {.Z_REG_S,     .P_REG, .MEM_SVE_VEC, .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_VECST_S, .NONE}, 0xE4408000, 0xFFE0A000, .SVE, {}},                {read={0, 1, 2}, writes_mem=true}},
		{{.ST1B,           {.Z_REG_D,     .P_REG, .MEM_SVE_VEC, .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_VECST_D, .NONE}, 0xE4008000, 0xFFE0A000, .SVE, {is_64=true}},      {read={0, 1, 2}, writes_mem=true}},
		...
		{{.ST1B,           {.Z_PAIR_B,      .PN_REG, .MEM_SVE_SS,  .NONE}, {.ENC_Z_PAIR_VD, .PNG, .SVE_OFFSET_BASE_SS,  .NONE}, 0xA0200000, 0xFFE0E000, .SME, {}},                {read={0, 1, 2}, writes_mem=true}},
		{{.ST1B,           {.Z_QUAD_B,      .PN_REG, .MEM_SVE_SS,  .NONE}, {.ENC_Z_QUAD_VD, .PNG, .SVE_OFFSET_BASE_SS,  .NONE}, 0xA0208000, 0xFFE0E000, .SME, {}},                {read={0, 1, 2}, writes_mem=true}},
	},
	.ST1H = {
		{{.ST1H,           {.Z_REG_H,     .P_REG, .MEM_SVE_SS,  .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_SS1,  .NONE}, 0xE4A04000, 0xFFE0E000, .SVE, {}},                {read={0, 1, 2}, writes_mem=true}},
		{{.ST1H,           {.Z_REG_S,     .P_REG, .MEM_SVE_VEC, .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_VECST_S, .NONE}, 0xE4C08000, 0xFFE0A000, .SVE, {}},                {read={0, 1, 2}, writes_mem=true}},
		{{.ST1H,           {.Z_REG_D,     .P_REG, .MEM_SVE_VEC, .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_VECST_D, .NONE}, 0xE4808000, 0xFFE0A000, .SVE, {is_64=true}},      {read={0, 1, 2}, writes_mem=true}},
		{{.ST1H,           {.SME_SLICE_H, .P_REG, .MEM_SVE_SS,  .NONE}, {.SME_SLICE_H,   .PG, .SVE_OFFSET_BASE_SS1,  .NONE}, 0xE0600000, 0xFFE00010, .SME, {}},                {read={0, 1, 2}, writes_mem=true}},
		{{.ST1H,           {.Z_PAIR_H,      .PN_REG, .MEM_SVE_SS,  .NONE}, {.ENC_Z_PAIR_VD, .PNG, .SVE_OFFSET_BASE_SS1,  .NONE}, 0xA0202000, 0xFFE0E000, .SME, {}},                {read={0, 1, 2}, writes_mem=true}},
		{{.ST1H,           {.Z_QUAD_H,      .PN_REG, .MEM_SVE_SS,  .NONE}, {.ENC_Z_QUAD_VD, .PNG, .SVE_OFFSET_BASE_SS1,  .NONE}, 0xA020A000, 0xFFE0E000, .SME, {}},                {read={0, 1, 2}, writes_mem=true}},
	},
	.ST1W = {
		{{.ST1W,           {.Z_REG_S,     .P_REG, .MEM_SVE_SS,  .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_SS2,  .NONE}, 0xE5404000, 0xFFE0E000, .SVE, {}},                {read={0, 1, 2}, writes_mem=true}},
		{{.ST1W,           {.Z_REG_S,     .P_REG, .MEM_SVE_VEC, .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_VECST_S, .NONE}, 0xE5408000, 0xFFE0A000, .SVE, {}},                {read={0, 1, 2}, writes_mem=true}},
		{{.ST1W,           {.Z_REG_D,     .P_REG, .MEM_SVE_VEC, .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_VECST_D, .NONE}, 0xE5008000, 0xFFE0A000, .SVE, {is_64=true}},      {read={0, 1, 2}, writes_mem=true}},
		{{.ST1W,           {.SME_SLICE_W, .P_REG, .MEM_SVE_SS,  .NONE}, {.SME_SLICE_W,   .PG, .SVE_OFFSET_BASE_SS2,  .NONE}, 0xE0A00000, 0xFFE00010, .SME, {}},                {read={0, 1, 2}, writes_mem=true}},
		{{.ST1W,           {.Z_PAIR_S,      .PN_REG, .MEM_SVE_SS,  .NONE}, {.ENC_Z_PAIR_VD, .PNG, .SVE_OFFSET_BASE_SS2,  .NONE}, 0xA0204000, 0xFFE0E000, .SME, {}},                {read={0, 1, 2}, writes_mem=true}},
		{{.ST1W,           {.Z_QUAD_S,      .PN_REG, .MEM_SVE_SS,  .NONE}, {.ENC_Z_QUAD_VD, .PNG, .SVE_OFFSET_BASE_SS2,  .NONE}, 0xA020C000, 0xFFE0E000, .SME, {}},                {read={0, 1, 2}, writes_mem=true}},
	},
	.ST1D = {
		{{.ST1D,           {.Z_REG_D,     .P_REG, .MEM_SVE_SS,  .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_SS3,  .NONE}, 0xE5E04000, 0xFFE0E000, .SVE, {is_64=true}},      {read={0, 1, 2}, writes_mem=true}},
		{{.ST1D,           {.Z_REG_D,     .P_REG, .MEM_SVE_VEC, .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_VECST_D, .NONE}, 0xE5808000, 0xFFE0A000, .SVE, {is_64=true}},      {read={0, 1, 2}, writes_mem=true}},
		{{.ST1D,           {.SME_SLICE_D, .P_REG, .MEM_SVE_SS,  .NONE}, {.SME_SLICE_D,   .PG, .SVE_OFFSET_BASE_SS3,  .NONE}, 0xE0E00000, 0xFFE00010, .SME, {is_64=true}},      {read={0, 1, 2}, writes_mem=true}},
		{{.ST1D,           {.Z_PAIR_D,      .PN_REG, .MEM_SVE_SS,  .NONE}, {.ENC_Z_PAIR_VD, .PNG, .SVE_OFFSET_BASE_SS3,  .NONE}, 0xA0206000, 0xFFE0E000, .SME, {is_64=true}},      {read={0, 1, 2}, writes_mem=true}},
		{{.ST1D,           {.Z_QUAD_D,      .PN_REG, .MEM_SVE_SS,  .NONE}, {.ENC_Z_QUAD_VD, .PNG, .SVE_OFFSET_BASE_SS3,  .NONE}, 0xA020E000, 0xFFE0E000, .SME, {is_64=true}},      {read={0, 1, 2}, writes_mem=true}},
	},
	.LDFF1B = {
		{{.LDFF1B,         {.Z_REG_B, .P_REG_ZERO, .MEM_SVE_SS, .NONE}, {.VD_LIST1, .PG, .SVE_OFFSET_BASE_SS, .NONE}, 0xA4006000, 0xFFE0E000, .SVE, {}},                            {written={0}, read={1, 2}, reads_mem=true, side_effects={.FFR}}},
	},
	.LDFF1H = {
		{{.LDFF1H,         {.Z_REG_H, .P_REG_ZERO, .MEM_SVE_SS, .NONE}, {.VD_LIST1, .PG, .SVE_OFFSET_BASE_SS1, .NONE}, 0xA4A06000, 0xFFE0E000, .SVE, {}},                            {written={0}, read={1, 2}, reads_mem=true, side_effects={.FFR}}},
	},
	.LDFF1W = {
		{{.LDFF1W,         {.Z_REG_S, .P_REG_ZERO, .MEM_SVE_SS, .NONE}, {.VD_LIST1, .PG, .SVE_OFFSET_BASE_SS2, .NONE}, 0xA5406000, 0xFFE0E000, .SVE, {}},                            {written={0}, read={1, 2}, reads_mem=true, side_effects={.FFR}}},
	},
	.LDFF1D = {
		{{.LDFF1D,         {.Z_REG_D, .P_REG_ZERO, .MEM_SVE_SS, .NONE}, {.VD_LIST1, .PG, .SVE_OFFSET_BASE_SS3, .NONE}, 0xA5E06000, 0xFFE0E000, .SVE, {is_64=true}},                  {written={0}, read={1, 2}, reads_mem=true, side_effects={.FFR}}},
	},
	.WHILEGE = {
		{{.WHILEGE,        {.P_REG_B, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25201000, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.WHILEGE,        {.P_REG_H, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25601000, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.WHILEGE,        {.P_REG_S, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25A01000, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.WHILEGE,        {.P_REG_D, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25E01000, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
	},
	.WHILEGT = {
		{{.WHILEGT,        {.P_REG_B, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25201010, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.WHILEGT,        {.P_REG_H, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25601010, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.WHILEGT,        {.P_REG_S, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25A01010, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.WHILEGT,        {.P_REG_D, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25E01010, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
	},
	.WHILELE = {
		{{.WHILELE,        {.P_REG_B, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25201410, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.WHILELE,        {.P_REG_H, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25601410, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.WHILELE,        {.P_REG_S, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25A01410, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.WHILELE,        {.P_REG_D, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25E01410, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
	},
	.WHILELT = {
		{{.WHILELT,        {.P_REG_B, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25201400, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.WHILELT,        {.P_REG_H, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25601400, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.WHILELT,        {.P_REG_S, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25A01400, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.WHILELT,        {.P_REG_D, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25E01400, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
	},
	.WHILEHI = {
		{{.WHILEHI,        {.P_REG_B, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25201810, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.WHILEHI,        {.P_REG_H, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25601810, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.WHILEHI,        {.P_REG_S, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25A01810, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.WHILEHI,        {.P_REG_D, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25E01810, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
	},
	.WHILEHS = {
		{{.WHILEHS,        {.P_REG_B, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25201800, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.WHILEHS,        {.P_REG_H, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25601800, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.WHILEHS,        {.P_REG_S, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25A01800, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.WHILEHS,        {.P_REG_D, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25E01800, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
	},
	.WHILELO = {
		{{.WHILELO,        {.P_REG_B, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25201C00, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.WHILELO,        {.P_REG_H, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25601C00, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.WHILELO,        {.P_REG_S, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25A01C00, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.WHILELO,        {.P_REG_D, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25E01C00, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
	},
	.WHILELS = {
		{{.WHILELS,        {.P_REG_B, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25201C10, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.WHILELS,        {.P_REG_H, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25601C10, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.WHILELS,        {.P_REG_S, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25A01C10, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.WHILELS,        {.P_REG_D, .X_REG, .X_REG, .NONE}, {.PD, .RN, .RM, .NONE}, 0x25E01C10, 0xFFE0FC10, .SVE2, {sets_flags=true, is_64=true}},                            {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
	},
	.SQRDMLAH = {
	...
	.MATCH = {
		{{.MATCH,          {.P_REG_B, .P_REG_ZERO, .Z_REG_B, .Z_REG_B}, {.PD, .PG, .VN, .VM}, 0x45208000, 0xFFE0E010, .SVE2, {sets_flags=true}},                                {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.MATCH,          {.P_REG_H, .P_REG_ZERO, .Z_REG_H, .Z_REG_H}, {.PD, .PG, .VN, .VM}, 0x45608000, 0xFFE0E010, .SVE2, {sets_flags=true}},                                {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
	},
	.NMATCH = {
		{{.NMATCH,         {.P_REG_B, .P_REG_ZERO, .Z_REG_B, .Z_REG_B}, {.PD, .PG, .VN, .VM}, 0x45208010, 0xFFE0E010, .SVE2, {sets_flags=true}},                                {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
		{{.NMATCH,         {.P_REG_H, .P_REG_ZERO, .Z_REG_H, .Z_REG_H}, {.PD, .PG, .VN, .VM}, 0x45608010, 0xFFE0E010, .SVE2, {sets_flags=true}},                                {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
	},
	.HISTCNT = {
	...
	.FCADD = {
		{{.FCADD,          {.V_4H, .V_4H, .V_4H, .IMM_2}, {.VD, .VN, .VM, .ENC_FCADD_ROT}, 0x2E40E400, 0xFFE0EC00, .NEON, {}},                                                {written={0}, read={1, 2}, fpsr_wr={.IOC, .OFC, .UFC, .IXC, .IDC}, reads_fpcr=true}},
		{{.FCADD,          {.V_8H, .V_8H, .V_8H, .IMM_2}, {.VD, .VN, .VM, .ENC_FCADD_ROT}, 0x6E40E400, 0xFFE0EC00, .NEON, {}},                                                {written={0}, read={1, 2}, fpsr_wr={.IOC, .OFC, .UFC, .IXC, .IDC}, reads_fpcr=true}},
		...
		{{.FCADD,          {.V_2D, .V_2D, .V_2D, .IMM_2}, {.VD, .VN, .VM, .ENC_FCADD_ROT}, 0x6EC0E400, 0xFFE0EC00, .NEON, {}},                                                {written={0}, read={1, 2}, fpsr_wr={.IOC, .OFC, .UFC, .IXC, .IDC}, reads_fpcr=true}},
	},
	.PRFB = {
	...
	.PRFH = {
		{{.PRFH,           {.IMM_4, .P_REG_GOV, .MEM_SVE_SS, .NONE}, {.ENC_SVE_PRFOP, .PG, .SVE_OFFSET_BASE_SS1, .NONE}, 0x8480C000, 0xFFE0E000, .SVE, {}},                    {read={1, 2}, side_effects={.HINT}}},
	},
	.PRFW = {
		{{.PRFW,           {.IMM_4, .P_REG_GOV, .MEM_SVE_SS, .NONE}, {.ENC_SVE_PRFOP, .PG, .SVE_OFFSET_BASE_SS2, .NONE}, 0x8500C000, 0xFFE0E000, .SVE, {}},                    {read={1, 2}, side_effects={.HINT}}},
	},
	.PRFD = {
		{{.PRFD,           {.IMM_4, .P_REG_GOV, .MEM_SVE_SS, .NONE}, {.ENC_SVE_PRFOP, .PG, .SVE_OFFSET_BASE_SS3, .NONE}, 0x8580C000, 0xFFE0E000, .SVE, {}},                    {read={1, 2}, side_effects={.HINT}}},
	},
	.LDNT1B = {
		{{.LDNT1B,         {.Z_REG_B, .P_REG_ZERO, .MEM_SVE_SS, .NONE}, {.VD_LIST1, .PG, .SVE_OFFSET_BASE_SS, .NONE}, 0xA400C000, 0xFFE0E000, .SVE, {}},                            {written={0}, read={1, 2}, reads_mem=true}},
	},
	.LDNT1H = {
		{{.LDNT1H,         {.Z_REG_H, .P_REG_ZERO, .MEM_SVE_SS, .NONE}, {.VD_LIST1, .PG, .SVE_OFFSET_BASE_SS1, .NONE}, 0xA480C000, 0xFFE0E000, .SVE, {}},                            {written={0}, read={1, 2}, reads_mem=true}},
	},
	.LDNT1W = {
		{{.LDNT1W,         {.Z_REG_S, .P_REG_ZERO, .MEM_SVE_SS, .NONE}, {.VD_LIST1, .PG, .SVE_OFFSET_BASE_SS2, .NONE}, 0xA500C000, 0xFFE0E000, .SVE, {}},                            {written={0}, read={1, 2}, reads_mem=true}},
	},
	.LDNT1D = {
		{{.LDNT1D,         {.Z_REG_D, .P_REG_ZERO, .MEM_SVE_SS, .NONE}, {.VD_LIST1, .PG, .SVE_OFFSET_BASE_SS3, .NONE}, 0xA580C000, 0xFFE0E000, .SVE, {is_64=true}},                  {written={0}, read={1, 2}, reads_mem=true}},
	},
	.STNT1B = {
		{{.STNT1B,         {.Z_REG_B, .P_REG, .MEM_SVE_SS, .NONE}, {.VD_LIST1, .PG, .SVE_OFFSET_BASE_SS, .NONE}, 0xE4006000, 0xFFE0E000, .SVE, {}},                                 {read={0, 1, 2}, writes_mem=true}},
	},
	.STNT1H = {
		{{.STNT1H,         {.Z_REG_H, .P_REG, .MEM_SVE_SS, .NONE}, {.VD_LIST1, .PG, .SVE_OFFSET_BASE_SS1, .NONE}, 0xE4806000, 0xFFE0E000, .SVE, {}},                                 {read={0, 1, 2}, writes_mem=true}},
	},
	.STNT1W = {
		{{.STNT1W,         {.Z_REG_S, .P_REG, .MEM_SVE_SS, .NONE}, {.VD_LIST1, .PG, .SVE_OFFSET_BASE_SS2, .NONE}, 0xE5006000, 0xFFE0E000, .SVE, {}},                                 {read={0, 1, 2}, writes_mem=true}},
	},
	.STNT1D = {
		{{.STNT1D,         {.Z_REG_D, .P_REG, .MEM_SVE_SS, .NONE}, {.VD_LIST1, .PG, .SVE_OFFSET_BASE_SS3, .NONE}, 0xE5806000, 0xFFE0E000, .SVE, {is_64=true}},                       {read={0, 1, 2}, writes_mem=true}},
	},
	.SPLICE = {
		{{.SPLICE,         {.Z_REG_B, .P_REG_GOV, .Z_REG_B, .Z_REG_B}, {.VD, .PG, .VD, .VN}, 0x052C8000, 0xFFFFE000, .SVE, {}},                                               {written={0}, read={1, 2, 3}}},
	},
	.INDEX = {
		{{.INDEX,          {.Z_REG_B, .IMM_5, .IMM_5, .NONE}, {.VD, .SVE_IMM5A, .SVE_IMM5, .NONE}, 0x04204000, 0xFFE0FC00, .SVE, {}},   {written={0}}},
		{{.INDEX,          {.Z_REG_B, .IMM_5, .W_REG, .NONE}, {.VD, .SVE_IMM5A, .RM, .NONE}, 0x04204800, 0xFFE0FC00, .SVE, {}},   {written={0}}},
		{{.INDEX,          {.Z_REG_B, .W_REG, .IMM_5, .NONE}, {.VD, .RN, .SVE_IMM5, .NONE}, 0x04204400, 0xFFE0FC00, .SVE, {}},   {written={0}}},
		{{.INDEX,          {.Z_REG_B, .W_REG, .W_REG, .NONE}, {.VD, .RN, .RM, .NONE}, 0x04204C00, 0xFFE0FC00, .SVE, {}},   {written={0}}},
		{{.INDEX,          {.Z_REG_H, .IMM_5, .IMM_5, .NONE}, {.VD, .SVE_IMM5A, .SVE_IMM5, .NONE}, 0x04604000, 0xFFE0FC00, .SVE, {}},   {written={0}}},
		{{.INDEX,          {.Z_REG_H, .IMM_5, .W_REG, .NONE}, {.VD, .SVE_IMM5A, .RM, .NONE}, 0x04604800, 0xFFE0FC00, .SVE, {}},   {written={0}}},
		{{.INDEX,          {.Z_REG_H, .W_REG, .IMM_5, .NONE}, {.VD, .RN, .SVE_IMM5, .NONE}, 0x04604400, 0xFFE0FC00, .SVE, {}},   {written={0}}},
		{{.INDEX,          {.Z_REG_H, .W_REG, .W_REG, .NONE}, {.VD, .RN, .RM, .NONE}, 0x04604C00, 0xFFE0FC00, .SVE, {}},   {written={0}}},
		{{.INDEX,          {.Z_REG_S, .IMM_5, .IMM_5, .NONE}, {.VD, .SVE_IMM5A, .SVE_IMM5, .NONE}, 0x04A04000, 0xFFE0FC00, .SVE, {}},   {written={0}}},
		{{.INDEX,          {.Z_REG_S, .IMM_5, .W_REG, .NONE}, {.VD, .SVE_IMM5A, .RM, .NONE}, 0x04A04800, 0xFFE0FC00, .SVE, {}},   {written={0}}},
		{{.INDEX,          {.Z_REG_S, .W_REG, .IMM_5, .NONE}, {.VD, .RN, .SVE_IMM5, .NONE}, 0x04A04400, 0xFFE0FC00, .SVE, {}},   {written={0}}},
		{{.INDEX,          {.Z_REG_S, .W_REG, .W_REG, .NONE}, {.VD, .RN, .RM, .NONE}, 0x04A04C00, 0xFFE0FC00, .SVE, {}},   {written={0}}},
		{{.INDEX,          {.Z_REG_D, .IMM_5, .IMM_5, .NONE}, {.VD, .SVE_IMM5A, .SVE_IMM5, .NONE}, 0x04E04000, 0xFFE0FC00, .SVE, {}},   {written={0}}},
		{{.INDEX,          {.Z_REG_D, .IMM_5, .X_REG, .NONE}, {.VD, .SVE_IMM5A, .RM, .NONE}, 0x04E04800, 0xFFE0FC00, .SVE, {}},   {written={0}}},
		{{.INDEX,          {.Z_REG_D, .X_REG, .IMM_5, .NONE}, {.VD, .RN, .SVE_IMM5, .NONE}, 0x04E04400, 0xFFE0FC00, .SVE, {}},   {written={0}}},
		{{.INDEX,          {.Z_REG_D, .X_REG, .X_REG, .NONE}, {.VD, .RN, .RM, .NONE}, 0x04E04C00, 0xFFE0FC00, .SVE, {}},   {written={0}}},
	},
	.BSL1N = {
	...
	.BFADD = {
		{{.BFADD,          {.Z_REG_H, .P_REG_MERGE, .Z_REG_H, .Z_REG_H}, {.VD, .PG, .VD, .VN},   0x65008000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}, fpsr_wr={.IOC, .OFC, .UFC, .IXC, .IDC}, reads_fpcr=true}},
	...
	.BFSUB = {
		{{.BFSUB,          {.Z_REG_H, .P_REG_MERGE, .Z_REG_H, .Z_REG_H}, {.VD, .PG, .VD, .VN},   0x65018000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}, fpsr_wr={.IOC, .OFC, .UFC, .IXC, .IDC}, reads_fpcr=true}},
	...
	.BFMUL = {
		{{.BFMUL,          {.Z_REG_H, .P_REG_MERGE, .Z_REG_H, .Z_REG_H}, {.VD, .PG, .VD, .VN},   0x65028000, 0xFFFFE000, .SVE,  {}},                                          {written={0}, read={1, 2, 3}, fpsr_wr={.IOC, .OFC, .UFC, .IXC, .IDC}, reads_fpcr=true}},
	...
	.BFMAXNM = {
		{{.BFMAXNM,        {.Z_REG_H, .P_REG_MERGE, .Z_REG_H, .Z_REG_H}, {.VD, .PG, .VD, .VN}, 0x65048000, 0xFFFFE000, .SVE2, {}},                                            {written={0}, read={1, 2, 3}}},
	},
	.BFMINNM = {
		{{.BFMINNM,        {.Z_REG_H, .P_REG_MERGE, .Z_REG_H, .Z_REG_H}, {.VD, .PG, .VD, .VN}, 0x65058000, 0xFFFFE000, .SVE2, {}},                                            {written={0}, read={1, 2, 3}}},
	},
	.LUTI2 = {
		{{.LUTI2,         {.Z_PAIR_B, .ZT_REG, .Z_REG_ANY, .VEC_INDEX}, {.ENC_Z_PAIR_VD, .ENC_ZT0, .VN, .LUTI_IDX}, 0xC08C4000, 0xFFFE7C00, .SME, {}}, {written={0}, read={2}}},
		{{.LUTI2,         {.Z_PAIR_H, .ZT_REG, .Z_REG_ANY, .VEC_INDEX}, {.ENC_Z_PAIR_VD, .ENC_ZT0, .VN, .LUTI_IDX}, 0xC08C5000, 0xFFFE7C00, .SME, {}}, {written={0}, read={2}}},
		{{.LUTI2,         {.Z_PAIR_S, .ZT_REG, .Z_REG_ANY, .VEC_INDEX}, {.ENC_Z_PAIR_VD, .ENC_ZT0, .VN, .LUTI_IDX}, 0xC08C6000, 0xFFFE7C00, .SME, {}}, {written={0}, read={2}}},
	},
	.LUTI4 = {
		{{.LUTI4,         {.Z_PAIR_B, .ZT_REG, .Z_REG_ANY, .VEC_INDEX}, {.ENC_Z_PAIR_VD, .ENC_ZT0, .VN, .LUTI_IDX}, 0xC08A4000, 0xFFFE7C00, .SME, {}}, {written={0}, read={2}}},
		{{.LUTI4,         {.Z_PAIR_H, .ZT_REG, .Z_REG_ANY, .VEC_INDEX}, {.ENC_Z_PAIR_VD, .ENC_ZT0, .VN, .LUTI_IDX}, 0xC08A5000, 0xFFFE7C00, .SME, {}}, {written={0}, read={2}}},
		{{.LUTI4,         {.Z_PAIR_S, .ZT_REG, .Z_REG_ANY, .VEC_INDEX}, {.ENC_Z_PAIR_VD, .ENC_ZT0, .VN, .LUTI_IDX}, 0xC08A6000, 0xFFFE7C00, .SME, {}}, {written={0}, read={2}}},
	},
	.ZIP = {
		{{.ZIP,            {.Z_PAIR_B, .Z_REG_B, .Z_REG_B, .NONE}, {.ENC_Z_PAIR_VD, .VN,            .VM,   .NONE}, 0xC120D000, 0xFFE0FC00, .SME, {}},                           {written={0}, read={1, 2}}},
		{{.ZIP,            {.Z_QUAD_B, .Z_QUAD_B,  .NONE,    .NONE}, {.ENC_Z_QUAD_VD, .ENC_Z_QUAD_VN, .NONE, .NONE}, 0xC136E000, 0xFFFFFC00, .SME, {}},                           {written={0}, read={1, 2}}},
	},
	.UZP = {
		{{.UZP,            {.Z_PAIR_B, .Z_REG_B, .Z_REG_B, .NONE}, {.ENC_Z_PAIR_VD, .VN,            .VM,   .NONE}, 0xC120D001, 0xFFE0FC01, .SME, {}},                           {written={0}, read={1, 2}}},
		{{.UZP,            {.Z_QUAD_B, .Z_QUAD_B,  .NONE,    .NONE}, {.ENC_Z_QUAD_VD, .ENC_Z_QUAD_VN, .NONE, .NONE}, 0xC136E002, 0xFFFFFC02, .SME, {}},                           {written={0}, read={1, 2}}},
	},
	.TLBI_RPALOS = {
	...
	.SETM = {
		{{.SETM,           {.XSP_REG, .X_REG, .X_REG, .NONE}, {.RD, .RN, .RM, .NONE}, 0x19C04400, 0xFFE07C00, .BASE, {is_64=true}},                                           {written={0, 1}, read={0, 1, 2}, writes_mem=true}},
	},
	.SETE = {
		{{.SETE,           {.XSP_REG, .X_REG, .X_REG, .NONE}, {.RD, .RN, .RM, .NONE}, 0x19C08400, 0xFFE0BC00, .BASE, {is_64=true}},                                           {written={0, 1}, read={0, 1, 2}, writes_mem=true}},
	},
	.DC_IVAC = {
