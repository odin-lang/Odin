...
INSTRUCTION_TABLE := [Mnemonic][]Form{
	...
	.TBL = {
		{{.TBL,            {.V_8B,    .V_LIST_16B,   .V_8B,    .NONE}, {.VD, .VN, .VM, .NONE}, 0x0E000000, 0xFFE0FC00, .NEON, {}},                                                 {written={0}, read={1, 2}}},
		{{.TBL,            {.V_16B,   .V_LIST_16B,   .V_16B,   .NONE}, {.VD, .VN, .VM, .NONE}, 0x4E000000, 0xFFE0FC00, .NEON, {}},                                                 {written={0}, read={1, 2}}},
	...
	.TBX = {
		{{.TBX,            {.V_8B,    .V_LIST_16B,   .V_8B,    .NONE}, {.VD, .VN, .VM, .NONE}, 0x0E001000, 0xFFE0FC00, .NEON, {}},                                                 {written={0}, read={0, 1, 2}}},
		{{.TBX,            {.V_16B,   .V_LIST_16B,   .V_16B,   .NONE}, {.VD, .VN, .VM, .NONE}, 0x4E001000, 0xFFE0FC00, .NEON, {}},                                                 {written={0}, read={0, 1, 2}}},
