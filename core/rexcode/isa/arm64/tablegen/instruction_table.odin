...
INSTRUCTION_TABLE := [Mnemonic][]Form{
	...
	.AND = {
		...
		{{.AND,            {.P_REG_B,   .P_REG_ZERO,  .P_REG,       .P_REG},   {.PD, .PG4, .PN,            .PM},   0x25004000, 0xFFE0C210, .SVE,  {}},                          {written={0}, read={1, 2, 3}}},
	},
	.ANDS = {
		...
		{{.ANDS,           {.P_REG_H, .P_REG_ZERO, .P_REG,       .P_REG}, {.PD, .PG4, .PN,            .PM},   0x25404000, 0xFFE0C210, .SVE,  {sets_flags=true}},                {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
	},
	.ORR = {
		...
		{{.ORR,            {.P_REG_S,   .P_REG_ZERO,  .P_REG,       .P_REG},   {.PD, .PG4, .PN,            .PM},   0x25804000, 0xFFE0C210, .SVE,  {}},                          {written={0}, read={1, 2, 3}}},
	},
	.EOR = {
		...
		{{.EOR,            {.P_REG_B,   .P_REG_ZERO,  .P_REG,       .P_REG},   {.PD, .PG4, .PN,            .PM},   0x25004200, 0xFFE0C210, .SVE,  {}},                          {written={0}, read={1, 2, 3}}},
	},
	.BIC = {
		...
		{{.BIC,            {.P_REG_B,   .P_REG_ZERO,  .P_REG,     .P_REG},   {.PD, .PG4, .PN, .PM},   0x25004010, 0xFFE0C210, .SVE,  {}},                                       {written={0}, read={1, 2, 3}}},
	},
	.BICS = {
		...
		{{.BICS,           {.P_REG_H, .P_REG_ZERO, .P_REG,     .P_REG}, {.PD, .PG4, .PN, .PM},   0x25404010, 0xFFE0C210, .SVE,  {sets_flags=true}},                             {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
	},
	.ORN = {
		...
		{{.ORN,            {.P_REG_S, .P_REG_ZERO, .P_REG,     .P_REG}, {.PD, .PG4, .PN, .PM},   0x25804010, 0xFFE0C210, .SVE,  {}},                                            {written={0}, read={1, 2, 3}}},
	},
	.EON = {
	...
	.REV = {
		...
		{{.REV,            {.P_REG_B,   .P_REG,   .NONE, .NONE}, {.PD, .PN, .NONE, .NONE}, 0x05344000, 0xFFFFFE10, .SVE,  {}},                                                  {written={0}, read={1}}},
	},
	.REV16 = {
	...
	.LDR = {
		...
		{{.LDR,            {.P_REG_S,   .MEM_SVE_SI, .NONE, .NONE}, {.PD,       .SVE_OFFSET_BASE_SI, .NONE, .NONE}, 0x85800000, 0xFFE0E010, .SVE,  {}},                         {written={0}, read={1}, reads_mem=true}},
	...
	.STR = {
		...
		{{.STR,            {.P_REG_S,   .MEM_SVE_SI, .NONE, .NONE}, {.PD,       .SVE_OFFSET_BASE_SI, .NONE, .NONE}, 0xE5800000, 0xFFE0E010, .SVE,  {}},                         {read={0, 1}, writes_mem=true}},
	...
	.ZIP1 = {
		...
		{{.ZIP1,           {.P_REG_B,   .P_REG,   .P_REG,   .NONE}, {.PD, .PN, .PM, .NONE}, 0x05204000, 0xFFE0FE10, .SVE,  {}},                                                 {written={0}, read={1, 2}}},
	},
	.ZIP2 = {
		...
		{{.ZIP2,           {.P_REG_B,   .P_REG,   .P_REG,   .NONE}, {.PD, .PN, .PM, .NONE}, 0x05204400, 0xFFE0FE10, .SVE,  {}},                                                 {written={0}, read={1, 2}}},
	},
	.UZP1 = {
		...
		{{.UZP1,           {.P_REG_B,   .P_REG,   .P_REG,   .NONE}, {.PD, .PN, .PM, .NONE}, 0x05204800, 0xFFE0FE10, .SVE,  {}},                                                 {written={0}, read={1, 2}}},
	},
	.UZP2 = {
		...
		{{.UZP2,           {.P_REG_B,   .P_REG,   .P_REG,   .NONE}, {.PD, .PN, .PM, .NONE}, 0x05204C00, 0xFFE0FE10, .SVE,  {}},                                                 {written={0}, read={1, 2}}},
	},
	.TRN1 = {
		...
		{{.TRN1,           {.P_REG_B,   .P_REG,   .P_REG,   .NONE}, {.PD, .PN, .PM, .NONE}, 0x05205000, 0xFFE0FE10, .SVE,  {}},                                                 {written={0}, read={1, 2}}},
	},
	.TRN2 = {
		...
		{{.TRN2,           {.P_REG_B,   .P_REG,   .P_REG,   .NONE}, {.PD, .PN, .PM, .NONE}, 0x05205400, 0xFFE0FE10, .SVE,  {}},                                                 {written={0}, read={1, 2}}},
	},
	.NOT = {
		...
		{{.NOT,            {.P_REG_B, .P_REG_ZERO, .P_REG, .NONE}, {.PD, .PG4_PM_DUP, .PN,   .NONE}, 0x25004200, 0xFFE0C210, .SVE,  {}},                                        {written={0}, read={1, 2}}},
	},
	.REV64 = {
	...
	.NAND = {
		{{.NAND,           {.P_REG_S, .P_REG_ZERO, .P_REG, .P_REG}, {.PD, .PG4, .PN, .PM}, 0x25804210, 0xFFE0C210, .SVE, {}},                                                   {written={0}, read={1, 2, 3}}},
	},
	.NOR = {
		{{.NOR,            {.P_REG_S, .P_REG_ZERO, .P_REG, .P_REG}, {.PD, .PG4, .PN, .PM}, 0x25804200, 0xFFE0C210, .SVE, {}},                                                   {written={0}, read={1, 2, 3}}},
	},
	.SEL = {
		{{.SEL,            {.P_REG_B, .P_REG, .P_REG, .P_REG}, {.PD, .PG4, .PN, .PM}, 0x25004210, 0xFFE0C210, .SVE, {}},                                                        {written={0}, read={1, 2, 3}}},
	},
	.ORRS = {
		{{.ORRS,           {.P_REG_D, .P_REG_ZERO, .P_REG, .P_REG}, {.PD, .PG4, .PN, .PM}, 0x25C04000, 0xFFE0C210, .SVE, {sets_flags=true}},                                    {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
	},
	.EORS = {
		{{.EORS,           {.P_REG_H, .P_REG_ZERO, .P_REG, .P_REG}, {.PD, .PG4, .PN, .PM}, 0x25404200, 0xFFE0C210, .SVE, {sets_flags=true}},                                    {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
	},
	.NANDS = {
		{{.NANDS,          {.P_REG_D, .P_REG_ZERO, .P_REG, .P_REG}, {.PD, .PG4, .PN, .PM}, 0x25C04210, 0xFFF0C210, .SVE, {sets_flags=true}},                                    {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
	},
	.NORS = {
		{{.NORS,           {.P_REG_D, .P_REG_ZERO, .P_REG, .P_REG}, {.PD, .PG4, .PN, .PM}, 0x25C04200, 0xFFF0C210, .SVE, {sets_flags=true}},                                    {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
	},
	.ORNS = {
		{{.ORNS,           {.P_REG_D, .P_REG_ZERO, .P_REG, .P_REG}, {.PD, .PG4, .PN, .PM}, 0x25C04010, 0xFFF0C210, .SVE, {sets_flags=true}},                                    {written={0}, read={1, 2, 3}, nzcv_wr={.N, .Z, .C, .V}}},
	},
	.MOVS = {
	...
	.PFIRST = {
		{{.PFIRST,         {.P_REG_H, .P_REG, .P_REG, .NONE}, {.PD, .PN, .PD, .NONE}, 0x2558C000, 0xFFFFFE10, .SVE, {}},                                                        {written={0}, read={1, 2}}},
	},
	.PNEXT = {
		{{.PNEXT,          {.P_REG_B, .P_REG, .P_REG, .NONE}, {.PD, .PN, .PD, .NONE}, 0x2519C400, 0xFFFFFE10, .SVE, {}},                                                        {written={0}, read={1, 2}}},
	},
	.BRKA = {
		{{.BRKA,           {.P_REG_B, .P_REG_MERGE, .P_REG, .NONE}, {.PD, .PG4, .PN, .NONE}, 0x25104010, 0xFFFFC210, .SVE, {}},                                                 {written={0}, read={1, 2}}},
	},
	.BRKB = {
		{{.BRKB,           {.P_REG_S, .P_REG_MERGE, .P_REG, .NONE}, {.PD, .PG4, .PN, .NONE}, 0x25904010, 0xFFFFC210, .SVE, {}},                                                 {written={0}, read={1, 2}}},
	},
	.BRKAS = {
		{{.BRKAS,          {.P_REG_H, .P_REG_ZERO, .P_REG, .NONE}, {.PD, .PG4, .PN, .NONE}, 0x25504000, 0xFFFFC210, .SVE, {sets_flags=true}},                                   {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
	},
	.BRKBS = {
		{{.BRKBS,          {.P_REG_D, .P_REG_ZERO, .P_REG, .NONE}, {.PD, .PG4, .PN, .NONE}, 0x25D04000, 0xFFFFC210, .SVE, {sets_flags=true}},                                   {written={0}, read={1, 2}, nzcv_wr={.N, .Z, .C, .V}}},
	},
	.BRKPA = {
		{{.BRKPA,          {.P_REG_B, .P_REG_ZERO, .P_REG, .P_REG}, {.PD, .PG4, .PN, .PM}, 0x2500C000, 0xFFF0C210, .SVE, {}},                                                   {written={0}, read={1, 2, 3}}},
	},
	.BRKPB = {
		{{.BRKPB,          {.P_REG_B, .P_REG_ZERO, .P_REG, .P_REG}, {.PD, .PG4, .PN, .PM}, 0x2500C010, 0xFFF0C210, .SVE, {}},                                                   {written={0}, read={1, 2, 3}}},
	},
	.BRKN = {
		{{.BRKN,           {.P_REG_B, .P_REG_ZERO, .P_REG, .P_REG}, {.PD, .PG4, .PN, .PD}, 0x25184000, 0xFFFFC210, .SVE, {}},                                                   {written={0}, read={1, 2, 3}}},
	},
	.RDFFR = {
	...
	.LD1B = {
		...
		{{.LD1B,           {.Z_REG_S,     .P_REG_ZERO, .MEM_SVE_VEC, .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_VEC, .NONE}, 0x84004000, 0xFFA0E000, .SVE, {}},           {written={0}, read={1, 2}, reads_mem=true}},
		{{.LD1B,           {.Z_REG_D,     .P_REG_ZERO, .MEM_SVE_VEC, .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_VEC, .NONE}, 0xC4004000, 0xFFA0E000, .SVE, {is_64=true}}, {written={0}, read={1, 2}, reads_mem=true}},
	...
	.LD1H = {
		...
		{{.LD1H,           {.Z_REG_S,     .P_REG_ZERO, .MEM_SVE_VEC, .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_VEC, .NONE}, 0x84804000, 0xFFA0E000, .SVE, {}},           {written={0}, read={1, 2}, reads_mem=true}},
		{{.LD1H,           {.Z_REG_D,     .P_REG_ZERO, .MEM_SVE_VEC, .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_VEC, .NONE}, 0xC4804000, 0xFFA0E000, .SVE, {is_64=true}}, {written={0}, read={1, 2}, reads_mem=true}},
	...
	.LD1W = {
		...
		{{.LD1W,           {.Z_REG_S,     .P_REG_ZERO, .MEM_SVE_VEC, .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_VEC, .NONE}, 0x85004000, 0xFFA0E000, .SVE, {}},           {written={0}, read={1, 2}, reads_mem=true}},
		{{.LD1W,           {.Z_REG_D,     .P_REG_ZERO, .MEM_SVE_VEC, .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_VEC, .NONE}, 0xC5004000, 0xFFA0E000, .SVE, {is_64=true}}, {written={0}, read={1, 2}, reads_mem=true}},
	...
	.LD1D = {
		...
		{{.LD1D,           {.Z_REG_D,     .P_REG_ZERO, .MEM_SVE_VEC, .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_VEC, .NONE}, 0xC5804000, 0xFFA0E000, .SVE, {is_64=true}}, {written={0}, read={1, 2}, reads_mem=true}},
	...
	.LD1SB = {
		...
		{{.LD1SB,          {.Z_REG_S, .P_REG_ZERO, .MEM_SVE_VEC, .NONE}, {.VD_LIST1, .PG, .SVE_OFFSET_BASE_VEC, .NONE}, 0x84000000, 0xFFA0E000, .SVE, {}},                          {written={0}, read={1, 2}, reads_mem=true}},
		{{.LD1SB,          {.Z_REG_D, .P_REG_ZERO, .MEM_SVE_VEC, .NONE}, {.VD_LIST1, .PG, .SVE_OFFSET_BASE_VEC, .NONE}, 0xC4000000, 0xFFA0E000, .SVE, {is_64=true}},                {written={0}, read={1, 2}, reads_mem=true}},
	},
	.LD1SH = {
		...
		{{.LD1SH,          {.Z_REG_S, .P_REG_ZERO, .MEM_SVE_VEC, .NONE}, {.VD_LIST1, .PG, .SVE_OFFSET_BASE_VEC, .NONE}, 0x84800000, 0xFFA0E000, .SVE, {}},                          {written={0}, read={1, 2}, reads_mem=true}},
		{{.LD1SH,          {.Z_REG_D, .P_REG_ZERO, .MEM_SVE_VEC, .NONE}, {.VD_LIST1, .PG, .SVE_OFFSET_BASE_VEC, .NONE}, 0xC4800000, 0xFFA0E000, .SVE, {is_64=true}},                {written={0}, read={1, 2}, reads_mem=true}},
	},
	.LD1SW = {
		...
		{{.LD1SW,          {.Z_REG_D, .P_REG_ZERO, .MEM_SVE_VEC, .NONE}, {.VD_LIST1, .PG, .SVE_OFFSET_BASE_VEC, .NONE}, 0xC5000000, 0xFFA0E000, .SVE, {is_64=true}},                {written={0}, read={1, 2}, reads_mem=true}},
	},
	.ST1B = {
		...
		{{.ST1B,           {.Z_REG_S,     .P_REG, .MEM_SVE_VEC, .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_VEC, .NONE}, 0xE4008000, 0xFFA0E000, .SVE, {}},                {read={0, 1, 2}, writes_mem=true}},
		{{.ST1B,           {.Z_REG_D,     .P_REG, .MEM_SVE_VEC, .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_VEC, .NONE}, 0xE4008000, 0xFFA0E000, .SVE, {is_64=true}},      {read={0, 1, 2}, writes_mem=true}},
	...
	.ST1H = {
		...
		{{.ST1H,           {.Z_REG_S,     .P_REG, .MEM_SVE_VEC, .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_VEC, .NONE}, 0xE4808000, 0xFFA0E000, .SVE, {}},                {read={0, 1, 2}, writes_mem=true}},
		{{.ST1H,           {.Z_REG_D,     .P_REG, .MEM_SVE_VEC, .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_VEC, .NONE}, 0xE4808000, 0xFFA0E000, .SVE, {is_64=true}},      {read={0, 1, 2}, writes_mem=true}},
	...
	.ST1W = {
		...
		{{.ST1W,           {.Z_REG_S,     .P_REG, .MEM_SVE_VEC, .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_VEC, .NONE}, 0xE5008000, 0xFFA0E000, .SVE, {}},                {read={0, 1, 2}, writes_mem=true}},
		{{.ST1W,           {.Z_REG_D,     .P_REG, .MEM_SVE_VEC, .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_VEC, .NONE}, 0xE5008000, 0xFFA0E000, .SVE, {is_64=true}},      {read={0, 1, 2}, writes_mem=true}},
	...
	.ST1D = {
		...
		{{.ST1D,           {.Z_REG_D,     .P_REG, .MEM_SVE_VEC, .NONE}, {.VD_LIST1,            .PG, .SVE_OFFSET_BASE_VEC, .NONE}, 0xE5808000, 0xFFA0E000, .SVE, {is_64=true}},      {read={0, 1, 2}, writes_mem=true}},
