...
murmur3_x86_128 :: proc "contextless" (data: []u8, seed: u32 = 0) -> u128 #no_bounds_check {
  ...
  switch(len & 15) {
    ...
    case 13: k4 ~= u32(data[nblocks*16+12])
      k4 *= c4
      k4 = rotl32(k4, 18)
      k4 *= c1
      h4 ~= k4
    ...
    case 9: k3 ~= u32(data[nblocks*16+8])
      k3 *= c3
      k3 = rotl32(k3, 17)
      k3 *= c4
      h3 ~= k3
    ...
    case 5: k2 ~= u32(data[nblocks*16+4])
      k2 *= c2
      k2 = rotl32(k2, 16)
      k2 *= c3
      h2 ~= k2
    ...
    case 1: k1 ~= u32(data[nblocks*16+0])
      k1 *= c1
      k1 = rotl32(k1, 15)
      k1 *= c2
      h1 ~= k1
...
murmur3_x64_128 :: proc "contextless" (data: []u8, seed: u32 = 0) -> u128 #no_bounds_check {
  ...
  switch(len & 15) {
    ...
    case 9: k2 ~= u64(data[nblocks*16+8])
      k2 *= c2
      k2 = rotl64(k2, 33)
      k2 *= c1
      h2 ~= k2
    ...
    case 1: k1 ~= u64(data[nblocks*16+0])
      k1 *= c1
      k1 = rotl64(k1, 31)
      k1 *= c2
      h1 ~= k1
