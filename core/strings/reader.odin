...
"read" calls advance the current reading offset `i`, while "unread" calls decrement it.
*/
Reader :: struct {
...
This VTable is used by the Reader struct to provide its functionality as an `io.Stream`.
*/
@(private)
