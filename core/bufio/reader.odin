...
Because the data returned from reader_read_slice will be overwritten on the next IO operation, `reader_read_bytes` or
`reader_read_string` is usually preferred.
