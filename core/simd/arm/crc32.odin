...
__crc32b :: #force_inline proc "c" (crc: u32, data: u8) -> u32 {
	return ___crc32b(crc, u32(data))
}
...
@(require_results, enable_target_feature = "crc")
__crc32cb :: #force_inline proc "c" (crc: u32, data: u8) -> u32 {
	return ___crc32cb(crc, u32(data))
}
...
@(require_results, enable_target_feature = "crc")
__crc32h :: #force_inline proc "c" (crc: u32, data: u16) -> u32 {
	return ___crc32h(crc, u32(data))
}
...
@(require_results, enable_target_feature = "crc")
__crc32ch :: #force_inline proc "c" (crc: u32, data: u16) -> u32 {
	return ___crc32ch(crc, u32(data))
}
...
@(require_results, enable_target_feature = "crc")
__crc32w :: #force_inline proc "c" (crc: u32, data: u32) -> u32 {
...
@(require_results, enable_target_feature = "crc")
__crc32cw :: #force_inline proc "c" (crc: u32, data: u32) -> u32 {
...
@(require_results, enable_target_feature = "crc")
__crc32d :: #force_inline proc "c" (crc: u32, data: u64) -> u32 {
	when ODIN_ARCH == .arm64 {
		return ___crc32d(crc, data)
	} else {
		b := u32(data & 0xffffffff)
		c := u32(data >> 32)
...
@(require_results, enable_target_feature = "crc")
__crc32cd :: #force_inline proc "c" (crc: u32, data: u64) -> u32 {
	when ODIN_ARCH == .arm64 {
...
when ODIN_ARCH == .arm64 {
	...
	foreign _ {
		...
		___crc32d :: proc(crc: u32, data: u64) -> u32 ---
		@(link_name = "llvm.aarch64.crc32cx")
		___crc32cd :: proc(crc: u32, data: u64) -> u32 ---
	}
}
