...
gb_internal void ast_dumper_dump_ast(AstDumper *dumper, Ast *ast) {
	...
	case Ast_AsmMemoryTerm:
		ast_dumper_dump_token(dumper, STR_LIT("op"), ast->AsmMemoryTerm.op);
		ast_dumper_dump_named_ast(dumper, STR_LIT("operand"), ast->AsmMemoryTerm.operand);
		ast_dumper_dump_token(dumper, STR_LIT("scale_op"), ast->AsmMemoryTerm.scale_op);
		ast_dumper_dump_named_ast(dumper, STR_LIT("scale"), ast->AsmMemoryTerm.scale);
		break;
	case Ast_AsmMemoryOperand:
		...
		ast_dumper_dump_named_slice_of_asts(dumper, STR_LIT("terms"), ast->AsmMemoryOperand.terms);
