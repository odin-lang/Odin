...
static lbValue lb_type_info(lbModule *m, Type *type) {
	GB_ASSERT(!build_context.disallow_rtti);
...
static lbValue lb_type_info_member_types_offset(lbProcedure *p, isize count) {
...
static lbValue lb_type_info_member_names_offset(lbProcedure *p, isize count) {
	GB_ASSERT(p->module == &p->module->gen->default_module);
...
static lbValue lb_type_info_member_offsets_offset(lbProcedure *p, isize count) {
	GB_ASSERT(p->module == &p->module->gen->default_module);
...
static lbValue lb_type_info_member_usings_offset(lbProcedure *p, isize count) {
	GB_ASSERT(p->module == &p->module->gen->default_module);
...
static lbValue lb_type_info_member_tags_offset(lbProcedure *p, isize count) {
	GB_ASSERT(p->module == &p->module->gen->default_module);
...
static void lb_setup_type_info_data(lbProcedure *p) { // NOTE(bill): Setup type_info data
