...
static isize qprintf(bool format, isize indent, char const *fmt, ...) {
...
static bool qv_valid_char(u8 c) {
	if (c >= 0x80) {
		return false;
	}
...
static void print_query_data_as_json(QueryValue *value, bool format = true, isize indent = 0) {
	if (value == nullptr) {
		gb_printf("null");
		return;
	}
...
static int query_data_package_compare(void const *a, void const *b) {
...
static int query_data_definition_compare(void const *a, void const *b) {
...
static int entity_name_compare(void const *a, void const *b) {
	Entity *x = *cast(Entity *const *)a;
	Entity *y = *cast(Entity *const *)b;
	if (x == y) {
		return 0;
...
static void generate_and_print_query_data(Checker *c, Timings *timings) {
...
static void generate_and_print_query_data_global_definitions(Checker *c, Timings *timings) {
...
static int go_to_def_file_map_compare(void const *a, void const *b) {
...
static int quick_ident_compare(void const *a, void const *b) {
	Ast *x = *cast(Ast **)a;
	Ast *y = *cast(Ast **)b;
...
static void generate_and_print_query_data_go_to_definitions(Checker *c) {
