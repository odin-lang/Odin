...
echo ---
%PATH_TO_ODIN% test encoding/hxa    %COMMON% %COLLECTION%
...
echo ---
%PATH_TO_ODIN% test math %COMMON% %COLLECTION%

echo ---
echo Running core:math/linalg/glsl tests
echo ---
%PATH_TO_ODIN% test math/linalg/glsl %COMMON% %COLLECTION%

echo ---
echo Running core:path/filepath tests
echo ---
%PATH_TO_ODIN% test path/filepath %COMMON% %COLLECTION%

echo ---
echo Running core:reflect tests
echo ---
%PATH_TO_ODIN% test reflect %COMMON% %COLLECTION%
